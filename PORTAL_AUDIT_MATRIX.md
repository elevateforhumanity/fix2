...
15. [ ] Access documents page
16. [ ] Upload test document (license)
17. [ ] Verify file appears in Supabase Storage
18. [ ] Verify record appears in program_holder_documents table
19. [ ] Upload second document (insurance)
20. [ ] View uploaded documents list
21. [ ] See status (Pending/Approved/Rejected)
