...
## Quick Start - Copy & Paste These SQL Scripts
...
### Step 2: Add Programs & Courses Data
...
-- Verify
SELECT '✅ Programs created: ' || COUNT(*)::text as status FROM programs;
SELECT '✅ Courses created: ' || COUNT(*)::text as status FROM courses;
```
...
After running both scripts, verify your data:
...
- ✅ **All tables created** (profiles, enrollments, progress, etc.)
...
1. ✅ Run Step 1 (Base Tables)
2. ✅ Run Step 2 (Programs & Courses)
3. ✅ Run Verification queries
4. ✅ Visit your site at `/programs` - should show 16 programs
5. ✅ Visit your site at `/courses` - should show 17 courses
6. 🎉 **START TESTING!**
...
### If programs/courses don't show up:
- Check the status: `SELECT slug, status FROM programs;`
...
3. Make sure Supabase is connected to your Vercel project
4. Test the connection with a simple query: `SELECT NOW();`
