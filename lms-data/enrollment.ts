...
export const enrollmentConfigs: ProgramEnrollmentConfig[] = [
  ...
  },
  {
    ...
    shortDescription:
      "FREE salon-based apprenticeship mixing on-the-job learning with theory.",
    isStateFunded: true,
    isApprenticeship: true,
  ...
  },
  {
    ...
    shortDescription:
      "FREE apprenticeship in property and facilities maintenance roles.",
    isStateFunded: true,
    isApprenticeship: true,
    typicalDurationWeeks: 24,
  ...
  },
  {
    ...
    shortDescription:
      "FREE apprenticeship for office roles and business operations support.",
    isStateFunded: true,
    isApprenticeship: true,
    typicalDurationWeeks: 24,
    typicalHoursPerWeek: 20,
