...
test.describe('Course Enrollment and Progress', () => {
  ...
  test('should browse available courses', async ({ page }) => {
    ...
    const courseCards = page.locator('[data-testid="course-card"], .course-card, .program-card');
  ...
  test('should view course details', async ({ page }) => {
    ...
    // Click first course
    await page.click('[data-testid="course-card"]:first-child, .course-card:first-child, .program-card:first-child');
  ...
  test('should enroll in a course', async ({ page }) => {
    ...
    // Click first course
    await page.click('[data-testid="course-card"]:first-child, .course-card:first-child');
...
test.describe('Quiz and Assessment', () => {
  ...
  test('should submit quiz answers', async ({ page }) => {
    ...
    // Select first answer
    await page.click('input[type="radio"]:first-child, input[type="checkbox"]:first-child');
