...
export function LMSNavigation({ user, profile }: LMSNavigationProps) {
  ...
  return (
    <nav role="navigation" aria-label="Main navigation" className="bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/lms/dashboard" aria-label="Link" className="flex items-center gap-3 group">
            ...
            <span className="font-black text-xl text-slate-950 hidden md:block uppercase tracking-tight">
              Learning Portal
            </span>
          </Link>
