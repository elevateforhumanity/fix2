        ...
        <div className="pt-8 border-t border-gray-200 mb-6">
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-6 space-y-4">
            ...
            <div className="text-xs text-gray-600">
              <strong>Contact:</strong> (317) 555-0100 | <a href="mailto:elevate4humanityedu@gmail.com" className="text-blue-600 hover:underline">elevate4humanityedu@gmail.com</a> | Serving 8888 Keystone Crossing Suite 1300, Indianapolis, IN 46240
            </div>
          </div>
        </div>
