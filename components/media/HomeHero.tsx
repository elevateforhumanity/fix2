      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-3 py-4 md:px-4 md:py-6">
        ...
        <div className="md:hidden">
          <div className="relative mx-auto w-full max-w-md">
            <div className="relative w-full overflow-hidden rounded-2xl border border-slate-800 bg-slate-900 aspect-[4/3]">
              <Image
                src={current.src}
                alt={current.alt}
                fill
        ...
        <div className="grid gap-4 md:grid-cols-[1.3fr,1.7fr] md:items-center">
          ...
          <div className="relative hidden md:block">
            <div className="relative h-full w-full max-w-xl md:ml-auto">
              <div className="relative w-full overflow-hidden rounded-2xl border border-slate-800 bg-slate-900 aspect-[16/9]">
                <Image
                  src={current.src}
                  alt={current.alt}
                  fill
