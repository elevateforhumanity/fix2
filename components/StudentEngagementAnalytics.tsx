...
export function StudentEngagementAnalytics() {
      ...
      <div className="bg-gradient-to-r from-red-600 to-orange-500 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-red-100">
            Monitor and improve student participation
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 bg-gradient-to-r from-red-50 to-orange-50">
            ...
            <p className="text-sm text-gray-700">
              42 students haven't logged in for 7+ days. Consider sending
          ...
          <Card className="p-6 bg-gradient-to-r from-green-50 to-emerald-50">
            ...
            <p className="text-sm text-gray-700">
              Engagement rate increased 3% this month. Video content is driving
              participation.
            </p>
          </Card>
          ...
          <Card className="p-6 bg-gradient-to-r from-blue-50 to-cyan-50">
            ...
            <p className="text-sm text-gray-700">
              Peak activity hours are 7-9 PM. Schedule live sessions during this
              window.
            </p>
          </Card>
        </div>
