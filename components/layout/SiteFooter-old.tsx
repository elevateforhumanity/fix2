    ...
    <footer className="border-t border-slate-200 bg-slate-50 mt-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid gap-8 lg:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-slate-500">
              ...
              <br />
              <a href="tel:317-314-3757" className="hover:text-orange-600">
                (317) 314-3757
              </a>
            </p>
            ...
            >
              View Full Site Map (
              {footerSections.reduce((n, s) => n + s.items.length, 0)} pages)
            </Link>
          </div>
        ...
        <div className="mt-8 flex flex-col items-start justify-between gap-2 border-t border-slate-200 pt-4 text-[11px] text-slate-500 sm:flex-row sm:items-center">
          <p>© {year} Elevate For Humanity. All rights reserved.</p>
