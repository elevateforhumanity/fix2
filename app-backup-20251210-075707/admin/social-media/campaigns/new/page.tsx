                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-500 mt-1">From your blog</div>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-500 mt-1">GPT-4 powered</div>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-500 mt-1">Write your own</div>
                    </button>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                {campaign.frequency === '3x-daily' && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <h3 className="font-medium text-blue-900 mb-2">Daily Posting Times (EST)</h3>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Total posts: {parseInt(campaign.duration) * (campaign.frequency === '3x-daily' ? 3 : 1)}
                  </p>
                </div>
              </div>
            </div>
                    ...
                    <div key={index} className="p-4 border border-gray-200 rounded-lg">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <span className="text-xs text-gray-400">
                          Day {Math.floor(index / 3) + 1} - {['Morning', 'Afternoon', 'Evening'][index % 3]}
                        </span>
                      </div>
            ...
            <div className="bg-white rounded-lg shadow p-6 sticky top-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-900">{campaign.duration} days</div>
                </div>

                <div>
                  <div className="text-xs text-gray-500 mb-1">Total Posts</div>
                  <div className="text-sm font-medium text-gray-900">
                    {parseInt(campaign.duration) * (campaign.frequency === '3x-daily' ? 3 : 1)} posts
                  </div>
                </div>

                <div>
                  <div className="text-xs text-gray-500 mb-1">Content Source</div>
                  <div className="text-sm text-gray-900">
                    {campaign.contentSource === 'blog' ? 'Blog Posts' :
                     campaign.contentSource === 'ai' ? 'AI Generated' :
                     'Manual'}
                  </div>
                </div>
...
function PlatformButton({ name, icon: Icon, selected, onClick }: PlatformButtonProps) {
  return (
    ...
    >
      <Icon className={`w-8 h-8 mb-2 ${selected ? 'text-blue-600' : 'text-gray-400'}`} />
