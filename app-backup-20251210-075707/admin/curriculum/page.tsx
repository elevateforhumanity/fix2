...
export const metadata: Metadata = {
  ...
  description: 'Manage curriculum, course content, and educational materials for all programs.',
};
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white rounded-lg shadow-sm border p-6">
                <h3 className="text-sm font-medium text-gray-600 mb-2">Total Curriculum Items</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              {profile && profile.length > 0 ? (
                ...
                <p className="text-gray-500 text-center py-8">No curriculum items found</p>
              )}
            </div>
