...
⏳ **Partial:** 7. Premium features gated (guards created, not applied) 8. Suspended tenants read-only (logic created, not applied) 9. Admin override UI (schema ready, UI pending)
