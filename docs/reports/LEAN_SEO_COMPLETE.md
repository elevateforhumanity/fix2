...
1. **Sitemap:** https://www.elevateforhumanity.org/sitemap.xml
   - Should show XML with all routes
   - Auto-generated by Vite plugin

2. **robots.txt:** https://www.elevateforhumanity.org/robots.txt
   - Should reference sitemap
   - Should block AI crawlers

3. **Home Page:** https://www.elevateforhumanity.org
   - View source
   - Check meta tags
