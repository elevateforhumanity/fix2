...
**CSS Variables:**
```css
--efh-red: #E41E26       /* Primary brand color */
--efh-orange: #F97316    /* Secondary/gradient */
--efh-blue: #2563EB      /* Accent */
--efh-bg: #0B0B0D        /* Dark background */
--efh-surface: #121318   /* Card/surface */
--efh-text: #F8FAFC      /* Primary text */
--efh-muted: #94A3B8     /* Secondary text */
...
```json
{
  ...
  "theme_color": "#E41E26",
  "icons": [{"src": "/assets/logo-efh.svg", "sizes": "any", "type": "image/svg+xml"}]
}
```
