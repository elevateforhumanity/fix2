...
## A. Barber Final Assessment (15 Questions)

**Quiz ID:** `barber_final_assessment_001`  
**Passing Score:** 80%  
**Total Questions:** 15
...
**Explanation:** A 5-15 degree angle provides the safest and most effective cutting angle for straight razor work.
...
- D. Spraying tools with cologne

**Correct Answer:** C

**Explanation:** EPA-registered disinfectants used for the proper contact time are required for proper sanitation.
...
- D. Ask the client to hold a tissue and continue

**Correct Answer:** C

**Explanation:** Blood exposure requires immediate cessation of service and proper infection control procedures.
...
**Explanation:** A traveling guideline moves with each section to maintain consistent length throughout the haircut.
...
**Explanation:** Open sores or unexplained lesions require medical evaluation and are outside the scope of barbering practice.
...
- D. A doctor's note from the client

**Correct Answer:** C

**Explanation:** Razor work is regulated by state boards and requires strict adherence to infection control protocols.
...
- D. Arguing about style choices

**Correct Answer:** B

**Explanation:** Active listening and confirming client expectations is essential for professional communication.
...
- D. Check if the client can tip

**Correct Answer:** C

**Explanation:** Consultations ensure you understand what the client wants before beginning the service.
...
- D. To compete with other barbers

**Correct Answer:** C

**Explanation:** Accurate hour tracking is required for state licensing and workforce program compliance.
...
- D. Mix every product together for better results

**Correct Answer:** C

**Explanation:** Manufacturer instructions and SDS sheets ensure safe and effective product use.
...
- D. Only do a quick lineup

**Correct Answer:** C

**Explanation:** Refusing service to impaired clients protects both their safety and yours.
...
- D. Complaining about other clients

**Correct Answer:** A

**Explanation:** Personalized service and attention to client satisfaction builds lasting relationships.
...
**Explanation:** Apprentices must be reliable, follow shop protocols, and actively engage with their mentors.
...
- D. Rinsing is enough if tools "look clean"

**Correct Answer:** C

**Explanation:** Disinfection reduces but doesn't eliminate all microorganisms; sterilization kills all including spores.
...
**Explanation:** Completing the pathway prepares you for state licensing and beginning your professional career.

---

## B. CNA Final Assessment (15 Questions)

**Quiz ID:** `cna_final_assessment_001`  
**Passing Score:** 80%  
**Total Questions:** 15
...
- D. No PPE needed if the resident looks healthy

**Correct Answer:** B

**Explanation:** Hand hygiene before and after all resident contact is a fundamental standard precaution.
...
- D. Give the resident food

**Correct Answer:** B

**Explanation:** Positioning for comfort and staying with the resident while getting help is the appropriate response.
...
- D. Pull the resident by their arms

**Correct Answer:** C

**Explanation:** Proper body mechanics with bent knees and wide base prevents injury during transfers.
...
- D. You can talk about residents with friends or family

**Correct Answer:** C

**Explanation:** HIPAA requires that resident information only be shared with authorized care team members.
...
- D. Argue with them about the facts

**Correct Answer:** B

**Explanation:** Patience and reassurance are appropriate responses to repetitive questions from residents with dementia.
...
- C. Slow you down
- D. Are optional if you are strong

**Correct Answer:** B

**Explanation:** Proper body mechanics protect both caregivers and residents from injury.
...
- D. Ignore hygiene completely

**Correct Answer:** C

**Explanation:** Residents have the right to refuse care; understanding their concerns and trying later respects their autonomy.
...
- D. Only count if they have heart problems

**Correct Answer:** B

**Explanation:** Irregular pulses must be counted for a full minute to ensure accuracy.
...
- D. Scold them for getting out of bed

**Correct Answer:** C

**Explanation:** Never leave a fallen resident alone; stay with them and call for help immediately.
...
**Explanation:** Regular repositioning and skin care are essential for pressure injury prevention.
...
- D. They should not have anything by mouth ✓

**Correct Answer:** D

**Explanation:** NPO (nil per os) means nothing by mouth, including water.
...
- D. Joke loudly in the hallway

**Correct Answer:** B

**Explanation:** Privacy, communication, and appropriate covering maintain resident dignity during care.
...
- D. Before leaving the facility only

**Correct Answer:** B

**Explanation:** Hand washing is required after restroom use, before meals, and when hands are visibly soiled.
...
- D. Done only at the end of the week

**Correct Answer:** C

**Explanation:** Documentation must be factual, timely, and clear for accurate medical records.
...
- D. Change careers immediately

**Correct Answer:** C

**Explanation:** Pathway completion prepares you for state certification and beginning your CNA career.
...
2. **Randomization:** Randomize question order for each student attempt

3. **Retakes:** Allow unlimited retakes with 24-hour cooldown between attempts

4. **Progress Tracking:** Mark quiz block as complete only when passing score is achieved
