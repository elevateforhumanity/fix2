              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">
                    [SKILL_1 - Be specific and outcome-focused]
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <svg
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center gap-2 text-gray-700">
                    ...
                    [CREDENTIAL_3 - e.g., "Eligibility for state licensure
                    exam"]
                  </li>
                </ul>
              </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <p className="flex items-start gap-2">
                  ...
                  <span>
                    [REQUIREMENT_2 - e.g., "High school diploma or GED"]
                  </span>
                </p>
                <p className="flex items-start gap-2">
                  <svg
                  ...
                  <span>
                    [REQUIREMENT_3 - e.g., "Background-friendly
                    (justice-involved welcome)"]
                  </span>
                </p>
                <p className="flex items-start gap-2">
                  <svg
                  ...
                  <span>
                    [REQUIREMENT_4 - e.g., "Able to commit to full schedule"]
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                ...
                <p className="flex items-center gap-2">
                  ...
                  <span>
                    <strong>Schedule:</strong> [MORNING/EVENING OPTIONS]
                  </span>
                </p>
                <p className="flex items-center gap-2">
                  <svg
        ...
        <div className="mx-auto max-w-5xl px-6 md:px-12">
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              <strong>WRG / WIOA / Apprenticeship funding</strong>.
            </p>
            <p className="text-gray-700 mb-6">
              We provide attendance, progress, and outcome reports for your
              files.
            </p>
            <Link
              href="/partners"
