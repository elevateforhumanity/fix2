  ...
  const l = [
    {
      ...
      icon: e.jsx(r, { className: 'h-8 w-8 text-green-600' }),
    },
    {
      ...
      icon: e.jsx(a, { className: 'h-8 w-8 text-green-600' }),
    },
    {
      ...
      icon: e.jsx(i, { className: 'h-8 w-8 text-green-600' }),
    },
    {
      ...
      icon: e.jsx(n, { className: 'h-8 w-8 text-green-600' }),
    },
  ];
  return e.jsxs('div', {
          ...
          children: e.jsxs('div', {
            ...
            children: [
              e.jsx('h1', {
                ...
                children: 'Workforce Funding & Public Partnerships',
              }),
              e.jsx('p', {
                className: 'text-xl text-blue-100 mb-8',
                children:
                  'Elevate for Humanity is an approved ETPL provider delivering WIOA-compliant workforce development programs across Indiana.',
              }),
              e.jsxs('div', {
            ...
            e.jsxs('div', {
              ...
              children: [
                e.jsx('h2', {
                  ...
                  children: 'Available Funding Programs',
                }),
                e.jsx('p', {
            ...
            e.jsx('div', {
              ...
              children: l.map((s, t) =>
                e.jsx(
                  ...
                  {
                    className:
                      'bg-white rounded-xl p-6 shadow-sm border border-brown-200 hover:shadow-md transition-shadow',
                    children: e.jsxs('div', {
                      className: 'flex items-start gap-4',
                      children: [
                        e.jsx('div', {
                          className:
                            'flex-shrink-0 w-16 h-16 bg-green-600/10 rounded-lg flex items-center justify-center',
                          children: s.icon,
                        }),
                        e.jsxs('div', {
                          className: 'flex-1',
          ...
          children: e.jsxs('div', {
            ...
            children: [
              e.jsx('h2', {
                ...
                children: 'Why Partner With Elevate for Humanity?',
              }),
              e.jsx('div', {
        ...
        children: e.jsx('div', {
          ...
          children: e.jsxs('div', {
            ...
            children: [
              e.jsxs('div', {
                className:
                  'bg-white rounded-xl p-6 text-center shadow-sm border border-brown-200',
                children: [
                  e.jsx('div', {
        ...
        children: e.jsxs('div', {
          ...
          children: [
            ...
            e.jsx('p', {
              ...
              children:
                'Contact us to discuss how Elevate for Humanity can support your workforce development goals.',
            }),
            e.jsxs('div', {
              ...
              children: [
                e.jsxs('a', {
                  ...
                  children: ['Contact Us ', e.jsx(t, { className: 'h-4 w-4' })],
                }),
                e.jsx('a', {
                  href: '/programs',
