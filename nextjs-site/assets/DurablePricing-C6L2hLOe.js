...
function i() {
  return e.jsxs('div', {
    children: [
      e.jsxs(t, {
        children: [
          e.jsx('title', { children: 'Pricing | Elevate for Humanity' }),
          e.jsx('meta', {
            name: 'description',
            content:
              "Simple, transparent pricing. Choose the plan that's right for you.",
          }),
        ],
      }),
      e.jsx(r, {}),
                  ...
                  'div',
                  {
                    ...
                    children: [
                      t.highlighted &&
                        e.jsx('div', {
                          className:
                            'bg-green-600 text-white text-sm font-semibold px-4 py-1 rounded-full inline-block mb-4',
