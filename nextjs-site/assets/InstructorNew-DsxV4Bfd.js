...
function n() {
  const [n, r] = e.useState(1),
    ...
    d = (e) => {
      s({ ...l, [e.target.name]: e.target.value });
    },
    a = () => {
      switch (n) {
        case 1:
        ...
        i.jsxs('div', {
          ...
          children: [
            ...
            i.jsx('p', {
              ...
              children: 'Follow the steps to create your course',
            }),
          ],
        }),
        i.jsxs('div', {
                  ...
                  children: [
                    i.jsx('div', {
                      style: {
                        ...
                        height: 40,
                        borderRadius: '50%',
                        backgroundColor: n >= e.num ? '#00a544' : '#d4c9b8',
                        color: n >= e.num ? '#fff' : '#999',
                        display: 'flex',
                        alignItems: 'center',
                    ...
                    i.jsx('div', {
                      style: {
                        fontSize: 12,
                        color: n >= e.num ? '#00a544' : '#999',
                        fontWeight: n === e.num ? 600 : 400,
                      },
                      children: e.label,
                    }),
                  ],
                      ...
                      i.jsxs('div', {
                        children: [
                          ...
                          i.jsx('input', {
                            ...
                            onChange: d,
                            placeholder:
                              'e.g., Learn HTML, CSS, and JavaScript from scratch',
                            style: {
                              width: '100%',
                              padding: '12px 14px',
                              border: '1px solid #d4c9b8',
                      ...
                      i.jsxs('div', {
                        children: [
                          ...
                          i.jsx('textarea', {
                            ...
                            onChange: d,
                            placeholder:
                              'Describe your course in detail. What will students learn? What skills will they gain?',
                            rows: 8,
                            style: {
                              width: '100%',
                              padding: '12px 14px',
                          ...
                          i.jsx('p', {
                            ...
                            children: 'Minimum 200 characters recommended',
                          }),
                        ],
                      }),
                      i.jsxs('div', {
                        ...
                        children: [
                          i.jsx('h3', {
                            ...
                            children: '💡 Tips for a great description',
                          }),
                          i.jsxs('ul', {
                            style: {
                              fontSize: 13,
                            ...
                            children: [
                              i.jsx('li', {
                                children:
                                  'Start with what students will achieve',
                              }),
                              i.jsx('li', {
                                children: 'List key learning outcomes',
                              }),
                              i.jsx('li', {
                                children: 'Mention any prerequisites',
                              }),
                              i.jsx('li', {
                                children: 'Explain who the course is for',
                              }),
                            ],
                          }),
                        ],
            ...
            3 === n &&
              i.jsxs('div', {
                children: [
                  ...
                  i.jsx('p', {
                    style: { fontSize: 14, color: '#6b5d52', marginBottom: 24 },
                    children: 'Configure language and pricing for your course',
                  }),
                  i.jsxs('div', {
                    style: {
                      display: 'flex',
            ...
            4 === n &&
              i.jsxs('div', {
                children: [
                  ...
                  i.jsx('p', {
                    style: { fontSize: 14, color: '#6b5d52', marginBottom: 24 },
                    children: 'Review your course details before creating',
                  }),
                  i.jsxs('div', {
                    style: {
                      border: '1px solid #d4c9b8',
                      ...
                      i.jsxs('div', {
                        ...
                        children: [
                          ...
                          i.jsx('div', {
                            ...
                            children: l.title || 'Untitled Course',
                          }),
                        ],
                      }),
                      l.subtitle &&
                  ...
                  i.jsxs('div', {
                    ...
                    children: [
                      ...
                      i.jsx('p', {
                        style: { fontSize: 13, color: '#0056b3', margin: 0 },
                        children:
                          "After creating your course, you'll be able to add curriculum, upload videos, create quizzes, and publish when ready.",
                      }),
                    ],
                  }),
                ],
        ...
        i.jsxs('div', {
          ...
          children: [
            i.jsx('button', {
              ...
              style: {
                padding: '12px 24px',
                backgroundColor: 1 === n ? '#f0f0f0' : '#fff',
                color: 1 === n ? '#999' : '#333',
                border: '1px solid #d4c9b8',
                borderRadius: 6,
                fontSize: 14,
