  ...
  return e.jsxs('main', {
    ...
    children: [
      e.jsx('h1', {
        ...
        children: 'Elevate for Humanity Ecosystem',
      }),
      e.jsxs('section', {
          ...
          e.jsxs('div', {
            ...
            children: [
              ...
              e.jsx('a', {
                ...
                children: 'Visit Volunteer Network',
              }),
            ],
          }),
          e.jsxs('div', {
            ...
            children: [
              ...
              e.jsx('a', {
                ...
                children: 'Visit Wellness & Support',
              }),
            ],
          }),
        ],
      ...
      e.jsxs('section', {
        ...
        children: [
          ...
          e.jsxs('ul', {
            style: { fontSize: 16, color: '#444', lineHeight: 1.7 },
            children: [
              e.jsx('li', {
                children:
                  'All sister sites and the main site are listed with clear, descriptive text and accessible links.',
              }),
              e.jsxs('li', {
                children: [
                  'Links open in a new tab and use',
                  ' ',
                  e.jsx('code', { children: 'rel="noopener noreferrer"' }),
                  ' for security.',
                ],
              }),
              e.jsx('li', {
                children:
                  'Layout is responsive and visually appealing; consider adding images or icons for each card for more visual interest.',
              }),
              e.jsxs('li', {
                children: [
                  'Accessibility is improved with ',
                  e.jsx('code', { children: 'aria-label' }),
                  ' on links for screen readers.',
                ],
              }),
              e.jsx('li', {
                children:
                  'Replace placeholder URLs with your real sister site URLs for production.',
              }),
              e.jsx('li', {
                children: 'All content is clear, professional, and accessible.',
              }),
            ],
          }),
        ],
