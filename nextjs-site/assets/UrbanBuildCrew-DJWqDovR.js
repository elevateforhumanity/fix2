  ...
  return e.jsxs('div', {
    children: [
      e.jsxs(r, {
        children: [
          e.jsx('title', {
            children: 'Urban Build Crew | Elevate for Humanity',
          }),
          e.jsx('meta', {
            name: 'description',
            content: 'Construction and building trades training programs',
          }),
        ],
      }),
      e.jsx(t, {}),
      e.jsxs('div', {
        ...
        children: [
          ...
          e.jsx('div', {
            style: { padding: '4rem 2rem', backgroundColor: '#f5f1e8' },
            children: e.jsxs('div', {
              style: { maxWidth: '1200px', margin: '0 auto' },
              children: [
                e.jsx('h2', {
          ...
          e.jsx('div', {
            style: { backgroundColor: '#f5f1e8', padding: '4rem 2rem' },
            children: e.jsx('div', {
              style: { maxWidth: '1200px', margin: '0 auto' },
              children: e.jsxs('div', {
                style: {
                ...
                children: [
                  e.jsxs('div', {
                    children: [
                      ...
                      e.jsx('div', {
                        style: { color: '#6b5d52', fontSize: '1.125rem' },
                        children: 'Graduates Placed',
                      }),
                    ],
                  }),
                  e.jsxs('div', {
                  ...
                  e.jsxs('div', {
                    children: [
                      ...
                      e.jsx('div', {
                        style: { color: '#6b5d52', fontSize: '1.125rem' },
                        children: 'Average Starting Salary',
                      }),
                    ],
                  }),
                  e.jsxs('div', {
            ...
            children: e.jsxs('div', {
              ...
              children: [
                e.jsx('h2', {
                  ...
                  children: 'Start Building Your Career Today',
                }),
                e.jsx('p', {
                  style: {
                    fontSize: '1.125rem',
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsx('p', {
                ...
                children: '© 2025 Urban Build Crew. All rights reserved.',
              }),
              e.jsx('p', {
                style: { fontSize: '0.875rem', color: '#8b7d6f' },
                children: 'Part of the Elevate for Humanity Network',
              }),
            ],
          }),
        ],
...
export { o as UrbanBuildCrew, o as default };
