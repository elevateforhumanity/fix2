...
import { P as i } from './ProgramPageTemplate-DF_avGqN.js';
...
function n() {
  return e.jsx(i, {
    ...
    funding: 'WRG • WIOA',
    metaDescription:
      'Become a certified Building Services Technician. Learn HVAC, plumbing, electrical, and facility maintenance with 100% funded training.',
    overview:
      "Our Building Services Technician program prepares you for a career in facility maintenance and building operations. You'll learn essential skills in HVAC, plumbing, electrical systems, and general maintenance to keep commercial and residential properties running smoothly.",
    benefits: [
      '100% funded training',
