...
function o() {
  return e.jsx(i, {
    ...
    funding: 'WRG • WIOA',
    metaDescription:
      'Become a certified Drug Testing Specialist. Learn collection procedures, compliance, and chain of custody with 100% funded training.',
    overview:
      'Our Drug Testing Specialist program trains you in proper collection procedures, chain of custody protocols, and compliance requirements for workplace drug testing programs.',
    benefits: [
      '100% funded training',
