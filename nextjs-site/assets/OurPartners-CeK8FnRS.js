          ...
          children: e.jsxs('div', {
            ...
            children: [
              e.jsx('div', {
                ...
                children: e.jsx(r, { className: 'w-20 h-20' }),
              }),
              e.jsx('h1', {
              ...
              e.jsx('p', {
                ...
                children:
                  'We partner with leading organizations to provide industry-recognized training, certifications, and career pathways for our students.',
              }),
            ],
          }),
        }),
        ...
        children: [
              ...
              e.jsx('div', {
                ...
                children: i.map((r, n) =>
                  e.jsxs(
                    'div',
                    {
                      className: `border-2 rounded-lg p-6 ${o(r.color)} hover:shadow-lg transition`,
                      children: [
                        e.jsxs('div', {
                            ...
                            e.jsxs('div', {
                              children: [
                                ...
                                r.internal &&
                                  e.jsx('span', {
                                    className:
                                      'inline-block bg-gray-200 px-3 py-1 rounded-full text-sm font-semibold ml-2',
                                    children: 'Internal Use',
                                  }),
                              ],
                            }),
                            e.jsx(a, { className: 'w-8 h-8 text-gray-600' }),
                          ],
                        }),
                        e.jsx('p', {
                        ...
                        e.jsxs('div', {
                          ...
                          children: [
                            e.jsx('a', {
                              href: r.page,
                              className:
                                'flex-1 bg-white border-2 border-gray-300 text-gray-800 px-4 py-2 rounded-lg font-semibold hover:bg-gray-50 transition text-center',
                              children: 'Learn More',
                            }),
                            e.jsx('a', {
                              href: r.url,
                              ...
                              className:
                                'flex items-center justify-center bg-white border-2 border-gray-300 text-gray-800 px-4 py-2 rounded-lg font-semibold hover:bg-gray-50 transition',
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsx('h2', {
                className: 'text-3xl font-bold mb-8 text-center',
                children: 'Partners by Category',
              }),
              e.jsx('div', {
                className: 'grid md:grid-cols-2 lg:grid-cols-3 gap-6',
                children: l.map((r, a) => {
                  const t = i.filter((e) => e.category === r);
                  return e.jsxs(
                    'div',
                    {
                            ...
                            e.jsxs(
                              'li',
                              {
                                ...
                                children: [
                                  e.jsx(n, {
                                    className:
                                      'w-4 h-4 text-blue-600 mr-2 flex-shrink-0',
                                  }),
                                  e.jsx('span', {
                                    className: 'text-sm',
                                    children: r.name,
          ...
          e.jsxs('div', {
            className:
              'bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg p-12 text-center',
            children: [
              e.jsx('h2', {
