...
function n() {
  const [n, r] = e.useState(1),
    ...
    u = p.modules.flatMap((e) => e.lessons).find((e) => e.id === n),
    h = (e) => {
      s.includes(e) ? l(s.filter((o) => o !== e)) : l([...s, e]);
    },
    x = (e) => {
      switch (e) {
        case 'video':
          ...
          children: [
            o.jsxs('div', {
              ...
              children: [
                ...
                o.jsx('p', {
                  style: { fontSize: 13, color: '#6b5d52', marginBottom: 12 },
                  children: p.instructor,
                }),
                o.jsxs('div', {
                  children: [
                    o.jsxs('div', {
                      ...
                      e.lessons.map((e) =>
                        o.jsxs(
                          'div',
                          {
                            ...
                            style: {
                              padding: '12px 20px',
                              backgroundColor: n === e.id ? '#e3f2fd' : '#fff',
              ...
              children: o.jsxs('div', {
                ...
                children: [
                  ...
                  o.jsxs('p', {
                    ...
                    children: ['Duration: ', null == u ? void 0 : u.duration],
                  }),
                  o.jsxs('div', {
                    style: {
                      display: 'flex',
                        ...
                        children: [
                          ...
                          o.jsxs('p', {
                            ...
                            children: [
                              ...
                              ' ',
                              null == u ? void 0 : u.title.toLowerCase(),
                              ". You'll learn key concepts, best practices, and practical applications that you can immediately apply to your projects.",
                            ],
                          }),
                          o.jsx('h3', {
                            style: {
                          ...
                          o.jsxs('div', {
                            ...
                            children: [
                              o.jsxs('button', {
                                onClick: () =>
                                  alert('Resource download coming soon!'),
                                style: {
                                  padding: 12,
                                  backgroundColor: '#f8f8f8',
                                  borderRadius: 6,
            ...
            o.jsxs('div', {
              ...
              children: [
                ...
                o.jsx('button', {
                  style: {
                    padding: '10px 24px',
                    backgroundColor: (s.includes(n), '#00a544'),
                    color: '#fff',
                    border: 'none',
                    borderRadius: 6,
                    fontSize: 14,
                  ...
                  onClick: () => h(n),
                  children: s.includes(n) ? '✓ Completed' : 'Mark as Complete',
                }),
                o.jsx('button', {
                  style: {
                    padding: '10px 24px',
