...
import { a as r } from './certificates-Y_9npsL2.js';
import { u as i } from './AuthContext-D_Hfa_pA.js';
      ...
      : s.jsx('div', {
          ...
          children: s.jsxs('div', {
            ...
            children: [
              s.jsxs('div', {
                ...
                children: [
                  ...
                  s.jsx('p', {
                    ...
                    children: 'View and download all your earned certificates',
                  }),
                ],
              }),
              0 === n.length
                ...
                : s.jsx('div', {
                    ...
                    children: n.map((e) => {
                      var r, i;
                      const a = new Date(e.issued_at).toLocaleDateString(
                        'en-US',
                      ...
                      return s.jsxs(
                        'div',
                        {
                          ...
                          children: [
                            s.jsx('div', {
                              className:
                                'bg-gradient-to-br from-green-50 to-beige-50 p-6 border-b-4 border-green-600',
                              children: s.jsxs('div', {
                                className: 'text-center',
                                children: [
                                  s.jsx('div', {
                                  ...
                                  s.jsx('h3', {
                                    className:
                                      'text-lg font-semibold text-brown-900 mb-1',
                              ...
                              children: [
                                  ...
                                  children: [
                                    s.jsxs('div', {
                                      children: [
                                        s.jsx('div', {
                                          className:
                                            'text-xs font-semibold text-brown-500 uppercase mb-1',
                                          children: 'Issued',
                                        }),
                                        s.jsx('div', {
                                    ...
                                    s.jsxs('div', {
                                      children: [
                                        ...
                                        s.jsx('div', {
                                          className:
                                            'text-sm text-brown-900 font-mono',
                                          children: e.certificate_number,
                                        }),
                                      ],
                                    }),
                                    e.grade &&
                                      s.jsxs('div', {
                                        children: [
                                          ...
                                          s.jsx('div', {
                                            className:
                                              'text-sm text-brown-900 font-semibold',
                                            children: e.grade,
                                          }),
                                        ],
                                      }),
                                ...
                                s.jsxs('div', {
                                  ...
                                  children: [
                                    ...
                                    s.jsx('button', {
                                      onClick: () => {
                                        const s = `${window.location.origin}/verify/${e.certificate_number}`;
              ...
              n.length > 0 &&
                s.jsxs('div', {
                  className: 'card p-6 mt-8 bg-beige-50',
                  children: [
                    s.jsx('h3', {
                      className: 'text-lg font-semibold text-brown-900 mb-3',
                      children: 'About Your Certificates',
                    }),
                    s.jsxs('ul', {
                      className: 'space-y-2 text-sm text-brown-600',
                      children: [
                        s.jsxs('li', {
                        ...
                        s.jsxs('li', {
                          ...
                          children: [
                            ...
                            s.jsx('span', {
                              children:
                                'Download and print certificates for your records',
                            }),
                          ],
                        }),
                        s.jsxs('li', {
