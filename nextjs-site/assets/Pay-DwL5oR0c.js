...
import { L as l } from './vendor-router-CQjfSXV_.js';
import './vendor-Da1LjC7-.js';
function i() {
  const [i, d] = e.useState(null),
    o = [
      {
        id: 'ai-fundamentals',
              ...
              s.jsxs('div', {
                children: [
                  ...
                  s.jsx('p', {
                    ...
                    children:
                      'Secure payments with 50/50 revenue sharing and federal funding support',
                  }),
                ],
              }),
              s.jsxs('div', {
            ...
            children: [
              s.jsx('div', {
                ...
                children: s.jsxs('div', {
                  ...
                  children: [
                    s.jsx('h2', {
                      className: 'text-xl font-bold text-brown-900 mb-6',
                      children: 'Complete Your Enrollment Payment',
                    }),
                    s.jsxs('div', {
                      className: 'mb-6',
                      children: [
                        ...
                        s.jsxs('select', {
                          onChange: (e) =>
                            d(o.find((s) => s.id === e.target.value)),
                          className:
                            'w-full border border-brown-300 rounded-lg px-3 py-2',
                          children: [
                            s.jsx('option', {
                              value: '',
                      ...
                      s.jsxs('div', {
                        ...
                        children: [
                                ...
                                children: [
                                  ...
                                  s.jsxs('div', {
                                    children: [
                                      s.jsx('span', {
                                        className: 'text-green-600',
                                        children: 'Revenue Split:',
                                      }),
                                      s.jsx('span', {
                                        className: 'font-medium ml-2',
                                        children: '50/50 Partner Model',
                                      }),
                                    ],
                                  }),
                                ],
                          ...
                          s.jsxs('div', {
                            children: [
                              s.jsx('h4', {
                                className: 'font-medium text-brown-900 mb-3',
                              ...
                              s.jsxs('div', {
                                ...
                                children: [
                                  s.jsxs('label', {
                                    className:
                                      'flex items-start space-x-3 p-4 border border-brown-200 rounded-lg cursor-pointer hover:bg-beige-50',
                                    children: [
                                      s.jsx('input', {
                                        type: 'radio',
                                      ...
                                      s.jsxs('div', {
                                        ...
                                        children: [
                                          s.jsx('div', {
                                            className:
                                              'font-medium text-brown-900',
                                            children: '4 Installments',
                                          }),
                                          s.jsxs('div', {
                                            className: 'text-sm text-brown-600',
                                            children: [
                                              '$',
                                              (i.price / 4).toLocaleString(),
                                              ' per installment',
                                            ],
                                          }),
                                          s.jsx('div', {
                                            className:
                                              'text-xs text-brown-500 mt-1',
                                            children: i.installments.map(
                                              (e, t) =>
                                                s.jsxs(
                                                  'div',
                                                  {
                                  ...
                                  s.jsxs('label', {
                                    className:
                                      'flex items-start space-x-3 p-4 border border-green-200 rounded-lg cursor-pointer hover:bg-green-50 bg-green-25',
                                    children: [
                                      s.jsx('input', {
                                        type: 'radio',
                                        'aria-label': 'radio input',
                                      ...
                                      s.jsxs('div', {
                                        ...
                                        children: [
                                          s.jsxs('div', {
                                            className:
                                              'font-medium text-brown-900 flex items-center',
                                            children: [
                                              'Buy Now, Pay Later',
                                              s.jsx('span', {
                                                className:
                                                  'ml-2 bg-beige-50 text-green-600 text-xs px-2 py-1 rounded',
                                                children: 'Popular',
                                              }),
                                            ],
                                          }),
                                          ...
                                          s.jsxs('div', {
                                            className:
                                              'text-xs text-green-600 mt-1 space-y-1',
                                            children: [
                                              s.jsx('div', {
                                                children:
                          ...
                          s.jsxs('div', {
                            ...
                            children: [
                              s.jsx('h4', {
                                ...
                                children: '🏛️ Federal Funding Available',
                              }),
                              s.jsx('p', {
                              ...
                              s.jsx('div', {
                                ...
                                children: i.fundingOptions.map((e, t) =>
                                  s.jsx(
                                    'span',
                                    {
                                      className:
                              ...
                              s.jsx(l, {
                                ...
                                className:
                                  'text-green-600 hover:text-green-700 text-sm font-medium mt-2 inline-block',
                                children: 'Apply for Federal Funding →',
                              }),
                            ],
                          }),
                          s.jsxs('div', {
                              ...
                              s.jsxs('div', {
                                ...
                                children: [
                                  s.jsx('input', {
                                    ...
                                    className:
                                      'flex-1 border border-brown-300 rounded-lg px-3 py-2',
                                  }),
                                  s.jsx('button', {
                                    className:
                                    ...
                                    children: [
                                      s.jsxs('div', {
                                        children: [
                                          s.jsx('label', {
                                            className:
                                              'block text-sm font-medium text-brown-900 mb-1',
                                          ...
                                          s.jsx('input', {
                                            ...
                                            className:
                                              'w-full border border-brown-300 rounded px-3 py-2',
                                          }),
                                        ],
                                      }),
                                      s.jsxs('div', {
                          ...
                          s.jsxs('div', {
                            ...
                            children: [
                              s.jsxs('button', {
                                id: 'standardCheckout',
                                className:
                                  'w-full bg-green-600 text-white py-3 px-6 rounded-lg hover:bg-green-700 transition-colors font-medium',
                                children: [
                                  'Complete Payment - $',
                                  (i.price / 4).toLocaleString(),
                                ],
                              ...
                              s.jsx('button', {
                                id: 'bnplCheckout',
                                className:
                                  'hidden w-full bg-green-600 text-white py-3 px-6 rounded-lg hover:bg-green-700 transition-colors font-medium',
                                onClick: () =>
                                  (window.location.href =
                                    '/bnpl-frontend.html'),
                                children: 'Choose Buy Now, Pay Later Plan',
                              }),
                            ],
                          }),
                          s.jsx('script', {
                ...
                children: [
                            ...
                            'div',
                            {
                              ...
                              children: [
                                ...
                                s.jsxs('div', {
                                  ...
                                  children: [
                                    'Expires: ',
                                    new Date(e.expires).toLocaleDateString(),
                                  ],
                                }),
                              ],
                            },
                  ...
                  s.jsxs('div', {
                    ...
                    children: [
                      ...
                      s.jsx(l, {
                        to: '/compliance',
                        className:
                          'bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors text-sm',
                  ...
                  s.jsxs('div', {
                    ...
                    children: [
                      ...
                      s.jsxs('div', {
                        ...
                        children: [
                          s.jsxs('div', {
                            ...
                            children: [
                              s.jsx(t, { className: 'h-4 w-4 mr-2' }),
                          ...
                          s.jsxs('div', {
                            className: 'flex items-center text-brown-600',
                            children: [
                              s.jsx(n, { className: 'h-4 w-4 mr-2' }),
                          ...
                          s.jsxs('div', {
                            className: 'flex items-center text-brown-600',
                            children: [
                              s.jsx(a, { className: 'h-4 w-4 mr-2' }),
                      ...
                      s.jsx('button', {
                        className:
                          'w-full mt-4 bg-beige-100 text-brown-900 py-2 rounded-lg hover:bg-brown-300 transition-colors text-sm',
              ...
              s.jsxs('div', {
                ...
                children: [
                  s.jsx('div', {
                    ...
                    children: s.jsx('h2', {
                      className: 'text-xl font-bold text-brown-900',
                      children: 'Federal Funding Applications',
                    }),
                  }),
                  s.jsxs('div', {
                    className: 'p-6',
                    children: [
                      ...
                      s.jsx('div', {
                        ...
                        children: s.jsx(l, {
                          to: '/compliance/eligibility-verification',
                          className:
                            'bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors',
                          children: 'Apply for New Funding',
                        }),
                      }),
                    ],
                  }),
