...
function l() {
  ...
  const m = async () => {
    if (!t) return (x('Database service is not available'), void d(!1));
    try {
      (d(!0), x(null));
      const {
        data: { user: e },
      } = await t.auth.getUser();
      if (!e) return void x('Please log in to view your grades');
      ...
      null == l ||
        l.forEach((e) => {
          var s, t, r;
          const l =
            null == (t = null == (s = e.quiz_questions) ? void 0 : s.lessons)
              ? void 0
              : t.course_id;
          if (!l) return;
          i[l] || (i[l] = { correct: 0, total: 0, quizzes: [] });
          const d =
            e.answer === (null == (r = e.quiz_questions) ? void 0 : r.answer);
          (i[l].total++, d && i[l].correct++);
        });
      const o = Object.entries(i).map(([e, s]) => ({
        courseId: e,
      ...
      (console.error('Error fetching student grades:', e), x(e.message));
    } finally {
      d(!1);
    }
  };
      ...
      children: [
        ...
        o &&
          s.jsx('div', {
            ...
            children: s.jsx('p', { className: 'text-red-800', children: o }),
          }),
        l
          ? s.jsxs('div', {
          ...
          : s.jsxs('div', {
              ...
              children: [
                s.jsxs('div', {
                  className:
                    'bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-lg p-6 text-white',
                  children: [
                    s.jsx('h2', {
                      ...
                      children: [
                        ...
                        s.jsxs('div', {
                          ...
                          children: [
                            s.jsx('div', {
                              className: 'text-3xl font-bold',
                              children: n.reduce((e, s) => e + s.total, 0),
                            }),
                            s.jsx('div', {
                              className: 'text-sm',
                      ...
                      ? s.jsxs('div', {
                          ...
                          children: [
                            ...
                            s.jsx('a', {
                              href: '/programs',
                              className:
                                'text-green-600 hover:underline mt-2 inline-block',
                      ...
                      : s.jsx('div', {
                          ...
                          children: i.map((e) => {
                            ...
                            const l = n.find((s) => {
                                ...
                                return (
                                  s.courseId ===
                                  (null == (t = e.courses) ? void 0 : t.id)
                                );
                              }),
                              d = (null == l ? void 0 : l.percentage) || 0,
                              a = ((e) =>
                                e >= 90
                                  ? 'A'
                                  : e >= 80
                                  ...
                                  children: [
                                    s.jsxs('div', {
                                      ...
                                      children: [
                                        s.jsx('h3', {
                                          className:
                                            'text-lg font-bold text-brown-900',
                                          children:
                                            (null == (t = e.courses)
                                              ? void 0
                                              : t.title) || 'Unknown Course',
                                        }),
                                        s.jsx('p', {
                                    ...
                                    s.jsxs('div', {
                                      ...
                                      children: [
                                        s.jsx('div', {
                                          className: `text-4xl font-bold ${i}`,
                                          children: a,
                                        }),
                                        s.jsxs('div', {
                                        ...
                                        l
                                          ...
                                          : s.jsx('div', {
                                              ...
                                              children: s.jsx('span', {
                                                className:
                                                  'px-3 py-1 bg-beige-100 text-brown-600 rounded-full text-xs font-semibold',
