...
function o() {
  const [o, d] = e.useState('all'),
    ...
    m = 'all' === o ? g : g.filter((e) => e.category === o);
  return s.jsxs('div', {
      ...
      s.jsx('div', {
        ...
        children: s.jsxs('div', {
          ...
          children: [
            ...
            s.jsx('p', {
              className: 'text-xl text-brown-600 max-w-3xl',
              children:
          ...
          children: m.map((e) => {
            ...
            return s.jsxs(
              l,
              {
                to: `/lms/course/${e.id}`,
                className:
                  'group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1',
                children: [
                  s.jsxs('div', {
                    ...
                    children: [
                      ...
                      s.jsx('div', {
                        ...
                        children: s.jsx('div', {
                          className:
                            'bg-white/90 backdrop-blur-sm rounded-full p-4',
                          children: s.jsx(r, {
                            className: 'h-8 w-8 text-green-600 fill-blue-600',
                          }),
                        }),
                      }),
                      s.jsx('div', {
                        ...
                        children: s.jsx('span', {
                          className:
                            'bg-white/90 backdrop-blur-sm text-brown-900 text-xs font-semibold px-3 py-1 rounded-full',
                          children: e.level,
                        }),
                      }),
                      s.jsx('div', {
                        ...
                        children: s.jsx('span', {
                          className:
                            'bg-green-500/90 backdrop-blur-sm text-white text-xs font-bold px-3 py-1 rounded-full',
                          children: 'FREE',
                        }),
                      }),
                    ],
                    ...
                    children: [
                      s.jsx('div', {
                        ...
                        children: s.jsx('span', {
                          ...
                          children:
                            null == (o = c.find((s) => s.id === e.category))
                              ? void 0
                              : o.name,
                        }),
                      }),
                      s.jsx('h3', {
                        className:
                          'font-semibold text-brown-900 mb-2 line-clamp-2 group-hover:text-green-600 transition-colors',
                        children: e.title,
                      }),
                      s.jsx('p', {
                      ...
                      s.jsxs('div', {
                        className:
                          'flex items-center gap-1 text-xs text-brown-500 mb-3',
                        children: [
                          s.jsx(t, { className: 'h-3 w-3' }),
                          s.jsx('span', { children: e.instructor }),
                        ],
                      }),
                      s.jsxs('div', {
                        className:
                          'flex items-center justify-between text-sm text-brown-600 pt-3 border-t border-gray-100',
                        children: [
                          s.jsxs('div', {
                            className: 'flex items-center gap-1',
                            children: [
                              s.jsx(a, { className: 'h-4 w-4' }),
                              s.jsxs('span', {
                                children: [e.lessons, ' lessons'],
                              }),
                            ],
                          }),
                          s.jsxs('div', {
                      ...
                      s.jsxs('div', {
                        className:
                          'flex items-center gap-1 text-xs text-brown-500 mt-2',
                        children: [
                          s.jsx(n, { className: 'h-3 w-3' }),
                          s.jsxs('span', {
                            children: [
