          ...
          e.jsxs('header', {
            ...
            children: [
              ...
              e.jsx('p', {
                ...
                children:
                  'Welcome to the Elevate for Humanity Instructor Portal. Manage your courses, track student progress, and access teaching resources all in one place.',
              }),
            ],
          }),
          e.jsxs('section', {
                ...
                children: e.jsxs('ul', {
                  ...
                  children: [
                    e.jsx(i, {
                      ...
                      description:
                        'Best practices and guidelines for effective online teaching',
                    }),
                    e.jsx(i, {
                      title: 'Course Design Templates',
                      description:
                        'Pre-built templates to help structure your course content',
                    }),
                    e.jsx(i, {
                      title: 'Assessment Tools',
                      description:
                        'Create quizzes, assignments, and grading rubrics',
                    }),
                    e.jsx(i, {
...
function s({ title: r, description: o, link: n }) {
  return e.jsxs(t, {
    to: n,
    style: {
      display: 'block',
    ...
    children: [
      ...
      e.jsx('p', { style: { color: '#6b5d52', margin: 0 }, children: o }),
    ],
  });
}
function i({ title: t, description: r }) {
  return e.jsxs('li', {
    style: {
      padding: '1rem 0',
    ...
    children: [
      ...
      e.jsx('p', {
        style: { color: '#6b5d52', margin: 0, fontSize: '0.875rem' },
        children: r,
      }),
    ],
  });
