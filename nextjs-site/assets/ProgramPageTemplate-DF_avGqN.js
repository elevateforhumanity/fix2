...
import { H as t } from './Hero-OZm9SWPG.js';
...
function c({
  ...
  return e.jsxs('div', {
    children: [
      e.jsxs(s, {
        children: [
          e.jsxs('title', { children: [c, ' | Elevate for Humanity'] }),
          e.jsx('meta', { name: 'description', content: d }),
        ],
      }),
      e.jsx(a, {}),
      e.jsx(t, {
      ...
      e.jsx(r, {
        ...
        children: e.jsxs('div', {
          ...
          children: [
            ...
            e.jsx('p', { className: 'body-large', children: m }),
          ],
        }),
      }),
      e.jsx(r, {
              ...
              children: j.map((s, a) =>
                e.jsxs(
                  'div',
                  {
                    ...
                    children: [
                      e.jsx('span', {
                        className: 'text-[var(--color-green-600)] font-bold',
                        children: '•',
                      }),
                      e.jsx('span', { children: s }),
                    ],
          ...
          children: [
            ...
            e.jsxs('p', {
              ...
              children: [
                'Apply now for ',
                c,
                ' and transform your career with 100% funded training.',
              ],
            }),
            e.jsxs('div', {
              ...
              children: [
                e.jsx('a', {
                  href: '/apply',
                  className: 'button-white button-large',
                  children: 'Apply Now',
                }),
                e.jsx('a', {
                  href: '/programs',
