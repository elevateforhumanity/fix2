...
function l() {
  const l = [
    ...
    {
      icon: e.jsx(a, { className: 'h-6 w-6' }),
      title: 'Empowering',
      desc: 'Inspiring action and growth',
    },
    {
      icon: e.jsx(n, { className: 'h-6 w-6' }),
      title: 'Professional',
        ...
        children: e.jsxs('div', {
          ...
          children: [
            e.jsx('h1', {
              ...
              children: 'EFH Ecosystem Visual Identity',
            }),
            e.jsx('p', {
              className: 'text-xl text-blue-100 max-w-2xl',
              children:
                'Our brand reflects our commitment to elevating individuals and communities through workforce development.',
            }),
          ],
        }),
      }),
                ...
                e.jsxs(
                  'div',
                  {
                    ...
                    children: [
                      e.jsx('div', {
                        className:
                          'inline-flex items-center justify-center w-12 h-12 bg-green-600/10 rounded-lg mb-4 text-green-600',
                        children: s.icon,
                      }),
                      e.jsx('h3', {
                        className: 'font-bold text-brown-900 mb-2',
                        children: s.title,
                      }),
                      e.jsx('p', {
      ...
      e.jsx('section', {
        ...
        children: e.jsxs('div', {
          ...
          children: [
            ...
            e.jsxs('div', {
              className:
                'grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto',
              children: [
                e.jsxs('div', {
                  className: 'text-center',
                  children: [
                    e.jsx('div', {
                      className: 'h-24 bg-green-600 rounded-lg mb-2',
                    }),
                    e.jsx('div', {
                ...
                e.jsxs('div', {
                  ...
                  children: [
                    e.jsx('div', {
                      className: 'h-24 bg-brown-600 rounded-lg mb-2',
                    }),
                    e.jsx('div', {
                      className: 'font-medium',
        ...
        children: e.jsxs('div', {
          ...
          children: [
            ...
            e.jsx('p', {
              ...
              children: 'Download logos, style guides, and marketing materials',
            }),
            e.jsx('a', {
              href: '/contact',
              className: 'btn',
              children: 'Request Brand Kit',
            }),
          ],
        }),
      }),
