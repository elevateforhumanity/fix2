...
import { u as s } from './vendor-router-CQjfSXV_.js';
...
const t = {
  ...
  'digital-marketing-essentials': {
    ...
    modules: [
      ...
      { title: 'Analytics', lessons: ['Google Analytics', 'KPIs'] },
    ],
...
function r() {
  ...
  return i.jsxs('main', {
    ...
    children: [
      i.jsx('h1', { style: { fontSize: 32 }, children: n.title }),
      i.jsx('img', {
        src: n.coverUrl,
        alt: n.title,
        title: n.title,
      ...
      i.jsx('h2', { style: { marginTop: 32 }, children: 'Modules' }),
      i.jsx('ul', {
        children: n.modules.map((e, s) =>
          i.jsxs(
            'li',
            {
              ...
              children: [
                ...
                i.jsx('ul', {
                  children: e.lessons.map((e, s) =>
                    i.jsx('li', { children: e }, s)
                  ),
                }),
              ],
            },
      ...
      i.jsx('h2', { style: { marginTop: 32 }, children: 'Quizzes' }),
      i.jsx('ul', {
        children: n.quizzes.map((e, s) =>
          i.jsxs(
            'li',
      ...
      l
        ? i.jsx('div', {
            style: { marginTop: 32, color: '#388e3c', fontWeight: 'bold' },
            children: 'You are enrolled! Progress tracking is now enabled.',
          })
        : i.jsx('button', {
            style: {
              marginTop: 32,
