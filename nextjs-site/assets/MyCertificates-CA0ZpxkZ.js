...
import { g as a } from './auth-tBRKQLtx.js';
import { a as i } from './certificates-Y_9npsL2.js';
          ...
          children: s.jsxs('div', {
            ...
            children: [
              ...
              s.jsx('p', {
                ...
                children: 'Your earned certificates and credentials',
              }),
              s.jsxs('div', {
                            ...
                            s.jsxs('div', {
                              children: [
                                s.jsx('div', {
                                  ...
                                  children:
                                    null == (a = e.courses) ? void 0 : a.code,
                                }),
                                s.jsx('h3', {
                                  className: 'mt-1 text-xl font-semibold',
                                  children:
                                    null == (i = e.courses) ? void 0 : i.title,
                                }),
                                s.jsxs('div', {
                                ...
                                s.jsx('div', {
                                  className:
                                    'mt-1 text-xs text-brown-500 font-mono',
                  ...
                  0 === r.length &&
                    s.jsxs('div', {
                      ...
                      children: [
                        ...
                        s.jsx('p', {
                          className: 'mt-2 text-brown-600',
                          children: 'Complete courses to earn certificates',
                        }),
                        s.jsx(t, {
                          to: '/lms/courses',
                          className: 'btn mt-4',
