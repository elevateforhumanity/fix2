...
import { c as s } from './vendor-router-CQjfSXV_.js';
...
const a = [
  ...
  r = { draft: '📝', sent: '📧', paid: '✅', overdue: '⚠️' },
  i = () => {
    const i = s(),
      [d] = e.useState(a),
      [c, n] = e.useState('all'),
      x = 'all' === c ? d : d.filter((e) => e.status === c),
      m = d.filter((e) => 'paid' === e.status).reduce((e, t) => e + t.total, 0),
      o = d
        .filter((e) => 'sent' === e.status || 'overdue' === e.status)
                ...
                t.jsxs('div', {
                  children: [
                    ...
                    t.jsx('p', {
                      ...
                      children: 'Manage and track your invoices',
                    }),
                  ],
                }),
                t.jsx('button', {
                  onClick: () => i('/invoice/create'),
                  className:
            ...
            children: [
              t.jsx('div', {
                ...
                children: t.jsx('div', {
                  ...
                  children: ['all', 'draft', 'sent', 'paid', 'overdue'].map(
                    (e) =>
                      t.jsxs(
                        'button',
                        {
                                  ...
                                  children: [
                                    ...
                                    t.jsx('td', {
                                      ...
                                      children: t.jsxs('span', {
                                        className: `inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${l[e.status]}`,
                                        children: [
                                          t.jsx('span', {
                                            className: 'mr-1',
                                            children: r[e.status],
                                        ...
                                        children: [
                                          ...
                                          t.jsx('button', {
                                            onClick: () =>
                                              ((e) => {
                                                alert(
                                                  `Downloading PDF for ${e.invoiceNumber}`
                                                );
                                              })(e),
                                            className:
                                          ...
                                          ('sent' === e.status ||
                                            ...
                                            t.jsx('button', {
                                              onClick: () =>
                                                ((e) => {
                                                  alert(
                                                    `Reminder sent to ${e.customerEmail}`
                                                  );
                                                })(e),
                                              className:
                                                'text-orange-600 hover:text-orange-800 font-medium text-sm',
                                              title: 'Send Reminder',
                                              children: '🔔',
                                            }),
                                        ],
