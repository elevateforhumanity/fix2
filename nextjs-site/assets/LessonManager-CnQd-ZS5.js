...
import { u as t, L as l } from './vendor-router-CQjfSXV_.js';
import { s as a } from './supa-DdKhhKHf.js';
...
function n() {
  const { courseId: n } = t(),
    ...
    [o, d] = e.useState([]),
    [c, m] = e.useState(!1),
    [x, u] = e.useState({ title: '', video_url: '', html: '' });
  async function h() {
            ...
            children: [
                ...
                s.jsxs('form', {
                  onSubmit: async function (e) {
                    ...
                    const s = o.length + 1,
                      { error: t } = await a
                        .from('lessons')
                        .insert([{ course_id: n, idx: s, ...x }]);
                    t
                      ? alert(t.message)
                      : (u({ title: '', video_url: '', html: '' }), m(!1), h());
                  },
                  ...
                  children: [
                    s.jsxs('div', {
                      children: [
                        ...
                        s.jsx('input', {
                          ...
                          value: x.title,
                          onChange: (e) => u({ ...x, title: e.target.value }),
                    ...
                    s.jsxs('div', {
                      children: [
                        s.jsx('label', {
                          className: 'block text-sm font-medium mb-1',
                          children: 'Video URL (YouTube embed)',
                        }),
                        s.jsx('input', {
                          type: 'url',
                    ...
                    s.jsxs('div', {
                      children: [
                        ...
                        s.jsx('textarea', {
                          value: x.html,
                          onChange: (e) => u({ ...x, html: e.target.value }),
                          className:
              ...
              s.jsxs('div', {
                ...
                children: [
                        ...
                        children: [
                          s.jsxs('div', {
                            children: [
                              ...
                              e.video_url &&
                                s.jsx('div', {
                                  className: 'mt-1 text-xs text-brown-500',
                                  children: '📹 Video',
                                }),
                            ],
                          }),
                  ...
                  0 === o.length &&
                    s.jsx('div', {
                      className: 'card p-6 text-center text-brown-600',
                      children:
