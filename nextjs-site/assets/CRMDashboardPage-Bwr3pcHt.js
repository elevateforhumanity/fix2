...
const s = [
  ...
  a = () => {
    const [a] = e.useState(s),
      [i, r] = e.useState('all'),
      [c, n] = e.useState(!1),
      d = 'all' === i ? a : a.filter((e) => e.status === i),
      x = a.reduce((e, t) => e + t.value, 0),
      o = a
        .filter((e) => 'customer' !== e.status)
        .reduce((e, t) => e + t.value, 0),
      m = {
        lead: a.filter((e) => 'lead' === e.status).length,
        qualified: a.filter((e) => 'qualified' === e.status).length,
        proposal: a.filter((e) => 'proposal' === e.status).length,
        customer: a.filter((e) => 'customer' === e.status).length,
      };
    return t.jsxs('div', {
          ...
          children: [
                  ...
                  t.jsxs('div', {
                    children: [
                      ...
                      t.jsx('p', {
                        ...
                        children: 'Manage your contacts and sales pipeline',
                      }),
                    ],
                  }),
                  t.jsx('button', {
                    onClick: () => n(!0),
                    className:
                      'mt-4 sm:mt-0 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium',
            ...
            t.jsxs('div', {
              ...
              children: [
                ...
                t.jsx('div', {
                  ...
                  children: Object.entries(l).map(([e, s]) =>
                    t.jsxs(
                      'div',
                      {
                        className:
                          'border-2 border-gray-200 rounded-lg p-4 hover:border-blue-500 transition-colors cursor-pointer',
                        onClick: () => r(e),
                        children: [
                          t.jsxs('div', {
                  ...
                  children: t.jsxs('div', {
                    ...
                    children: [
                      t.jsxs('button', {
                        ...
                        children: ['All Contacts (', a.length, ')'],
                      }),
                              ...
                              children: [
                                ...
                                t.jsx('td', {
                                  ...
                                  children: t.jsxs('span', {
                                    className: `inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${l[e.status].color}`,
                                    children: [
                                      t.jsx('span', {
                                        className: 'mr-1',
                                        children: l[e.status].icon,
                                      }),
                                      l[e.status].label,
                                    ],
                                  }),
            ...
            t.jsx('div', {
              ...
              children: t.jsxs('div', {
                ...
                children: [
                  t.jsx('div', { className: 'text-3xl mr-4', children: '🔗' }),
                  t.jsxs('div', {
                    children: [
                      t.jsx('h3', {
                        className: 'font-semibold text-lg text-blue-900 mb-2',
                        children: 'HubSpot Integration Available',
                      }),
                      t.jsx('p', {
                        className: 'text-blue-800 mb-4',
                        children:
                          'Connect your HubSpot account to sync contacts, track deals, and automate your sales process.',
                      }),
                      t.jsx('button', {
                        className:
                          'px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium',
                        children: 'Connect HubSpot',
                      }),
                    ],
                  }),
                ],
            ...
            children: t.jsxs('div', {
              ...
              children: [
                ...
                t.jsx('button', {
                  onClick: () => n(!1),
                  className:
                    'px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300',
                  children: 'Close',
                }),
              ],
            }),
