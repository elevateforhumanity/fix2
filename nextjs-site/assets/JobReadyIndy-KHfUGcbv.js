...
import { F as c } from './Footer-Dh9yHrAI.js';
...
const d = {
  ...
  m = () => {
    const m = d,
      ...
      b = m.badges.map((e) => ({ ...e, icon: p[e.id] || s }));
    return l.jsxs('div', {
      children: [
        l.jsxs(i, {
          children: [
            l.jsx('title', {
              children: 'Job Ready Indy | Elevate for Humanity',
            }),
            l.jsx('meta', {
              name: 'description',
              content:
                'Job Ready Indy training programs through Elevate for Humanity Career and Training Institute',
            }),
          ],
        }),
        l.jsx(o, {}),
        l.jsxs('div', {
          ...
          children: [
            l.jsx('div', {
              className:
                'bg-gradient-to-r from-green-600 to-green-700 text-white py-20',
              children: l.jsx('div', {
                ...
                children: l.jsxs('div', {
                  ...
                  children: [
                    l.jsx('h1', {
                      ...
                      children: 'Job Ready Indy',
                    }),
                    l.jsx('p', {
                      className: 'text-2xl mb-6',
                      children: m.organization,
                    }),
                    l.jsxs('p', {
                      className: 'text-lg mb-4 text-blue-100',
                      children: ['Facilitator: ', m.facilitator],
                    }),
                    l.jsx('p', {
                      className: 'text-xl mb-8 max-w-3xl mx-auto',
                      children:
                        "Build essential workplace skills through EmployIndy's Job Ready Indy program. Earn digital badges recognized by employers across Indianapolis.",
                    }),
                    l.jsxs('a', {
                      href: x,
                      target: '_blank',
                      ...
                      className:
                        'inline-flex items-center bg-white text-blue-600 px-8 py-4 rounded-lg text-lg font-bold hover:bg-gray-100 transition',
                      children: [
                        'Register for JRI',
                        l.jsx(r, { className: 'w-5 h-5 ml-2' }),
                      ],
                    }),
                  ],
                }),
            ...
            l.jsxs('div', {
              ...
              children: [
                l.jsxs('div', {
                  ...
                  children: [
                    l.jsx('h2', {
                      ...
                      children: 'What is Job Ready Indy?',
                    }),
                    l.jsx('p', {
                      className:
                        'text-lg text-gray-700 mb-6 text-center max-w-3xl mx-auto',
                      children:
                        'Job Ready Indy (JRI) is a free, online program that helps you develop the essential skills employers are looking for. Complete six badge courses to demonstrate your workplace readiness and stand out to employers.',
                    }),
                    l.jsxs('div', {
                      ...
                      children: [
                        ...
                        l.jsxs('div', {
                          ...
                          children: [
                            l.jsx('div', {
                              className:
                                'bg-purple-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4',
                              children: l.jsx(t, {
                            ...
                            children: [
                              l.jsxs('div', {
                                ...
                                children: [
                                  l.jsx('div', {
                                    className:
                                      'bg-blue-100 rounded-full p-3 mr-4',
                                    children: l.jsx(t, {
                      ...
                      children: [
                        l.jsxs('div', {
                          ...
                          children: [
                            l.jsx(n, {
                              className:
                                'w-6 h-6 text-green-600 mr-3 mt-1 flex-shrink-0',
                            }),
                            l.jsxs('div', {
                              children: [
                                l.jsx('h3', {
                ...
                l.jsxs('div', {
                  className:
                    'bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg p-8 mb-12',
                  children: [
                    l.jsx('h2', {
                      className: 'text-3xl font-bold mb-6 text-center',
                    ...
                    l.jsxs('div', {
                      ...
                      children: [
                        l.jsxs('a', {
                          ...
                          rel: 'noopener noreferrer',
                          className:
                            'bg-white text-blue-600 p-6 rounded-lg hover:bg-gray-100 transition text-center',
                          children: [
                            l.jsx('h3', {
                            ...
                            l.jsx('p', {
                              ...
                              children: 'Sign up for Job Ready Indy',
                            }),
                            l.jsx(r, { className: 'w-6 h-6 mx-auto' }),
                          ],
                        }),
                        l.jsxs('a', {
                          href: h,
                    ...
                    l.jsxs('div', {
                      ...
                      children: [
                        l.jsx('a', {
                          ...
                          className:
                            'bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition',
                          children: 'Contact Facilitator',
                        }),
                        l.jsx('a', {
                          href: 'tel:+13173143757',
                          className:
                            'bg-green-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-green-700 transition',
                          children: 'Call (317) 314-3757',
                        }),
                      ],
                    }),
                  ],
