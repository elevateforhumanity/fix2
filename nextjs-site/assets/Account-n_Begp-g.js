...
import { u as a, s as l } from './auth-tBRKQLtx.js';
import { s as t } from './supa-DdKhhKHf.js';
import { c as n } from './vendor-router-CQjfSXV_.js';
import './vendor-Da1LjC7-.js';
import './vendor-supabase-C00Cu5KO.js';
function r() {
  var r;
  const { user: i, loading: c } = a(),
    o = n(),
    [d, m] = s.useState(
      null != (r = null == i ? void 0 : i.full_name) ? r : ''
    ),
    [u, x] = s.useState(!1),
    [h, j] = s.useState('');
  return (
    s.useEffect(() => {
      var s;
      m(null != (s = null == i ? void 0 : i.full_name) ? s : '');
    }, [i]),
    c
      ? e.jsx('section', {
          className: 'section',
                ...
                e.jsxs('div', {
                  ...
                  children: [
                    ...
                    h &&
                      e.jsx('div', {
                        className:
                          'p-3 bg-beige-50 border border-brown-200 rounded-lg text-sm',
                        children: h,
                      }),
                    e.jsxs('div', {
                            ...
                            if (i) {
                              ...
                              try {
                                const { error: s } = await t
                                  .from('profiles')
                                  .upsert({ id: i.id, full_name: d });
                                if (s) throw s;
                                j('Profile updated successfully!');
                              } catch (s) {
                                j(s.message);
                              } finally {
                                x(!1);
                  ...
                  e.jsxs('div', {
                    ...
                    children: [
                      ...
                      e.jsx('p', {
                        ...
                        children: 'Manage your courses and lessons',
                      }),
                      e.jsx('a', {
