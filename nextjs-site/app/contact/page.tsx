          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  <a href="tel:+13175551234" className="text-orange-600 hover:text-orange-700">
                    (317) 555-1234
                  </a>
                </p>
              </div>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Yes! All our programs are 100% funded through WIOA (Workforce Innovation and Opportunity Act) and WRG (Workforce Ready Grant) programs. There is no cost to eligible participants.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Eligibility is determined by WorkOne Indiana. Generally, you must be a resident of Indiana and meet certain income or employment criteria. Contact us to learn more about your specific situation.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Program lengths vary. The Barber Apprenticeship is 2,000 hours, while other programs have flexible schedules. Most programs can be completed in 6-18 months depending on your pace and schedule.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                We have a 92% job placement rate. Many of our programs include paid apprenticeships with employer partners, and we provide job placement assistance to all graduates.
              </p>
            </div>
          </div>
        </div>
