    ...
    <>
      ...
      <section>
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          />
          <StatCard icon={Briefcase} label="Job Placement" value="80%" />
        </div>
      </section>
  ...
  curriculum: [
    {
      ...
      description:
        'Learn healthcare basics, medical terminology, and patient rights',
      hours: 20,
      topics: [
  ...
  faq: [
    {
      ...
      answer:
        'Yes! The program is fully funded through WIOA, Workforce Ready Grant, or JRI. No tuition, no hidden fees, no student debt.',
    },
    {
      question: 'How long does it take?',
      answer:
        'The program is 4-8 weeks depending on schedule. Full-time students complete in 4 weeks, part-time in 6-8 weeks.',
    },
    {
      question: 'Do I need experience?',
      answer:
        'No prior healthcare experience required. We start from the basics and train you completely.',
    },
    {
      question: 'Will I get a job after?',
      answer:
        'We have 80% job placement rate. We work with 500+ employers who actively hire our graduates.',
    },
    {
      question: 'What if I fail the state exam?',
      answer:
        "We provide free exam prep and support. If you don't pass, we offer free retake preparation.",
    },
  ],
  testimonials: [
    {
      ...
      quote:
        'I went from unemployed to working as a CNA in just 6 weeks. The training was excellent and completely free!',
    ...
    },
    {
      ...
      program: 'CNA Certification',
      quote:
        'Best decision I ever made. The instructors were amazing and helped me every step of the way.',
