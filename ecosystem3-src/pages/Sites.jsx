...
export function Sites() {
  const [site, setSite] = useState({
    title: 'My Site',
    pages: [{ id: 1, title: 'Home', content: 'Welcome to my site' }],
  });
  ...
  const addPage = () => {
    setSite({
      ...
      pages: [
        ...site.pages,
        { id: Date.now(), title: 'New Page', content: '' },
      ],
    });
  };
  return (
    <div style={{ display: 'flex', height: '100vh' }}>
      <div
        style={{ width: '200px', backgroundColor: '#f3f4f6', padding: '1rem' }}
      >
      ...
      <div style={{ flex: 1, padding: '2rem' }}>
        <input
          value={site.pages[currentPage]?.title}
          onChange={(e) => {
        ...
        />
        <textarea
          value={site.pages[currentPage]?.content}
          onChange={(e) => {
            const newPages = [...site.pages];
