...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  console.log(
    `   Priority 1.0: ${urls.filter((u) => u.priority === 1.0).length}`
  );
  console.log(
    `   Priority 0.9: ${urls.filter((u) => u.priority === 0.9).length}`
  );
  console.log(
    `   Priority 0.8: ${urls.filter((u) => u.priority === 0.8).length}`
  );
  console.log(
    `   Priority 0.7: ${urls.filter((u) => u.priority === 0.7).length}`
  );
  console.log(
    `   Priority 0.6: ${urls.filter((u) => u.priority === 0.6).length}`
  );
  console.log(
    `   Priority 0.3: ${urls.filter((u) => u.priority === 0.3).length}`
  );
}
