...
const mockFileContents: Record<string, string> = {
  ...
  '/app/layout.tsx': `export default async function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body>{children}</body>
    </html>
  ...
  '/components/Header.tsx': `export default async function Header() {
  return <header>Header Component</header>;
}`,
  '/components/Footer.tsx': `export default async function Footer() {
