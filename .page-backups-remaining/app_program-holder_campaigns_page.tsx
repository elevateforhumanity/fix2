...
export default async function ProgramOwnerCampaignsPage() {
  ...
  const handleSend = async () => {
    if (selectedStudents?.length ?? 0 === 0) {
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 pt-4 border-t border-gray-200">
                  <button
                    onClick={handleSend}
                    disabled={loading || selectedStudents?.length ?? 0 === 0}
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        ...
                        Send to {selectedStudents?.length ?? 0} Student
                        {selectedStudents?.length ?? 0 !== 1 ? 's' : ''}
                      </>
                    )}
                  </button>
                </div>
