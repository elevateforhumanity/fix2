...
export const metadata: Metadata = {
  title: 'Supersonic Fast Cash - Tax Refund Advance Indianapolis | Same Day Cash Advance',
  ...
  openGraph: {
    title: 'Supersonic Fast Cash - Same Day Tax Refund Advance Indianapolis',
    ...
    url: 'https://elevateforhumanity.org/supersonic-fast-cash',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Supersonic Fast Cash - Tax Refund Advance Indianapolis',
    description: 'Get your tax refund advance TODAY in Indianapolis. Fast cash, no waiting!',
  },
  alternates: {
    canonical: 'https://elevateforhumanity.org/supersonic-fast-cash',
  },
};
  ...
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <div className="flex flex-wrap gap-4 justify-center mb-8">
              ...
              <Link
                href="/supersonic-fast-cash/upload"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-900 mb-8">
              Don't wait weeks for your refund. Get it in days with Supersonic Fast Cash!
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <a
                href="https://calendly.com/supersonicfastcash/tax-appointment"
      ...
      <section className="py-12 bg-slate-900 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h3 className="text-2xl font-bold mb-4">Supersonic Fast Cash</h3>
