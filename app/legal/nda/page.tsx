...
export const metadata: Metadata = {
  ...
  description: 'Non-Disclosure Agreement for Elevate for Humanity partners and stakeholders.',
};
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-700 mb-4">
              This Non-Disclosure Agreement ("Agreement") is entered into by and between Elevate for Humanity 
              ("Disclosing Party") and the individual or entity accessing confidential information ("Receiving Party").
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">2. Confidential Information</h2>
            <p className="text-slate-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">3. Obligations</h2>
            <p className="text-slate-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">4. Exceptions</h2>
            <p className="text-slate-700 mb-4">
              This Agreement does not apply to information that:
            </p>
            <ul className="list-disc pl-6 text-slate-700 space-y-2 mb-4">
              <li>Is or becomes publicly available through no breach of this Agreement</li>
              <li>Was rightfully in Receiving Party's possession prior to disclosure</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-700 mb-4">
              This Agreement remains in effect for the duration of the relationship between the parties 
              and for three (3) years thereafter.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">6. Remedies</h2>
            <p className="text-slate-700 mb-4">
              The Receiving Party acknowledges that breach of this Agreement may cause irreparable harm 
              for which monetary damages may be inadequate. The Disclosing Party shall be entitled to 
              seek injunctive relief in addition to any other remedies available at law or in equity.
            </p>
          </section>
