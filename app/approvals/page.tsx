            ...
            <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-orange-600">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-slate-700 mb-4">Authorized to administer industry-recognized certification exams for:</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <p className="text-white/90 text-lg leading-relaxed">
                Our employers can trust that our programs are standards-aligned and reportable. Graduates meet industry requirements and are job-ready from day one.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <p className="text-white/90 text-lg leading-relaxed">
                Workforce boards, schools, reentry programs, and community partners can confidently refer people to Elevate For Humanity knowing we meet state and federal quality benchmarks.
              </p>
            </div>
          </div>
        </div>
