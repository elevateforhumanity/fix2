...
export const metadata: Metadata = {
  ...
  description: 'Explore Payroll and discover opportunities for career growth and development.',
};
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                <h2 className="text-3xl font-bold mb-6">Payroll</h2>
                <p className="text-gray-700 mb-6">Explore Payroll and discover opportunities for career growth and development.</p>
