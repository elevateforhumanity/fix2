      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-blue-50 border-l-4 border-brand-blue-600 p-6 mb-8">
          <p className="text-gray-700 leading-relaxed">
            Elevate for Humanity reserves the right to update services,
            eligibility, and policies as required by funding partners and
            regulations.
          </p>
        </div>
          ...
          <ul className="space-y-4 text-gray-700">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                completion, and funding approval are not guaranteed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-brand-orange-600 rounded-full mt-2 flex-shrink-0"></div>
              <span>
                ...
                Humanity does not control funding decisions.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-brand-orange-600 rounded-full mt-2 flex-shrink-0"></div>
              <span>
                ...
                not directly control all aspects of partner-delivered services.
              </span>
            </li>
          </ul>
        </div>
