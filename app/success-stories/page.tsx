  ...
  const stories = [
    {
      ...
      quote:
        'The WIOA program changed my life. I went from unemployed to working as a CNA at a top hospital in just 8 weeks.',
    ...
    },
    {
      ...
      quote:
        'I never thought I could afford training. WIOA covered everything and now I have a career I love.',
    ...
    },
    {
      ...
      quote:
        'The instructors were amazing and the job placement support helped me land my dream job.',
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-blue-50 to-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-600">
              See how WIOA-funded training has transformed lives and careers
              across Wisconsin
            </p>
          </div>
        </section>
              ...
              {stories.map((story, index) => (
                <Card key={story.id} className="overflow-hidden">
                  <CardContent className="p-0">
                    <div
                      className={`grid md:grid-cols-2 gap-8 ${index % 2 === 1 ? 'md:grid-flow-dense' : ''}`}
                    >
                      <div
                        className={`relative h-96 ${index % 2 === 1 ? 'md:col-start-2' : ''}`}
                      >
                        <Image
                          src={story.image}
                          alt={story.name}
        ...
        <section className="py-20 px-4 bg-red-600 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">
              Join thousands of Wisconsin residents who have transformed their
