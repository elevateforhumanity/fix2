...
export const metadata: Metadata = {
  ...
  description: 'Discover more about System Health inside the Elevate For Humanity workforce ecosystem.',
};
      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            System Health | Elevate For Humanity
          </h1>
          <p className="text-gray-600">
            Discover more about System Health inside the Elevate For Humanity workforce ecosystem.
          </p>
        </header>
