    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Tax Filing Reports</h1>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="space-y-3">
              <button className="w-full text-left px-4 py-3 border border-gray-200 rounded-lg hover:border-blue-500">
                ...
                <div className="text-sm text-gray-500">Returns filed and refunds processed</div>
              </button>
              <button className="w-full text-left px-4 py-3 border border-gray-200 rounded-lg hover:border-blue-500">
                <div className="font-semibold text-gray-900">Preparer Performance</div>
                <div className="text-sm text-gray-500">Individual preparer statistics</div>
              </button>
              <button className="w-full text-left px-4 py-3 border border-gray-200 rounded-lg hover:border-blue-500">
                <div className="font-semibold text-gray-900">Client Demographics</div>
                <div className="text-sm text-gray-500">Client breakdown and trends</div>
              </button>
            </div>
          </div>
