...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.elevateforhumanity.org/admin/external-modules/approvals",
  },
  title: 'Approvals | Elevate For Humanity',
  description: 'Explore Approvals and discover opportunities for career growth and development.',
};
