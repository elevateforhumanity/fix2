...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.elevateforhumanity.org/admin/course-studio-simple",
  },
  title: 'Course Studio Simple | Elevate For Humanity',
  description: 'Explore Course Studio Simple and discover opportunities for career growth and development.',
};
      ...
      <section className="relative h-[400px] md:h-[500px] lg:h-[600px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            Course Studio Simple
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-100">
            Explore Course Studio Simple and discover opportunities for career growth and development.
          </p>
