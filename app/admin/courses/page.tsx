...
export default async function AdminCoursesPage() {
  ...
  const enrollmentMap = enrollmentCounts?.reduce((acc: Record<number, number>, e) => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="elevate-nav">
        ...
        <nav className="flex gap-6 items-center">
          ...
          <Link href="/admin/students" className="text-gray-700 hover:text-red-600 font-medium">
            Students
          </Link>
      ...
      <main className="elevate-container py-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage course content, settings, and enrollments</p>
          </div>
          <Button asChild>
                  ...
                  <CardContent className="flex-1 flex flex-col justify-between">
                    <div className="space-y-2 mb-4 text-sm text-gray-600">
                      ...
                      {course.duration_hours && (
                        <div>Duration: <span className="font-medium">{course.duration_hours} hours</span></div>
                      )}
                      <div>Enrollments: <span className="font-medium">{enrollmentCount}</span></div>
                    </div>
