      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Weekly Hours Export</h1>
          </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <h3 className="font-semibold text-blue-900 mb-2">WorkOne/DWD Compliance</h3>
          <p className="text-sm text-blue-800">
            This export generates a CSV file formatted for WorkOne and Indiana Department of Workforce Development (DWD) reporting requirements. 
            The file includes all apprenticeship hours for the selected date range with approval status.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-6">Select Date Range</h2>
          ...
          <div className="bg-gray-50 rounded-md p-4 mb-6">
            <h3 className="text-sm font-semibold text-gray-900 mb-2">Export will include:</h3>
        ...
        <div className="mt-6 bg-white rounded-lg shadow p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">How to Use This Export</h2>
