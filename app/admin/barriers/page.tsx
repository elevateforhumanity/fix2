...
export const metadata: Metadata = {
  ...
  title: 'Barriers | Admin',
  description: 'Track and address student barriers',
};
      ...
      <section className="bg-blue-700 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-4xl font-bold mb-4">Barriers</h1>
            <p className="text-xl text-blue-100">Track and address student barriers</p>
          </div>
        </div>
      </section>
