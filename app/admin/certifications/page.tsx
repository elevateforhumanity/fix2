...
export const metadata: Metadata = {
  ...
  description: 'Manage certifications, credentials, and professional licenses for students and programs.',
};
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white rounded-lg shadow-sm border p-6">
                <h3 className="text-sm font-medium text-gray-600 mb-2">Total Certifications</h3>
