      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Test Email System</h1>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Email System Status</h2>
        ...
        {/* Test Email Types */}
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Send Test Emails</h2>
          <p className="text-sm text-gray-600 mb-6">
            Click a button below to send a test email to your admin account. Check your inbox to verify delivery.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-gray-500 mt-1">New user onboarding</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-center">
                <div className="font-semibold text-gray-900">Reminder Email</div>
                <div className="text-xs text-gray-500 mt-1">Action required alerts</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-center">
                <div className="font-semibold text-gray-900">Notification Email</div>
                <div className="text-xs text-gray-500 mt-1">Activity updates</div>
              </div>
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Automated Email Triggers</h2>
          <div className="space-y-3 text-sm">
            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded">
              <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
              <div>
                <div className="font-medium text-gray-900">Student Application</div>
                <div className="text-gray-600">Welcome email sent on successful enrollment</div>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded">
              <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
              <div>
                <div className="font-medium text-gray-900">Shop Partner Application</div>
                <div className="text-gray-600">Confirmation email sent to new shop partners</div>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded">
              <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
              <div>
                ...
                <div className="text-gray-600">Notification sent to admin on new inquiries</div>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded">
              <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
              <div>
                ...
                <div className="text-gray-600">Confirmation and admin notification emails</div>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded">
              <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
