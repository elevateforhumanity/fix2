...
export default function CoursesCatalog({ courses, categories, levels }: CoursesCatalogProps) {
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-between mt-6">
              <p className="text-gray-600">
                Showing <span className="font-semibold">{sortedCourses.length}</span> of <span className="font-semibold">{courses.length}</span> courses
              </p>
