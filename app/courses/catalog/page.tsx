...
const courses = [
  {
    ...
    description: 'Become an IRS-certified tax preparer. Learn tax law, filing procedures, and client service.',
    category: 'business',
    level: 'beginner',
    duration: '8 weeks',
    students: '342',
  ...
  {
    id: 'barber-fundamentals',
    title: 'Barber Fundamentals',
    description: 'Master cutting techniques, styling, and customer service. Prepare for state licensing.',
    category: 'trades',
    level: 'beginner',
    duration: '12 weeks',
    students: '289',
  ...
  },
  {
    ...
    description: 'Learn clinical procedures, patient care, and medical office administration.',
    category: 'healthcare',
    level: 'beginner',
    duration: '10 weeks',
    students: '456',
  ...
  },
  {
    ...
    description: 'Install, maintain, and repair heating and cooling systems. EPA certification prep included.',
    category: 'trades',
    level: 'beginner',
    duration: '12 weeks',
    students: '378',
  ...
  },
  {
    ...
    description: 'Get your CDL Class A license. Learn safe driving, regulations, and vehicle inspection.',
    category: 'trades',
    level: 'beginner',
    duration: '4 weeks',
    students: '523',
  ...
  },
  {
    ...
    description: 'Learn blood collection techniques, lab procedures, and patient interaction.',
    category: 'healthcare',
    level: 'beginner',
    duration: '8 weeks',
    students: '234',
  ...
  },
  {
    ...
    description: 'Master Microsoft Office, Google Workspace, email, and professional communication.',
    category: 'technology',
    level: 'beginner',
    duration: '6 weeks',
    students: '789',
  ...
  },
  {
    ...
    description: 'Learn electrical, plumbing, and HVAC basics for facility maintenance.',
    category: 'trades',
    level: 'intermediate',
    duration: '10 weeks',
    students: '198',
