...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.elevateforhumanity.org/program-holder/how-to-use",
  },
  title: 'How To Use | Elevate For Humanity',
  description: 'Discover more about How To Use inside the Elevate For Humanity workforce ecosystem.',
};
      ...
      <section className="bg-blue-700 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6">How To Use | Elevate For Humanity</h1>
            <p className="text-xl mb-8 text-blue-100">Discover more about How To Use inside the Elevate For Humanity workforce ecosystem.</p>
