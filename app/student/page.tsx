          ...
          <div className="max-w-xl">
            ...
            <div className="mt-4 flex flex-wrap gap-3 text-xs">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center rounded-md border border-blue-200 bg-transparent px-4 py-2 font-semibold text-white hover:bg-blue-500/30"
              >
                Go To My Dashboard
              </Link>
            </div>
