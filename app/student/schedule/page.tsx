      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 mb-6">
          <div className="text-center">
            <Calendar className="w-16 h-16 text-brand-blue-600 mx-auto mb-4" />
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <Link
                  ...
                  className="text-brand-green-600 hover:text-green-700 font-semibold text-sm"
                >
                  Log Hours →
                </Link>
              </div>
        ...
        <div className="mt-6 text-center">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-6 py-3 bg-brand-blue-600 text-white rounded-lg hover:bg-brand-blue-700 transition-colors font-semibold"
          >
