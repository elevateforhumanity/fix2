        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-base md:text-lg text-blue-100">
              Get personalized guidance from your AI instructor
            </p>
          </div>
        </div>
      </section>
              ...
              {aiInstructors && aiInstructors.length > 0 ? (
                                ...
                                <div className="grid md:grid-cols-2 gap-12 items-center">
                                  <div>
                                    ...
                                    <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                                      ...
                                      workforce for the first time, we're here
                                      to help you succeed. Our programs are 100%
                                      free, government-funded, and designed to
                                      get you hired fast.
                                    </p>
                ...
                <div className="bg-white rounded-lg shadow-sm border p-12 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">
                    No AI Instructors Available
                  </h3>
                  <p className="text-gray-600 mb-6">
                    Enroll in a program to get access to your AI instructor
                  </p>
                  <Link
                    href="/student/courses"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start">
                    <svg
                      className="w-5 h-5 text-brand-green-600 mr-2 flex-shrink-0 mt-0.5"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
              ...
              <div className="   rounded-lg shadow-sm p-6 text-white">
                ...
                <p className="text-sm opacity-90 mb-4">
                  Your AI instructor is here to help you succeed in your
                  program.
                </p>
                <Link
                  href="/support"
