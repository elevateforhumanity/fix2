      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="border-4 border-red-600 rounded-lg p-6 mb-4">
              <div className="text-center">
                ...
                <p className="text-lg text-slate-700 mb-2">HVAC Technician</p>
                <p className="text-sm text-slate-600">
                  Issued: November 15, 2025
                </p>
                <p className="text-xs text-slate-500 mt-2">
                  Certificate ID: HVAC-2025-001234
                </p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 opacity-50">
            <div className="border-4 border-slate-300 rounded-lg p-6 mb-4">
              <div className="text-center">
            ...
            <button
              disabled
              className="w-full px-4 py-2 bg-slate-300 text-slate-500 rounded-lg cursor-not-allowed"
            >
