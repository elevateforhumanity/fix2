...
export default function BusinessApprenticeCheckout() {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Business Apprenticeship Enrollment
          </h1>
          <p className="text-gray-600 mb-8">
            Complete your enrollment for the Business Start-Up & Marketing program
          </p>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">Business Start-Up & Marketing</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">WIOA • WRG</span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>✓ Business planning & LLC formation</li>
                  <li>✓ Digital marketing training</li>
                  <li>✓ Laptop kit provided</li>
                  <li>✓ Business match stipend</li>
