...
export default function EstheticsApprenticeCheckout() {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Esthetics Apprenticeship Enrollment
          </h1>
          <p className="text-gray-600 mb-8">
            Complete your enrollment for the Professional Esthetician program
          </p>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">Professional Esthetician</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">WIOA • WRG • Apprenticeship</span>
                </div>
                <div className="flex justify-between">
