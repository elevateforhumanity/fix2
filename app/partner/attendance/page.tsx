    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold text-center mb-6">Attendance | Elevate For Humanity</h1>
          <p className="text-xl text-center text-gray-600 mb-12">Learn more about Attendance inside the Elevate For Humanity workforce ecosystem.</p>
          <div className="prose prose-lg max-w-none">
            <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8">
              <p className="text-lg">Welcome to Attendance | Elevate For Humanity.</p>
            </div>
