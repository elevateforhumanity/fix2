      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-slate-700 mb-4">
              Our training facilities are designed to be accessible to all
              students:
            </p>
            <ul className="list-disc pl-6 mb-6 text-slate-700 space-y-2">
            ...
            <p className="text-slate-700 mb-4">
              We provide reasonable accommodations for students with
            ...
            <p className="text-slate-700 mb-6">
              ...
              website and services. Our efforts include regular accessibility
              audits, staff training, and updates to our digital platforms.
            </p>
            ...
            <p className="text-slate-700 mb-4">
              ...
              services. If you encounter any accessibility barriers, please let
              us know:
            </p>
            ...
            <p className="text-slate-700 mb-6">
              Some content on our website may be provided by third parties.
              While we strive to ensure all content is accessible, we may not
              have full control over third-party materials. We are working with
              our partners to improve accessibility across all platforms.
            </p>
