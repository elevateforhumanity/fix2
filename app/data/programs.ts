...
CIP Code: 51.0999 - Allied Health Diagnostic, Intervention, and Treatment Professions`,
  ...
  },
  {
    ...
    heroSubtitle: "5-week accelerated non-licensure training for job-ready skills in the high-demand personal care industry",
    shortDescription: "Comprehensive skincare training with hands-on practice, business startup support, and career readiness for spas, salons, and mobile beauty services",
...
CIP Code: 12.0409 - Aesthetician/Esthetician and Skin Care Specialist`,
    ...
    credential: "Certificate of Completion, Business of Retail Certified Specialist (NRF), Customer Service and Sales Certified Specialist (NRF), OSHA 10",
    approvals: ["ETPL Approved - Program ID #10004628", "WIOA Eligible", "Workforce Ready Grant Eligible", "CIP Code: 12.0409", "Non-Licensure Certificate Program"],
  ...
  },
  {
    ...
    heroSubtitle: "45-day inclusive program for peer support, recovery coaching, and reentry navigation - welcoming all backgrounds",
    shortDescription: "Accessible training for justice-involved individuals, career changers, and those with lived experience to become certified peer recovery coaches",
...
CIP Code: 43.0112 - Securities Services Administration/Management`,
    ...
    approvals: ["ETPL Approved - Program ID #10004666", "WIOA Eligible", "Workforce Ready Grant Eligible", "SNAP Eligible", "CIP Code: 43.0112"],
    fundingOptions: ["100% FREE through WIOA", "Workforce Ready Grant", "SNAP Support", "Public Assistance Programs", "Self-Pay: $4,750"],
    highlights: [
  ...
  },
  {
    ...
    heroSubtitle: "10-week IRS VITA/TCE certified training for tax preparation, bookkeeping, and financial services careers",
    shortDescription: "IRS-approved training with supervised practicum at VITA site, QuickBooks, Microsoft 365, and financial literacy certifications",
...
CIP Code: 52.0302 - Accounting Technology/Technician and Bookkeeping`,
    ...
    delivery: "Hybrid - Classroom instruction + Online IRS modules + Supervised practicum at IRS-approved VITA site",
    credential: "IRS VITA/TCE Certification, QuickBooks Pro Advisor, Microsoft 365 Fundamentals, Rise Up Certificate, Certificate of Completion",
    approvals: ["ETPL Approved - Program ID #10004627", "WIOA Eligible", "Workforce Ready Grant Eligible", "IRS VITA/TCE Approved Site", "SAM.gov Active Entity", "Authorized IRS e-file Provider", "CIP Code: 52.0302"],
