      ...
      <header className="border-b border-white/10 bg-black">
        <div className="mx-auto max-w-4xl px-6 py-6">
          ...
          <h1 className="mt-4 text-2xl font-bold">
            Training Provider / School Onboarding
          </h1>
        </div>
      </header>
          ...
          <div className="rounded-2xl border border-orange-400/40 bg-slate-900 p-6">
            ...
            <div className="space-y-3">
              <label className="flex items-start gap-3">
                ...
                <span className="text-sm">Provide safe environment</span>
              </label>
              <label className="flex items-start gap-3">
                <input type="checkbox" required className="mt-1 w-4 h-4" />
                <span className="text-sm">Allow Elevate check-ins</span>
              </label>
              <label className="flex items-start gap-3">
                <input type="checkbox" required className="mt-1 w-4 h-4" />
                <span className="text-sm">Notify Elevate of issues</span>
              </label>
            </div>
            <div className="mt-6">
              <label className="block text-sm font-semibold mb-2">
