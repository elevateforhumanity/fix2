      ...
      <section className="mx-auto max-w-4xl px-6 py-12">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-900 p-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-semibold mb-2">Program of Interest *</label>
                <select
                  required
                ...
                >
                  ...
                  <option value="building-tech">Building Maintenance Technician</option>
                  <option value="workforce-readiness">Workforce Readiness & Re-Entry</option>
          ...
          <div className="rounded-2xl border border-orange-400/40 bg-gradient-to-r from-slate-900 to-slate-950 p-6">
            ...
            <div className="space-y-3">
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) => setFormData({...formData, handbook_read: e.target.checked})}
                  className="mt-1 w-4 h-4 rounded border-white/20 bg-slate-800 text-orange-500 focus:ring-orange-400"
                />
                <span className="text-sm">
                  I have read the <Link href="/onboarding/handbook" className="text-orange-400 hover:underline">Universal Responsibilities Handbook</Link>
                </span>
              </label>
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) => setFormData({...formData, privacy_understood: e.target.checked})}
                  className="mt-1 w-4 h-4 rounded border-white/20 bg-slate-800 text-orange-500 focus:ring-orange-400"
                />
                <span className="text-sm">
                  I understand Elevate's privacy expectations and professional communication standards
                </span>
              </label>
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) => setFormData({...formData, attendance_commitment: e.target.checked})}
                  className="mt-1 w-4 h-4 rounded border-white/20 bg-slate-800 text-orange-500 focus:ring-orange-400"
                />
                <span className="text-sm">
                  I understand attendance is required and I will communicate absences in advance
                </span>
              </label>
            </div>
            ...
            <div className="mt-6">
              ...
              <p className="mt-2 text-xs text-slate-400">
                By typing your name, you agree to the terms and conditions outlined above.
              </p>
            </div>
          </div>
