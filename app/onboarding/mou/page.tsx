...
export const metadata: Metadata = {
  title: "Mou - Workforce Development Platform | Elevate for Humanity",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <header className="border-b border-white/10 bg-black">
        <div className="mx-auto max-w-4xl px-6 py-6">
          ...
          <h1 className="mt-4 text-3xl font-bold">Memorandum of Understanding (MOU)</h1>
          <p className="mt-2 text-lg text-slate-300">Partnership Agreement Template</p>
        </div>
      </header>
      <section className="mx-auto max-w-4xl px-6 py-12 prose prose-invert prose-orange max-w-none">
        <p className="text-lg">Between Elevate For Humanity™ and Partner Organization</p>
        
        <h2>1. Purpose</h2>
        <p>This MOU outlines expectations for collaboration in workforce training, education, apprenticeship, and employment pathways.</p>

        <h2>2. Elevate For Humanity™ Responsibilities</h2>
        <ul>
          <li>Provide accurate program information to learners and partners</li>
          <li>Support learners through coaching, case management, and navigation</li>
        ...
        <p>This MOU is effective upon signature and remains in effect until terminated by either party with 30 days written notice.</p>

        <h2>7. Modification</h2>
        <p>This MOU may be modified by mutual written agreement of both parties.</p>
        ...
        <div className="mt-12 p-6 rounded-2xl border border-orange-400/40 bg-slate-900">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-slate-400">Signature: ____________________</p>
              <p className="text-sm text-slate-400">Name: ____________________</p>
              <p className="text-sm text-slate-400">Title: ____________________</p>
              <p className="text-sm text-slate-400">Date: ____________________</p>
            </div>
            <div>
        ...
        <div className="mt-8 p-4 rounded-lg bg-slate-900 border border-white/10">
          <p className="text-sm text-slate-400">
            <strong>Note:</strong> This is a template. Please download, customize for your specific partnership, and have both parties sign before beginning collaboration.
          </p>
        </div>
      </section>
    </main>
