...
export const metadata: Metadata = {
  ...
  description: 'Discover more about Kingdomkonnect inside the Elevate For Humanity workforce ecosystem.',
};
      ...
      <section className="bg-blue-700 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6">Kingdomkonnect | Elevate For Humanity</h1>
            <p className="text-xl mb-8 text-blue-100">Discover more about Kingdomkonnect inside the Elevate For Humanity workforce ecosystem.</p>
