...
export default function HomePage() {
  ...
  return (
    <main>
      ...
      {/* Hero Section - Video Banner - Wix Style */}
      <section className="rich-hero relative h-[700px] w-full overflow-hidden">
        <video
          autoPlay
          loop
          muted
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-4">
          <div className="rich-container max-w-6xl w-full rich-animate">
            {/* Logo */}
            <div className="mb-8">
              <Image
                src="/logo.png"
            ...
            <div className="rich-badge mb-8">
              <Award className="w-5 h-5" />
              <span>WIOA-Funded Training Programs</span>
            </div>
            
            <h1 className="rich-headline text-white mb-6">
              "LIMITLESS OPPORTUNITIES WHERE LEARNING LEADS TO EARNING!"
            </h1>
            
            <p className="rich-body text-white/90 mb-12 max-w-3xl mx-auto text-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link
                href="/apply"
                className="rich-button-primary uppercase"
              >
                Apply Now
