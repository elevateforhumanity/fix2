      ...
      <section className="relative min-h-[250px] sm:h-[300px] md:h-[350px] flex items-center">
        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 drop-shadow-2xl">Building Maintenance Training</h1>
            <p className="text-xl md:text-2xl mb-8 drop-shadow-lg">Master HVAC, electrical, plumbing, and facility maintenance skills for high-demand careers</p>
