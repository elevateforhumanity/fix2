...
export const metadata: Metadata = {
  ...
  description: 'Tax preparation certification and small business development training. Free with funding when eligible.',
};
      ...
      <section className="bg-gradient-to-br from-blue-900 via-purple-900 to-black text-white py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl">
            Tax preparation certification and small business development training
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700">Tax prep certification + Business skills</p>
              </div>
            </div>
          </div>
        </div>
