...
import { GraduationCap, Clock, DollarSign, MapPin, CheckCircle, Users, Truck } from 'lucide-react';

export const metadata: Metadata = {
  title: 'CDL & Transportation',
  description: 'Commercial Driver License training for truck driving careers. Free with funding when eligible.',
};
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-green-50 rounded-lg p-6 text-center">
              <h3 className="font-bold text-black mb-2">Commercial Truck Driver</h3>
            </div>
            <div className="bg-green-50 rounded-lg p-6 text-center">
              <h3 className="font-bold text-black mb-2">Delivery Driver</h3>
            </div>
            <div className="bg-green-50 rounded-lg p-6 text-center">
              <h3 className="font-bold text-black mb-2">Transportation Specialist</h3>
            </div>
          </div>
        </div>
      </section>
