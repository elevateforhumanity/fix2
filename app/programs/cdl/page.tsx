...
export const metadata: Metadata = {
  ...
  description: 'Start your CDL career with free training. AI-powered learning, hands-on practice, and job placement support.',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] sm:h-[600px] md:h-[700px] w-full overflow-hidden bg-slate-900">
        ...
        >
          <source src="/videos/heroes/programs/trades/hero-program-cdl.mp4" type="video/mp4" />
        </video>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl text-white mb-8">
            Join students learning cdl with free training and AI support
          </p>
