...
export const metadata: Metadata = {
  title: 'Rise Up Program | Elevate For Humanity',
  description: 'Comprehensive career training program. Multiple pathways to success. Job placement and support included.',
};
