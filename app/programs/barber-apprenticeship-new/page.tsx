...
export const metadata: Metadata = {
  ...
  description:
    'Become a licensed barber while you work and earn. Train in a real shop, complete required theory, and log hours toward licensure. Free with funding.',
};
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Train in a real shop, complete required theory, and log hours
              toward licensure.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-8">
              ...
              <span className="px-4 py-2 bg-brand-orange-600 text-white rounded-full font-semibold text-sm">
            ...
            <Link
              href="/apply"
              className="inline-block px-10 py-4 bg-brand-orange-600 hover:bg-brand-orange-600 text-white text-xl font-bold rounded-lg shadow-lg transition-all"
            >
              Start My Path →
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex items-start gap-3 bg-white p-6 rounded-lg shadow-sm">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Learn by doing in a real barbershop, not sitting in a
                  classroom all day
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-white p-6 rounded-lg shadow-sm">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Get paid through hourly wages, commission, or tips while you
                  train
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-white p-6 rounded-lg shadow-sm">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Returning from justice involvement or career disruption?
                  You're welcome here
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-white p-6 rounded-lg shadow-sm">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-1">
                  Want a license and a real trade
                </h3>
                <p className="text-gray-600">
                  Build a career you can take anywhere—shop employment or your
                  own business
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-blue-50 p-6 rounded-lg text-center">
              ...
              <h3 className="font-bold text-gray-900 mb-2">
                Licensed Barber Roles
              </h3>
              <p className="text-gray-600 text-sm">
                Full state licensure to work in any shop
              </p>
            </div>
            ...
            <div className="bg-blue-50 p-6 rounded-lg text-center">
              ...
              <h3 className="font-bold text-gray-900 mb-2">
                Shop-Based Employment
              </h3>
              <p className="text-gray-600 text-sm">
                Steady work with established clientele
              </p>
            </div>

            <div className="bg-blue-50 p-6 rounded-lg text-center">
              <DollarSign className="w-12 h-12 text-brand-blue-600 mx-auto mb-4" />
              <h3 className="font-bold text-gray-900 mb-2">
                Booth Rental or Self-Employment
              </h3>
              <p className="text-gray-600 text-sm">
          ...
          <p className="text-sm text-gray-500 text-center mt-6">
            Wages vary by location, experience, and clientele. Most barbers earn
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-1">
                    Train in a licensed barbershop
                  </h3>
                  <p className="text-gray-600">
                    You'll be matched with a shop where you work with real
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-1">
                    Complete required theory online
                  </h3>
                  <p className="text-gray-600">
                    Study sanitation, safety, and technique at your own pace
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-1">
                    Log hours toward state licensure
                  </h3>
                  <p className="text-gray-600">
                    Track your progress—typically 1,500 hours over 12-18 months
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-1">
                    Receive placement and support
                  </h3>
                  <p className="text-gray-600">
                    We help you find the right shop and stay on track through
                    completion
                  </p>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-green-50 p-6 rounded-lg border-2 border-green-200">
              ...
              <p className="text-gray-600 text-sm">
                Justice Reinvestment Initiative for returning citizens
              </p>
            </div>
            ...
            <div className="bg-green-50 p-6 rounded-lg border-2 border-green-200">
              ...
              <p className="text-gray-600 text-sm">
                Some shops sponsor apprentices directly
              </p>
            </div>
          </div>

          <p className="text-center text-gray-600 bg-blue-50 p-4 rounded-lg">
            <strong>Funding eligibility is reviewed during advising.</strong> We
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                We coordinate with probation, parole, and reentry programs
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Help finding shops near you and managing your hours
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                We handle the paperwork with the state and funders
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-blue-600 text-slate-900">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="space-y-6 mb-10">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-brand-orange-600 text-white rounded-full flex items-center justify-center font-bold text-xl flex-shrink-0">
                1
              </div>
              <div>
                ...
                <p className="text-blue-100">
                  Takes 5 minutes. Tell us about yourself and what you're
                  looking for.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100">
                  We'll call you within 24-48 hours to schedule a conversation.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100">
                  We help you apply for funding and complete any required steps.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100">
                  Get matched to a shop and begin your apprenticeship.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <Link
              href="/apply"
              className="inline-block px-12 py-5 bg-brand-orange-600 hover:bg-brand-orange-600 text-white text-2xl font-bold rounded-lg shadow-xl transition-all"
            >
              Start My Path →
            </Link>
