    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[500px] flex items-center">
        <div className="absolute inset-0">
          <Image
            src="/images/healthcare/healthcare-professional-portrait-2.jpg"
        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl md:text-2xl mb-8 drop-shadow-lg">100% free training. Learn chairside assisting, X-rays, and patient care. Get certified and start your career.</p>
