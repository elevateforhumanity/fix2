...
export const metadata: Metadata = {
  title: 'Esthetics Apprenticeship Training | Elevate For Humanity',
  description: 'Start your esthetics apprenticeship career with free training. AI-powered learning, hands-on practice, and job placement support.',
  alternates: {
    canonical: 'https://www.elevateforhumanity.org/programs/esthetics-apprenticeship',
  },
};

export default function EstheticsApprenticeshipPage() {
  return (
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Why Choose Esthetics Apprenticeship?
              </h2>
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/images/gallery/image6.jpg"
                alt="Esthetics Apprenticeship professional at work"
                fill
                className="object-cover"
                quality={100}
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl text-white mb-8">
            Join students learning esthetics apprenticeship with free training and AI support
          </p>
