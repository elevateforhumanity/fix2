...
export const metadata: Metadata = {
  ...
  description: 'Discover more about Esthetics Apprenticeship inside the Elevate For Humanity workforce ecosystem.',
};
      ...
      <section className="relative min-h-[400px] sm:h-[500px] md:h-[600px] flex items-center">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">Discover more about Esthetics Apprenticeship inside the Elevate For Humanity workforce ecosystem.</p>
