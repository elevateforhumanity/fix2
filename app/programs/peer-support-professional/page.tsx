...
export const metadata: Metadata = {
  ...
  description: 'Start your peer support professional career with free training. AI-powered learning, hands-on practice, and job placement support.',
  alternates: {
    canonical: 'https://www.elevateforhumanity.org/programs/peer-support-professional',
  },
};

export default function PeerSupportProfessionalPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] sm:h-[600px] md:h-[700px] w-full overflow-hidden">
        <Image
          ...
          alt="Peer Support Professional Training"
          fill
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Why Choose Peer Support Professional?
              </h2>
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/images/gallery/image6.jpg"
                alt="Peer Support Professional professional at work"
                fill
                className="object-cover"
                quality={100}
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl text-white mb-8">
            Join students learning peer support professional with free training and AI support
          </p>
