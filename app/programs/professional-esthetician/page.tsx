...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.elevateforhumanity.org/programs/professional-esthetician",
  },
  title: 'Professional Esthetician Training | Elevate For Humanity',
  description: '100% free Esthetician training. Learn skincare, facials, and spa treatments. Get licensed and start your career.',
};
      ...
      <section className="relative min-h-[250px] sm:h-[300px] md:h-[350px] flex items-center">
        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 drop-shadow-2xl">Professional Esthetician Training</h1>
            <p className="text-xl md:text-2xl mb-8 drop-shadow-lg">100% free training. Learn skincare, facials, and spa treatments. Get licensed and start your career.</p>
