...
export const metadata: Metadata = {
  ...
  description: '100% free esthetician training. Learn skincare, facials, and beauty treatments. Get licensed.',
};
...
export default function Page() {
  return (
    <div className="min-h-screen bg-white">
      <ProgramHero
        title="Professional Esthetician Training"
        description="100% free esthetician training. Learn skincare, facials, and beauty treatments. Get licensed."
        imageSrc="/images/artlist/hero-training-1.jpg"
        imageAlt="Professional Esthetician Training"
