...
export const metadata: Metadata = {
  ...
  description:
    'Start your business startup marketing career with free training. AI-powered learning, hands-on practice, and job placement support.',
  alternates: {
    canonical:
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] sm:h-[600px] md:h-[700px] w-full overflow-hidden bg-slate-900">
        ...
        >
          <source
            src="/videos/heroes/programs/business/hero-program-business.mp4"
            type="video/mp4"
          />
        </video>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Why Choose Business Startup Marketing?
              </h2>
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Business Startup Marketing professional at work"
                fill
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl text-white mb-8">
            Join students learning business startup marketing with free training
            and AI support
          </p>
