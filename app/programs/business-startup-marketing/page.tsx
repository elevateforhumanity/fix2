      ...
      <section className="relative min-h-[250px] sm:h-[300px] md:h-[350px] flex items-center">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6">Business Startup Marketing | Elevate For Humanity</h1>
            <p className="text-xl mb-8 text-blue-100">Discover more about Business Startup Marketing inside the Elevate For Humanity workforce ecosystem.</p>
