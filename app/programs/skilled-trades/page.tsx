...
import { GraduationCap, Clock, DollarSign, MapPin, CheckCircle, Users, Wrench } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Skilled Trades',
  description: 'HVAC, Building Maintenance, and Building Technician training programs. Free with funding when eligible.',
};
      ...
      <section className="bg-gradient-to-br from-blue-900 via-purple-900 to-black text-white py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl">
            HVAC, Building Maintenance, and Building Technician training programs
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700">HVAC certification, Building Tech credentials</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-green-50 rounded-lg p-6 text-center">
              <h3 className="font-bold text-black mb-2">Building Maintenance Tech</h3>
            </div>
            <div className="bg-green-50 rounded-lg p-6 text-center">
