...
import { GraduationCap, Clock, DollarSign, MapPin, CheckCircle, Users, Heart } from 'lucide-react';
      ...
      <section className="bg-gradient-to-br from-blue-900 via-purple-900 to-black text-white py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl">
            CNA, Medical Assistant, Phlebotomy, and Home Health Aide training programs
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700">CNA, MA, Phlebotomy certification</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-green-50 rounded-lg p-6 text-center">
              <h3 className="font-bold text-black mb-2">Certified Nursing Assistant</h3>
            </div>
            <div className="bg-green-50 rounded-lg p-6 text-center">
              <h3 className="font-bold text-black mb-2">Medical Assistant</h3>
            </div>
            <div className="bg-green-50 rounded-lg p-6 text-center">
              <h3 className="font-bold text-black mb-2">Phlebotomy Technician</h3>
            </div>
            <div className="bg-green-50 rounded-lg p-6 text-center">
