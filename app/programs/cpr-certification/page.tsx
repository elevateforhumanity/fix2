...
export const metadata: Metadata = {
  ...
  description: 'Start your cpr certification career with free training. AI-powered learning, hands-on practice, and job placement support.',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] sm:h-[600px] md:h-[700px] w-full overflow-hidden">
        ...
        >
          <source src="/videos/cpr-hero.mp4" type="video/mp4" />
        </video>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Cpr Certification professional at work"
                fill
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl text-white mb-8">
            Join students learning cpr certification with free training and AI support
          </p>
