      ...
      <section className="mx-auto max-w-5xl px-6 py-10 md:px-12 md:py-12 space-y-8">
        <div>
          ...
          <p className="text-sm md:text-base text-slate-200 mb-4">
            This is a DOL-approved apprenticeship program registered with the
            Indiana Department of Labor. You'll work in a real barbershop,
            learning from licensed barbers while earning income and building the
            hours required for Indiana state licensure.
          </p>
          <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-4 mb-4">
            ...
            <p className="text-sm text-slate-200">
              The Indiana Professional Licensing Agency requires{' '}
              <strong>1,500 hours</strong> of supervised training to qualify for
              the Indiana Barber License examination. Our apprenticeship program
              is designed to meet these requirements while providing real-world
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-slate-900 p-4">
            ...
            <p className="text-xs text-slate-400 mt-1">
              1,500 hours required by Indiana
            </p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-slate-900 p-4">
            <h3 className="mb-2 text-sm font-semibold text-orange-300">
            ...
            <p className="text-xs text-slate-400 mt-1">
              Supervised by licensed Indiana barbers
            </p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-slate-900 p-4">
            <h3 className="mb-2 text-sm font-semibold text-orange-300">
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900 p-5">
          ...
          <p className="text-sm text-slate-300 mb-3">
            Curriculum aligned with Indiana Professional Licensing Agency
            requirements:
          </p>
          <ul className="list-disc pl-5 text-sm md:text-base text-slate-200 space-y-1">
            <li>
              Hair cutting, styling, and grooming techniques (all hair types)
            </li>
            ...
            <li>
              Milady curriculum and Indiana state licensing exam preparation
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl border border-brandPrimary/20 bg-gradient-to-br from-blue-900/20 to-slate-900 p-6 mb-6">
          ...
          <div className="space-y-4 text-sm text-slate-200">
            <div>
              ...
              <p>
                Complete 1,500 hours of supervised training under a licensed
                Indiana barber. Our program tracks your hours and ensures
                compliance with all state requirements.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-blue-200 mb-2">
                Step 2: Pass State Examination
              </h3>
              <p>
                Take and pass the Indiana Barber License examination
                administered by the Indiana Professional Licensing Agency. Exam
            ...
            <div>
              ...
              <p>
                Upon passing the exam, receive your Indiana Barber License. This
                allows you to work independently in any barbershop in Indiana or
                open your own shop.
              </p>
            </div>
            <div className="bg-blue-900/30 border border-brandPrimary/30 rounded p-3 mt-4">
              <p className="text-xs">
                ...
                Indiana Department of Labor and meets all requirements set by
                the Indiana Professional Licensing Agency (IC 25-7-5).
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-orange-500/20 bg-gradient-to-br from-orange-900/20 to-slate-900 p-6">
          ...
          <ul className="list-disc pl-5 text-sm md:text-base text-slate-200 space-y-1 mb-4">
            ...
            <li>
              <strong>License Track</strong> - Build hours toward Indiana state
              licensure
            </li>
            <li>
              <strong>Support Services</strong> - Coaching, case management, and
              exam prep
            </li>
            <li>
              <strong>Career Placement</strong> - Job placement assistance upon
              completion
            </li>
          </ul>
        </div>
