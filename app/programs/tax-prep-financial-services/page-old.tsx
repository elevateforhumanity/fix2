...
export const metadata: Metadata = {
  ...
  description:
    'Start your tax prep financial services career with free training. AI-powered learning, hands-on practice, and job placement support.',
  alternates: {
    canonical:
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] sm:h-[600px] md:h-[700px] w-full overflow-hidden">
        <Image
          ...
          alt="Tax Prep Financial Services Training"
          fill
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Why Choose Tax Prep Financial Services?
              </h2>
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/images/gallery/image6.jpg"
                alt="Tax Prep Financial Services professional at work"
                fill
                className="object-cover"
                quality={100}
                sizes="100vw"
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl text-white mb-8">
            Join students learning tax prep financial services with free
