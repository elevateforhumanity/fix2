      ...
      <section className="relative min-h-[400px] sm:h-[500px] md:h-[600px] flex items-center">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6">Tax Prep Financial Services | Elevate For Humanity</h1>
            <p className="text-xl mb-8 text-blue-100">Discover more about Tax Prep Financial Services inside the Elevate For Humanity workforce ecosystem.</p>
