...
export const metadata: Metadata = {
  ...
  description:
    'Start your medical assistant career with free training. AI-powered learning, hands-on practice, and job placement support.',
  alternates: {
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 w-full">
            <div className="max-w-4xl">
              ...
              <p className="text-xl sm:text-2xl md:text-3xl text-white mb-8 drop-shadow-lg">
                Start your career with free training, AI-powered learning, and
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">
              Medical Assistant Training Highlights
            </h2>
            <p className="text-xl text-slate-600">
              Hands-on clinical training in real healthcare settings
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl">
              <Image
                ...
                alt="Medical Assistant training - Clinical skills"
                fill
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl">
              <Image
                ...
                alt="Medical Assistant training - Patient care"
                fill
                className="object-cover"
                quality={100}
                sizes="(max-width: 768px) 100vw, 33vw"
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl">
              <Image
                src="/media/programs/medical-assistant-highlight-3.jpg"
                alt="Medical Assistant training - Medical procedures"
                fill
                className="object-cover"
                quality={100}
                sizes="(max-width: 768px) 100vw, 33vw"
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-slate-600">
                      Growing industry with thousands of job openings
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-slate-600">
                      We start from the basics and build your skills
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-slate-600">
                      Essential skills that are always in demand
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl text-white mb-8">
            Join students learning medical assistant with free training and AI
            support
          </p>
