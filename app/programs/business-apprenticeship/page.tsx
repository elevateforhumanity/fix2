...
export const metadata: Metadata = {
  title: 'Business Apprenticeship Training | Elevate For Humanity',
  description: 'Start your business apprenticeship career with free training. AI-powered learning, hands-on practice, and job placement support.',
  alternates: {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Why Choose Business Apprenticeship?
              </h2>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl text-white mb-8">
            Join students learning business apprenticeship with free training and AI support
          </p>
