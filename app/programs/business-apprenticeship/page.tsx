      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6">Business Apprenticeship | Elevate For Humanity</h1>
            <p className="text-xl mb-8 text-blue-100">Learn more about Business Apprenticeship inside the Elevate For Humanity workforce ecosystem.</p>
