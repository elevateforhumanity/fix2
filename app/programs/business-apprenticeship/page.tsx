      ...
      <section className="relative min-h-[500px] flex items-center">
        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 drop-shadow-2xl">Business Apprenticeship</h1>
            <p className="text-xl md:text-2xl mb-8 drop-shadow-lg">Master entrepreneurship, marketing, and business management skills for career success</p>
