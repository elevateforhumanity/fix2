                ...
                <div className="space-y-4">
                  ...
                  <div className="border-2 border-slate-200 rounded-lg p-4 hover:border-blue-500 transition-colors">
                    ...
                    <p className="text-sm text-slate-600 mb-4">
                      One-time payment with credit/debit card
                    </p>
                    <PaymentButton
                  ...
                  <div className="border-2 border-purple-500 rounded-lg p-4 bg-purple-50">
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        ...
                        <p className="text-xs text-purple-700">0% APR for 3 months</p>
                      </div>
                      <div className="text-right">
                        <div className="text-2xl font-bold text-slate-900">
                          ${Math.ceil(price / 3).toLocaleString()}
                        </div>
                        <div className="text-xs text-slate-600">/month × 3</div>
                      </div>
                    </div>
                    <p className="text-sm text-slate-600 mb-4">
