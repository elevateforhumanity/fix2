    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[400px] flex items-center">
        <div className="absolute inset-0">
          <Image
            src="/images/programs/efh-beauty-career-educator-hero.jpg"
        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 drop-shadow-2xl">Beauty Career Educator</h1>
            <p className="text-xl md:text-2xl mb-8 drop-shadow-lg">Train the next generation of beauty professionals with our educator certification program</p>
