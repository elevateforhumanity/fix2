...
import { GraduationCap, Clock, DollarSign, MapPin, CheckCircle, Users, Briefcase } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Business & Financial Services',
  description: 'Business administration, financial services, and professional skills training. Free with funding when eligible.',
};
      ...
      <section className="bg-gradient-to-br from-blue-900 via-purple-900 to-black text-white py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl">
            Business administration, financial services, and professional skills training
          </p>
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm">
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700">Individuals seeking career change or advancement</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">No prior experience required for most programs</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
              ...
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Barriers support available</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-blue-50 rounded-lg p-6">
              ...
              <p className="text-gray-700 text-sm">Some employers sponsor training</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-green-50 rounded-lg p-6 text-center">
              <h3 className="font-bold text-black mb-2">Financial Services Rep</h3>
            </div>
            <div className="bg-green-50 rounded-lg p-6 text-center">
              <h3 className="font-bold text-black mb-2">Customer Service Specialist</h3>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-4 text-left max-w-2xl mx-auto mb-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">Start your training program</p>
              </div>
            </div>
          </div>
          <Link 
