...
export const metadata: Metadata = {
  ...
  description: '100% free truck driving training. Get your CDL and start a high-demand career. Job placement assistance included.',
};
  ...
  return (
    <div className="min-h-screen bg-white">
      <ProgramHero
        ...
        imageAlt="Truck Driving Training"
        duration="4-6 Weeks"
        cost="$0"
        placement="95%+"
        salary="$50K+"
