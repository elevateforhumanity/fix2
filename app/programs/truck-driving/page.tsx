...
export const metadata = {
  ...
  description:
    'Professional truck driver training leading to Class A Commercial Driver License. WIOA-funded, 160 hours, $50K-$65K starting salary.',
};
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                <Link
                  href="/enroll?program=truck-driving"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="elevate-card mb-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Our CDL Truck Driving program provides comprehensive training to
                prepare you for a career as a professional truck driver. You'll
                learn vehicle operation, safety procedures, DOT regulations, and
                earn your Class A Commercial Driver's License.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                The trucking industry is experiencing a nationwide driver
                shortage, creating excellent job opportunities with competitive
                salaries and benefits. This WIOA-approved program is 100% free
