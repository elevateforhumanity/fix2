...
export const metadata: Metadata = {
  ...
  description: 'Start your emergency health safety tech career with free training. AI-powered learning, hands-on practice, and job placement support.',
  alternates: {
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl text-white mb-8">
            Join students learning emergency health safety tech with free training and AI support
          </p>
