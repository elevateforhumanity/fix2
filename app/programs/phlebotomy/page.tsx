...
export const metadata: Metadata = {
  ...
  description: 'Start your phlebotomy career with free training. AI-powered learning, hands-on practice, and job placement support.',
  alternates: {
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/images/gallery/image6.jpg"
                alt="Phlebotomy professional at work"
                fill
                className="object-cover"
                quality={100}
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl text-white mb-8">
            Join students learning phlebotomy with free training and AI support
          </p>
