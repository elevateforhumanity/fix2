    ...
    <main className="bg-white">
      ...
      <section className="relative py-20    overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6 text-3xl md:text-2xl md:text-3xl lg:text-3xl md:text-4xl">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-bold mb-6 text-3xl md:text-2xl md:text-3xl lg:text-3xl md:text-4xl">
