...
export default async function DevAdmin() {
  ...
  return (
    <div className="min-h-screen   ">
      {/* Header */}
      <div className="bg-white shadow-lg border-b-4 border-brand-blue-600">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-brand-blue-600">
            <div className="text-3xl font-bold text-brand-blue-600">
              {totalCourses || 0}
            </div>
            <div className="text-gray-600 mt-1">Total Courses</div>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-brand-green-600">
            <div className="text-3xl font-bold text-brand-green-600">
              {barberCourses?.length || 0}
            </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-6">
              {barberCourses.map((course: Record<string, any>) => (
                <div
                  key={course.id}
                  className="bg-white rounded-xl shadow-lg overflow-hidden border-2 border-orange-500"
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <Link
                        ...
                        className="bg-brand-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors"
                      >
          ...
          {allCourses && allCourses.length === 0 && (
            <div className="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-8 text-center">
              ...
              <p className="text-yellow-700">
                Check your Supabase connection or create courses in the admin
                panel.
              </p>
            </div>
          )}
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-2">
                    <Link
                      href={`/lms/courses/${course.id}`}
                      className="flex-1 bg-brand-blue-600 hover:bg-brand-blue-700 text-white px-3 py-2 rounded text-sm font-semibold text-center transition-colors"
                    >
                      View
                    </Link>
                    <Link
                      href={`/admin/courses/${course.id}`}
                      className="flex-1 bg-brand-green-600 hover:bg-green-700 text-white px-3 py-2 rounded text-sm font-semibold text-center transition-colors"
                    >
                      Edit
                    </Link>
                  </div>
        ...
        <div className="mt-12 bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Link
              href="/lms"
              className="bg-brand-green-100 hover:bg-green-200 p-4 rounded-lg text-center transition-colors"
            >
