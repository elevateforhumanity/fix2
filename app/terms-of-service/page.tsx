        ...
        <div className="max-w-4xl mx-auto prose prose-lg">
          <div className="elevate-card mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              By accessing and using Elevate for Humanity services, including our website, 
              learning management system (LMS), and training programs, you accept and agree 
          ...
          <div className="elevate-card mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">4. WIOA Eligibility and Enrollment</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              Participation in WIOA-funded programs requires meeting eligibility criteria 
              as determined by local workforce boards. Eligibility is subject to verification 
              and may change based on funding availability.
            </p>
            <p className="text-gray-700 leading-relaxed">
          ...
          <div className="elevate-card mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Program Completion and Certification</h2>
            <p className="text-gray-700 leading-relaxed">
              Completion of training programs does not guarantee employment or certification. 
              Industry certifications may require passing external exams administered by 
              third-party organizations. Job placement assistance is provided but employment 
              is not guaranteed.
            </p>
          </div>
          ...
          <div className="elevate-card mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              All content, materials, and resources provided through our services are protected 
          ...
          <div className="elevate-card mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              and use personal information as described in our Privacy Policy, including 
              information required for WIOA reporting and compliance.
            </p>
          </div>
          ...
          <div className="elevate-card mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Elevate for Humanity provides services "as is" without warranties of any kind. 
          ...
          <div className="elevate-card mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              website contact form or reach out to your case manager.
            </p>
          </div>
          ...
          <div className="elevate-card bg-gradient-to-br from-red-50 to-orange-50 text-center mt-12">
            ...
            <p className="text-gray-700 mb-6">
              By enrolling in our programs, you agree to these terms and our commitment 
              to your success.
            </p>
