...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Career Services - Workforce Development Platform | Elevate for Humanity",
    description: "Elevate for Humanity connects job seekers with free career training and employers with skilled talent.",
    images: ["/images/hero-new/hero-7.jpg"],
    type: "website",
  },
  twitter: {
  ...
  const services = [
    {
      ...
      features: ['One-on-one consultations', 'Industry-specific templates', 'ATS optimization', 'Unlimited revisions'],
    },
    {
      icon: Users,
      title: 'Interview Preparation',
      description: 'Mock interviews and coaching to boost your confidence',
      features: ['Practice interviews', 'Feedback and tips', 'Common questions prep', 'Virtual and in-person options'],
    },
    {
      icon: Briefcase,
      title: 'Job Search Support',
      description: 'Guidance and resources for your job search',
      features: ['Job board access', 'Application tracking', 'Networking strategies', 'Company research'],
    },
    {
      icon: TrendingUp,
      title: 'Career Counseling',
      description: 'Personalized guidance for your career path',
      features: ['Career assessments', 'Goal setting', 'Skills evaluation', 'Industry insights'],
    },
  ];
      ...
      <main>
        ...
        <section className="py-20 px-4 bg-white">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-900 mb-4">How We Help You Get Hired</h2>
              <p className="text-xl text-slate-600">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    We start by understanding your goals, skills, and interests to create a personalized career plan.
                  </p>
                </div>
              </div>
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Complete your training program while building job search skills through workshops and one-on-one coaching.
                  </p>
                </div>
              </div>
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    We help you create a strong resume, practice interviews, and connect with employers actively hiring.
                  </p>
                </div>
              </div>
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    We support you through the application and interview process, and check in after you're hired to ensure your success.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 px-4 bg-slate-50">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <Badge variant="primary" className="mb-4">Employer Network</Badge>
              ...
              <Card>
                <CardContent className="p-8">
                  <h3 className="text-2xl font-bold text-slate-900 mb-6">Featured Employers</h3>
                  <div className="grid grid-cols-2 gap-6">
                    <div className="text-center p-4 bg-slate-50 rounded-lg">
                      <div className="font-semibold text-slate-900">Healthcare</div>
                      <div className="text-sm text-slate-600 mt-1">15+ hospitals & clinics</div>
                    </div>
                    <div className="text-center p-4 bg-slate-50 rounded-lg">
                      <div className="font-semibold text-slate-900">Manufacturing</div>
                      <div className="text-sm text-slate-600 mt-1">20+ companies</div>
                    </div>
                    <div className="text-center p-4 bg-slate-50 rounded-lg">
                      <div className="font-semibold text-slate-900">Technology</div>
                      <div className="text-sm text-slate-600 mt-1">10+ tech firms</div>
                    </div>
                    <div className="text-center p-4 bg-slate-50 rounded-lg">
                      <div className="font-semibold text-slate-900">Trades</div>
                      <div className="text-sm text-slate-600 mt-1">25+ contractors</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
