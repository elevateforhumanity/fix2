      ...
      <div className="mx-auto max-w-6xl">
        <section className="max-w-3xl">
          ...
          <p className="mt-4 text-lg text-zinc-700">
            Deliver training, track progress, and keep programs organized with a platform designed
            for workforce pathways, partner programs, and student success.
          </p>

          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            <Link
              href="/login?next=/lms/dashboard"
              className="rounded-xl bg-zinc-900 text-white px-5 py-3 font-extrabold hover:bg-zinc-800 text-center"
            >
              Login to LMS
            </Link>
            <Link
              href="/inquiry?topic=lms"
              className="rounded-xl border border-zinc-300 bg-white px-5 py-3 font-extrabold hover:bg-zinc-50 text-center"
            >
              Request a Demo
            </Link>
          </div>
        ...
        <section className="mt-14 grid md:grid-cols-3 gap-6">
          <Card
            ...
            bullets={["Modules & milestones", "Resources & assignments", "Hybrid-friendly flow"]}
          />
          <Card
            title="Progress tracking"
            desc="Track participation and progress in a way that supports completion and retention."
            bullets={["Clear checkpoints", "Progress visibility", "Completion-ready structure"]}
          />
          <Card
            title="Partner-ready"
            desc="Designed to support partner programs, accountability, and consistent workflows."
            bullets={["Partner program support", "Audit-friendly organization", "Standardized processes"]}
          />
        </section>

        <section className="mt-14 rounded-3xl border border-zinc-200 bg-zinc-50 p-8 sm:p-10">
          <h2 className="text-2xl sm:text-3xl font-black text-zinc-900">How it works</h2>
          <ol className="mt-6 space-y-3 list-decimal pl-5 text-zinc-700 max-w-3xl">
            ...
            <li>Progress is tracked through milestones and completion steps.</li>
