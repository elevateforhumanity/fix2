...
export const metadata: Metadata = {
  ...
  description: 'Learn more about [forumId] inside the Elevate For Humanity workforce ecosystem.',
};
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">Learn more about [forumId] inside the Elevate For Humanity workforce ecosystem.</p>
