        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="text-white max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/vita/volunteer"
                className="inline-block px-8 py-4 bg-brand-orange-600 text-white font-bold text-lg rounded-lg hover:bg-brand-orange-700 transition text-center"
              >
                Volunteer with VITA →
              </Link>
              <Link
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-slate-700 mb-6">
                ...
                offers free tax help to people who generally make $64,000 or
                less, persons with disabilities, the elderly, and limited
                English-speaking taxpayers who need assistance in preparing
                their own tax returns.
              </p>
              <p className="text-lg text-slate-700 mb-6">
                <strong>IRS-certified volunteers</strong> provide free basic
                income tax return preparation with electronic filing to
                qualified individuals. VITA sites are generally located at
                community and neighborhood centers, libraries, schools, shopping
                malls, and other convenient locations.
              </p>
              <p className="text-lg text-slate-700 mb-6">
                <strong>
                  Elevate for Humanity Technical & Career Institute
                </strong>{' '}
                operates as an official IRS VITA site, providing free tax
                preparation services to our community. Our volunteers complete
                IRS training and certification to ensure accurate, professional
                tax preparation.
              </p>
              <p className="text-lg text-slate-700">
                VITA has operated for over 50 years, with IRS-certified
                volunteers preparing millions of tax returns annually at
                thousands of sites nationwide. All VITA services are{' '}
                <strong>100% free</strong> - no fees, no charges, no hidden
                costs.
              </p>
            </div>
          </div>
        ...
        <section className="py-20 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="bg-slate-50 p-8 rounded-lg">
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start gap-3">
                    <svg
                      className="w-6 h-6 text-brand-green-600 flex-shrink-0 mt-1"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
                ...
                <Link
                  href="/vita/get-help"
                  className="block w-full px-8 py-4 bg-brand-blue-600 text-white font-bold text-center rounded-lg hover:bg-brand-blue-700 transition"
                >
              ...
              {/* Volunteer */}
              <div className="bg-slate-50 p-8 rounded-lg">
                <h3 className="text-3xl font-bold mb-6 text-brand-orange-600">
                  Want to Volunteer?
                </h3>
                <p className="text-lg text-slate-700 mb-6">
                  Help your community by becoming an IRS-certified VITA
                  volunteer.
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start gap-3">
                ...
                <Link
                  href="/vita/volunteer"
                  className="block w-full px-8 py-4 bg-brand-orange-600 text-white font-bold text-center rounded-lg hover:bg-brand-orange-700 transition"
                >
      ...
      <section className="py-20 bg-slate-50 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <h3 className="text-lg font-bold mb-2 text-brand-blue-600">
                Free Tax Prep Info
              </h3>
      ...
      <section className="py-20    text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/vita/volunteer"
              className="px-10 py-5 bg-brand-orange-600 text-white font-bold text-xl rounded-lg hover:bg-brand-orange-700 transition"
            >
              Volunteer with VITA
            </Link>
          </div>
