...
export async function POST(req: Request) {
  try {
    ...
    return NextResponse.json({
      response:
        "I'm having a brief technical issue. For immediate assistance, please call (317) 314-3757 or email info@elevateforhumanity.org. I apologize for the inconvenience!",
    });
  }
}
