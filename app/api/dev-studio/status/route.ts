...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    integrations: {
      ...
      containerEgress: {
        ok: null,
        auditEndpoint: '/api/dev-studio/egress-audit',
        note: 'Run the audit endpoint or pnpm run audit:egress to verify direct container DNS/HTTPS access to GitHub and Northflank.',
      },
      preview: {
        ok: githubTokenConfigured,
        required: ['GITHUB_TOKEN'],
