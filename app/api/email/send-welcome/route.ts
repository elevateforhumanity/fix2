  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="info-box">
        ...
        <p><strong>Login URL:</strong> <a href="https://www.elevateforhumanity.org/login">www.elevateforhumanity.org/login</a></p>
        <p><strong>Email:</strong> ${to}</p>
        <p><strong>Password:</strong> The password you created during registration</p>
      </div>

      <a href="https://www.elevateforhumanity.org/login" class="button">Access Your LMS Dashboard →</a>
