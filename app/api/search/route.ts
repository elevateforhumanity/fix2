  ...
  const allResults = {
    programs: [
      {
        ...
        description: '12-week intensive HVAC training program',
      },
      {
        id: 2,
        title: 'Certified Nursing Assistant',
        type: 'program',
        url: '/programs/cna-training',
      ...
      },
      {
        ...
        type: 'program',
        url: '/programs/web-development',
        description: '16-week coding bootcamp',
      },
    ],
    pages: [
      {
    ...
    resources: [
      ...
      },
      {
        ...
        type: 'resource',
        url: '/success-stories',
        description: 'Read student testimonials',
      },
    ],
  };
