      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <ul className="space-y-4 text-gray-700">
            <li className="flex items-start gap-3">
              ...
              <span><strong>We do not sell personal information</strong></span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-green-600 rounded-full mt-2 flex-shrink-0"></div>
              <span>Information is used only for program coordination, advising, reporting, and compliance</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-green-600 rounded-full mt-2 flex-shrink-0"></div>
              <span>Data may be shared with partners only as required for enrollment, funding, or reporting</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-green-600 rounded-full mt-2 flex-shrink-0"></div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-700 mb-4">
            We collect information necessary to coordinate workforce training and support services:
          </p>
          <ul className="space-y-3 text-gray-700">
            ...
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
              <span>Eligibility information (for funding and program placement)</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
            ...
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
              <span>Employment and outcome information (for reporting requirements)</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3">
              ...
              <span><strong>Training Partners:</strong> To coordinate program delivery</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-orange-600 rounded-full mt-2 flex-shrink-0"></div>
              <span><strong>Funding Agencies:</strong> To meet reporting requirements (WIOA, WRG, JRI, etc.)</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-orange-600 rounded-full mt-2 flex-shrink-0"></div>
              <span><strong>Employers:</strong> With your consent, for placement opportunities</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-orange-600 rounded-full mt-2 flex-shrink-0"></div>
              <span><strong>Service Providers:</strong> Who help us operate our platform (with data protection agreements)</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <ul className="space-y-3 text-gray-700">
            ...
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-green-600 rounded-full mt-2 flex-shrink-0"></div>
              <span>Withdraw consent (where applicable, subject to legal obligations)</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">Questions About Data Use?</h3>
