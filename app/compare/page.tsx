      ...
      <section className="elevate-hero">
        <div className="elevate-hero-content text-center">
          ...
          <p className="elevate-hero-subtitle mx-auto">
            See how we compare to traditional training providers and online
            learning platforms
          </p>
        </div>
      </section>
              ...
              <thead>
                <tr className="border-b-2 border-gray-200">
                  ...
                  <th className="p-6 text-center">
                    ...
                    <div className="elevate-pill elevate-pill--success">
                      Recommended
                    </div>
                  </th>
                  <th className="p-6 text-center font-bold text-gray-700">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="elevate-card elevate-card-red">
              <h3 className="font-bold text-gray-900 mb-3">
                100% Free for Eligible Participants
              </h3>
              <p className="text-gray-600">
                Through WIOA funding, qualified participants pay nothing—no
                tuition, no fees, no hidden costs. We even provide support
                services like childcare and transportation assistance.
              </p>
            </div>
            <div className="elevate-card elevate-card-orange">
              <h3 className="font-bold text-gray-900 mb-3">Real Results</h3>
              <p className="text-gray-600">
                85% of our graduates find employment within 6 months, with an
                average starting salary of $45K+. Our industry partnerships
                ensure you're learning skills employers actually need.
              </p>
            </div>
            <div className="elevate-card elevate-card-blue">
              ...
              <p className="text-gray-600">
                From career counseling to job placement assistance, we're with
                you every step of the way. Our support doesn't end when you
                complete your training—we help you launch your new career.
              </p>
            </div>
            <div className="elevate-card">
              ...
              <p className="text-gray-600">
                Combine online learning with hands-on training. Study at your
                own pace while getting the practical experience and
