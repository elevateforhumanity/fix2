...
export function Calendar() {
  ...
  const addEvent = () => {
    const event = {
      ...
      duration:
        typeof newEvent.duration === 'string'
          ? parseInt(newEvent.duration, 10)
          : newEvent.duration,
      color: '#3b82f6',
    };
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            <div style={{ display: 'flex', gap: '0.5rem' }}>
              <button
                ...
                style={{
                  padding: '0.5rem 1rem',
                  backgroundColor: view === 'month' ? '#3b82f6' : '#f3f4f6',
              ...
              <button
                ...
                style={{
                  padding: '0.5rem 1rem',
                  backgroundColor: view === 'week' ? '#3b82f6' : '#f3f4f6',
              ...
              <button
                ...
                style={{
                  padding: '0.5rem 1rem',
                  backgroundColor: view === 'day' ? '#3b82f6' : '#f3f4f6',
            ...
            {days.map((day, index) => (
              <div
                ...
                style={{
                  ...
                  backgroundColor: day ? '#fff' : '#f9fafb',
                }}
              >
                {day && (
                  <>
