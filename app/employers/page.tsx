  ...
  const benefits = [
    {
      ...
      description:
        'Connect with job-ready candidates who have completed industry-recognized training programs',
    },
    {
      icon: DollarSign,
      title: 'Reduce Hiring Costs',
      description:
        'Save on recruitment and training expenses with pre-trained, motivated workers',
    },
    {
      icon: TrendingUp,
      title: 'Fill Critical Positions',
      description:
        'Address workforce shortages in high-demand industries like healthcare, trades, and technology',
    },
    {
      icon: Award,
      title: 'Tax Credits Available',
      description:
        'Qualify for Work Opportunity Tax Credits (WOTC) when hiring WIOA participants',
    },
  ];
      ...
      <main>
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <Badge variant="success" className="mb-4 bg-white text-blue-600">
              For Employers
            </Badge>
            ...
            <p className="text-xl mb-8 text-blue-100">
              Partner with us to access a pipeline of trained talent ready to
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-slate-600 mb-8">
                  We provide end-to-end support to help you find, hire, and
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <blockquote className="text-slate-700 italic border-l-4 border-blue-600 pl-4">
                      "We've hired 15 graduates from the HVAC program over the
                      past year. They come to us with hands-on experience and
                      are productive from day one. This partnership has been
                      invaluable for our growth."
                    </blockquote>
                    <div className="pt-4 border-t border-slate-200">
                      <div className="text-sm text-slate-600">Results</div>
                      <div className="font-semibold text-slate-900">
                        15 hires • 95% retention rate • $200K saved in training
                        costs
                      </div>
                    </div>
                  </div>
