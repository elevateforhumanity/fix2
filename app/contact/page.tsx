      ...
      <section className="bg-white py-24 md:py-32">
        <div className="container mx-auto px-8 md:px-12">
          <div className="max-w-4xl">
            <h1 className="text-6xl md:text-8xl font-bold text-slate-900 mb-8 tracking-tight">Get in touch</h1>
            <p className="text-2xl md:text-3xl text-slate-700 mb-12">We're here to help you start your career journey.</p>
