...
export const metadata = {
  ...
  description:
    'Choose your path: learner, case manager, or employer. Start your journey with Elevate for Humanity today.',
};
      ...
      <section className="border-b border-slate-100 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-16 md:py-24 text-center">
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto">
            Choose the path that's right for you. Whether you're a learner
            looking for training, a case manager supporting clients, or an
            employer building your team — we're here to help.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-slate-600 mb-6">
              Explore free and funded training programs in healthcare, trades,
              CDL, and more. Build skills, earn credentials, and connect to real
              jobs.
            </p>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-slate-600 mb-6">
              Refer clients to workforce training, track progress, and access
              reporting tools. Partner with us to support your community.
            </p>
            <div className="space-y-3">
              <Link
                href="/partners"
                className="block w-full rounded-xl bg-emerald-600 px-6 py-3 text-center text-sm font-semibold text-white hover:bg-emerald-700 transition"
              >
                Partner Information
              </Link>
              <Link
                href="/workforce-partners"
                className="block w-full rounded-xl border-2 border-emerald-600 px-6 py-3 text-center text-sm font-semibold text-emerald-600 hover:bg-emerald-50 transition"
              >
                Workforce Partners
              </Link>
            </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-slate-600 mb-6">
              Build your talent pipeline with trained, work-ready candidates.
              Host apprentices, interns, or hire directly from our programs.
            </p>
            <div className="space-y-3">
              <Link
                href="/employers"
