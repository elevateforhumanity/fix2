          ...
          <div className="p-6">
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                <Link href="/delegate/students" aria-label="Link" className="p-3 bg-white border rounded-lg hover:border-blue-500 hover:shadow text-sm">Students</Link>
                <Link href="/delegate/messages" aria-label="Link" className="p-3 bg-white border rounded-lg hover:border-blue-500 hover:shadow text-sm">Messages</Link>
                <Link href="/delegate/reports" aria-label="Link" className="p-3 bg-white border rounded-lg hover:border-blue-500 hover:shadow text-sm">Reports</Link>
              </div>
            </div>
          </div>
        </div>
