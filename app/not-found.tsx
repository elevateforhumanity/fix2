      ...
      <div className="text-center px-4 max-w-2xl">
        ...
        <div className="text-sm text-slate-500">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <span>•</span>
            <Link href="/wioa-eligibility" className="hover:text-blue-600 transition">WIOA Eligibility</Link>
            <span>•</span>
            <Link href="/apply" className="hover:text-blue-600 transition">Apply Now</Link>
          </div>
        </div>
      </div>
    </div>
