...
export const metadata: Metadata = {
  ...
  description:
    'Quick cash advances powered by EPS Financial. Get approved in minutes, funded same day. No hidden fees.',
};
          ...
          <div className="grid md:grid-cols-2 gap-12 h-full items-center">
            ...
            <div>
              ...
              <p className="text-base md:text-lg mb-8 text-green-50 leading-relaxed">
                Need money now? Get up to $3,500 with same-day approval. No
                hidden fees, flexible repayment, and trusted by thousands.
              </p>
              ...
              <div className="relative">
                ...
                <div className="relative z-10 bg-white rounded-3xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-300">
                  <div className="mb-6">
                    ...
                    <div className="text-5xl font-bold text-brand-green-600 mb-1 text-3xl md:text-4xl lg:text-5xl">
                      $3,500
                    </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="relative">
              <div className="   rounded-2xl p-8 hover:shadow-xl transition-shadow">
                <div className="w-16 h-16 bg-brand-green-600 rounded-2xl flex items-center justify-center mb-6">
                ...
                <p className="text-gray-600 mb-6">
                  Fill out our simple 5-minute application. No paperwork, no
                  hassle.
                </p>
            ...
            <div className="relative">
              <div className="   rounded-2xl p-8 hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-6">
                  Receive instant decision powered by EPS Financial's advanced
                  underwriting.
                </p>
                <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex items-center gap-2">
            ...
            <div className="relative">
              <div className="   rounded-2xl p-8 hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-6">
                  Money deposited directly to your bank account. Same-day
                  funding available.
                </p>
                <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex items-center gap-2">
