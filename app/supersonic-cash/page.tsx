...
export const metadata: Metadata = {
  title: 'Supersonic Cash Advance | Get Up to $3,500 in Minutes | Elevate for Humanity',
  description: 'Fast cash advance up to $3,500. No credit check. $0 fee under $1,000. Approved in minutes. Repaid from paycheck. Powered by EOS Financial & Drake Software.',
  keywords: 'cash advance, payday advance, instant cash, no credit check, emergency money, fast loan, paycheck advance, tax refund advance, EOS Financial, Drake Software',
  openGraph: {
    title: 'Supersonic Cash Advance - Get Cash in Minutes',
    description: 'Fast cash advance up to $3,500. No credit check. Approved instantly.',
    url: 'https://elevateforhumanity.org/supersonic-cash',
    siteName: 'Elevate for Humanity',
    images: [
      {
        url: '/images/supersonic-cash-og.jpg',
        width: 1200,
        height: 630,
        alt: 'Supersonic Cash Advance',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Supersonic Cash Advance - Get Cash in Minutes',
    description: 'Fast cash advance up to $3,500. No credit check. Approved instantly.',
    images: ['/images/supersonic-cash-og.jpg'],
  },
  robots: {
    index: true,
    follow: true,
  ...
  alternates: {
    canonical: 'https://elevateforhumanity.org/supersonic-cash',
  },
};
