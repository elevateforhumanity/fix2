        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-base md:text-lg font-bold text-slate-900">{totalStudents}</p>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-base md:text-lg font-bold text-slate-900">{activeStudents}</p>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-base md:text-lg font-bold text-slate-900">{completedStudents}</p>
