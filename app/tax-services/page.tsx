...
export const metadata: Metadata = {
  ...
  title: 'Tax Services Directory | Free & Professional Tax Preparation | Elevate For Humanity',
  description: 'Complete directory of all tax services: Free VITA tax prep, professional tax filing, refund advances, and tax preparation training programs.',
};
    ...
    services: [
      {
        ...
        description: 'IRS Volunteer Income Tax Assistance - 100% free for individuals earning $64,000 or less',
        link: '/vita',
        icon: '🆓',
        features: ['IRS-certified volunteers', 'E-file included', 'No fees ever']
      },
      {
        name: 'Tax Self-Prep',
        ...
        link: '/tax-self-prep',
        icon: '💻',
        features: ['DIY tax filing', 'Step-by-step guidance', 'Free federal filing']
      }
    ]
  },
  {
    ...
    services: [
      {
        ...
        description: 'Professional tax preparation by certified experts with maximum refund guarantee',
      ...
      },
      {
        ...
        link: '/supersonic',
        icon: '🚀',
        features: ['Same-day service', 'Accuracy guaranteed', 'Refund tracking']
      },
      {
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        link: '/refund-policy',
        icon: '📋',
        features: ['Money-back guarantee', 'Refund protection', 'Clear policies']
      }
    ]
  },
  {
    ...
    services: [
      {
        ...
        description: 'Become a certified tax preparer with our comprehensive training program',
      ...
      },
      {
        ...
        description: 'Advanced training in tax preparation and financial services',
        link: '/programs/tax-prep-financial-services',
        icon: '📊',
        features: ['Advanced certification', 'Financial planning', 'Business tax']
      },
      {
      ...
      <section className="relative h-[500px] md:h-[600px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/vita"
              className="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all shadow-2xl"
            >
              Free Tax Prep (VITA)
            </Link>
            <Link
