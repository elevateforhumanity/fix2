    ...
    <main className="min-h-screen bg-slate-50 px-4 py-10">
      <div className="mx-auto max-w-4xl rounded-xl bg-white p-8 shadow">
        ...
        <div className="prose prose-slate max-w-none">
          <p className="mb-4">
            This Cookie Policy explains how Elevate for Humanity uses cookies
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              <strong>Security Cookies:</strong> Help us detect and prevent
              security threats
            </li>
            <li>
          ...
          <p className="mb-4">
            ...
            appropriate opt-out links provided in the cookie banner.
          </p>
          <p className="mb-4">
            ...
            our platform though your access to some functionality and areas may
            be restricted.
          </p>
          ...
          <p className="mb-4">
            ...
            signals to websites that you do not want to have your online
            activity tracked. We currently do not respond to DNT signals.
          </p>
