      ...
      <div className="mx-auto max-w-4xl rounded-xl bg-white p-8 shadow">
        ...
        <div className="prose prose-slate max-w-none">
          <p className="mb-4">
            ...
            the Elevate for Humanity platform, including all associated
          ...
          <p className="mb-4">
            ...
            Privacy Policy. By using the Services, you consent to such
            collection and use, including the transfer of this information to
            the United States and/or other countries for storage, processing,
            and use by Elevate for Humanity and its affiliates.
          </p>
          ...
          <p className="mb-4">
            ...
            arrangement thereof) are owned by Elevate for Humanity, its
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              To impersonate or attempt to impersonate Elevate for Humanity, an
          ...
          <p className="mb-4">
            In no event shall Elevate for Humanity, nor its directors,
