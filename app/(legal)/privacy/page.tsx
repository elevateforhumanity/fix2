      ...
      <div className="mx-auto max-w-4xl rounded-xl bg-white p-8 shadow">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              <strong>Profile Information:</strong> Educational background, work
              history, skills, certifications
            </li>
            <li>
              <strong>Training Data:</strong> Course enrollments, progress,
              completion status, grades, assessments
            </li>
            <li>
              <strong>Employment Information:</strong> Employer details, job
              placements, apprenticeship records
            </li>
            <li>
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              Comply with workforce development regulations (WIOA, DOL, DWD)
            </li>
          ...
          <p className="mb-4">
            We share training and employment data with workforce development
            boards, referring agencies and workforce partners, and employers as
            necessary to facilitate your training and job placement.
          </p>

          <h3 className="mt-4 text-lg font-semibold">3.2 Training Providers</h3>
          <p className="mb-4">
            We share enrollment and progress information with our partner
          ...
          <p className="mb-4">
            We report training outcomes to the Department of Labor (DOL),
            Department of Workforce Development (DWD), and other agencies as
            required by law or funding agreements.
          </p>
          ...
          <p className="mb-4">
            ...
            processing personal data include:
          </p>
          <ul className="list-disc pl-6 mb-4">
            <li>
            ...
            <li>
              <strong>Legal Obligation:</strong> Compliance with workforce
          ...
          <p className="mb-4">
            ...
            institutions, we act as a "school official" under the Family
            Educational Rights and Privacy Act (FERPA) and comply with all
