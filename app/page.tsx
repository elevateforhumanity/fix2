...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-12 w-full">
            <div className="max-w-3xl">
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-10 leading-relaxed drop-shadow-lg">
                Free career training programs in healthcare, skilled trades, and
                technology.
                <span className="block mt-2 font-semibold">
                  No cost. Real careers. Marion County.
                </span>
              </p>
      ...
      {/* Build Marker - Verify Deployments */}
      <div className="fixed bottom-2 right-2 bg-slate-900/90 text-white px-3 py-1.5 rounded-lg text-[10px] font-mono shadow-lg border border-slate-700 z-50">
        <div className="flex items-center gap-2">
          ...
          <span>BUILD: 2025-11-20 13:10</span>
        </div>
      </div>
    </main>
  );
