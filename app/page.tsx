            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight text-slate-900">
                  ...
                  <br />
                  <span className="text-blue-600">100% Free Training</span>.
                  <br />
                  Real Jobs Waiting.
                </h1>

                <p className="text-xl text-slate-600 mb-8 leading-relaxed">
                  <strong>WIOA, WRG, JRI, and OJT funding available</strong>.
                  DOL-registered apprenticeships. ETPL-approved training.
                  WorkOne and EmployIndy referrals accepted.{' '}
                  <strong>Most students pay $0</strong>.
                </p>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Our employer partners are actively hiring graduates. These
                aren't "potential" jobs - they're open positions waiting for
                trained candidates.
              </p>
            </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <div className="text-sm text-slate-600 mb-2">
                      IU Health, Community Health Network, Ascension
                    </div>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 border-2 border-orange-100">
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <div className="text-sm text-slate-600 mb-2">
                      Carrier, Trane, Local HVAC Companies
                    </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border-2 border-purple-100">
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <div className="text-sm text-slate-600 mb-2">
                      Kenny's Barber Academy, Local Shops
                    </div>
            ...
            <div className="bg-slate-900 rounded-2xl p-8 md:p-12 text-white text-center">
              ...
              <p className="text-xl text-slate-300 mb-6 max-w-2xl mx-auto">
                We're adding new programs every month based on employer demand.
                Tell us what you want to do and we'll help you get there.
              </p>
              <Link
                href="/contact"
