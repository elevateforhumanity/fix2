    ...
    <main className="bg-white overflow-x-hidden">
      ...
      <section className="relative w-full overflow-hidden bg-slate-900">
        <div className="relative w-full h-[500px] md:h-[600px] lg:h-[700px]">
          ...
          <button
            onClick={toggleMute}
            className="absolute bottom-6 right-6 z-20 bg-black/50 hover:bg-black/70 text-white p-4 rounded-full transition-all backdrop-blur-sm"
      ...
      <section className="py-12 bg-slate-50">
        ...
        >
          ...
          <p className="text-base md:text-lg text-slate-700 leading-relaxed mb-6">
            Short-term career training programs you can complete from home, in weeks or months, not years. 
            Designed for real people with real lives—parents, workers, people starting over.
          </p>
          <p className="text-base text-slate-600">
            <span className="font-bold text-slate-900">Free training for those who qualify.</span>{' '}
            Through WIOA, WRG, JRI, and registered apprenticeships, most students pay nothing. 
            No student loans. No debt. Just real training and a clear path to employment.
          </p>
        </div>
      </section>
