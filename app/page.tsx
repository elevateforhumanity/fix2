            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-lg">
                ...
                <div className="p-6">
                  ...
                  <div className="text-sm">
                    <div className="font-semibold text-slate-900">Marcus J.</div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-4 bg-slate-50 rounded-lg p-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm">Covers full tuition for eligible students</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 bg-slate-50 rounded-lg p-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm">Up to $5,000 for high-demand careers</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 bg-slate-50 rounded-lg p-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm">State-funded training for career advancement</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-4">
                    <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 text-center border-2 border-blue-100">
                      ...
                      <div className="text-sm text-slate-700">Average Cost for Students</div>
                    </div>
                    <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 text-center border-2 border-green-100">
                      ...
                      <div className="text-sm text-slate-700">Max WRG Grant</div>
                    </div>
                  </div>
                  <div className="space-y-4 mt-8">
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 text-center border-2 border-purple-100">
                      ...
                      <div className="text-sm text-slate-700">WIOA Coverage</div>
                    </div>
                    <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6 text-center border-2 border-orange-100">
                      ...
                      <div className="text-sm text-slate-700">Application Time</div>
                    </div>
                  </div>
                </div>
              </div>
