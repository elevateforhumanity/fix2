...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.elevateforhumanity.org/notebooklm",
  },
  title: 'Notebooklm | Elevate For Humanity',
  description: 'Explore Notebooklm and discover opportunities for career growth and development.',
};
      ...
      <section className="relative h-[400px] md:h-[500px] lg:h-[600px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-base md:text-lg mb-8 text-gray-100">
            Explore Notebooklm and discover opportunities for career growth and development.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-6">Notebooklm</h2>
                <p className="text-gray-700 mb-6">Explore Notebooklm and discover opportunities for career growth and development.</p>
