...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.elevateforhumanity.org/urban-build-crew/courses",
  },
  title: 'Courses | Elevate For Humanity',
  description: 'Discover more about Courses inside the Elevate For Humanity workforce ecosystem.',
};
      ...
      <section className="bg-blue-700 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">Discover more about Courses inside the Elevate For Humanity workforce ecosystem.</p>
