...
export const metadata: Metadata = {
  ...
  description: 'Explore Ecosystem and discover opportunities for career growth and development.',
};
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-gray-700 mb-6">Explore Ecosystem and discover opportunities for career growth and development.</p>
