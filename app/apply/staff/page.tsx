      ...
      <section className="border-b border-slate-200 bg-white">
        <div className="max-w-4xl mx-auto px-4 py-10 lg:py-14">
          ...
          <p className="text-lg text-slate-700 max-w-3xl">
            Apply to become a staff member or instructor and help students
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8">
          <div className="bg-white border-2 border-slate-200 rounded-lg p-6">
            ...
            <p className="text-sm text-slate-600 mb-4">
              Support students with enrollment, case management, and program
              coordination.
            </p>
          ...
          <div className="bg-white border-2 border-slate-200 rounded-lg p-6">
            ...
            <p className="text-sm text-slate-600 mb-4">
              Teach courses, track student progress, and provide hands-on
              training.
            </p>
            <ul className="space-y-1 text-sm text-slate-600 mb-4">
              <li className="flex items-start">
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ol className="space-y-2 text-sm text-slate-700">
            ...
            <li className="flex items-start">
              ...
              <span>
                After approval, you'll receive onboarding instructions and
                account access
              </span>
            </li>
            <li className="flex items-start">
