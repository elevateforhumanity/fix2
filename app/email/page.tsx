        ...
        >
          <button
            ...
            style={{
              padding: '0.75rem',
              textAlign: 'left',
              backgroundColor: folder === 'inbox' ? '#eff6ff' : 'transparent',
              color: folder === 'inbox' ? '#3b82f6' : '#000',
              border: 'none',
          ...
          <button
            ...
            style={{
              padding: '0.75rem',
              textAlign: 'left',
              backgroundColor: folder === 'starred' ? '#eff6ff' : 'transparent',
              color: folder === 'starred' ? '#3b82f6' : '#000',
              border: 'none',
              borderRadius: '0.375rem',
              cursor: 'pointer',
            }}
          ...
          <button
            ...
            style={{
              padding: '0.75rem',
              textAlign: 'left',
              backgroundColor: folder === 'sent' ? '#eff6ff' : 'transparent',
              color: folder === 'sent' ? '#3b82f6' : '#000',
              border: 'none',
              borderRadius: '0.375rem',
              cursor: 'pointer',
            }}
          ...
          <button
            ...
            style={{
              padding: '0.75rem',
              textAlign: 'left',
              backgroundColor: folder === 'drafts' ? '#eff6ff' : 'transparent',
              color: folder === 'drafts' ? '#3b82f6' : '#000',
              border: 'none',
              borderRadius: '0.375rem',
              cursor: 'pointer',
            }}
          ...
          <button
            ...
            style={{
              padding: '0.75rem',
              textAlign: 'left',
              backgroundColor: folder === 'trash' ? '#eff6ff' : 'transparent',
              color: folder === 'trash' ? '#3b82f6' : '#000',
              border: 'none',
              borderRadius: '0.375rem',
              cursor: 'pointer',
            }}
