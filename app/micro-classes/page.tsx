...
const microClasses = [
  ...
  },
  {
    ...
    duration: '6-8 Weeks',
    price: 1200,
    image: '/media/programs/healthcare-programs-cards-hd.jpg',
...
export default function MicroClassesPage() {
  return (
    <main className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-green-600 to-orange-600 text-white py-20">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start gap-2 mb-6 p-3 bg-blue-50 rounded-lg">
                    <Award className="w-5 h-5 text-brandPrimary flex-shrink-0 mt-0.5" />
                    <div>
                  ...
                  <div className="space-y-3">
                    {program.fundingAvailable ? (
                      <>
                        ...
                        <Link
                          href="/apply"
                          className="block w-full text-center px-6 py-3 bg-brandPrimary text-white rounded-full font-bold hover:bg-brandPrimaryDark transition-all"
                        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Award className="w-8 h-8 text-brandPrimary" />
              </div>
