...
const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        id: 'contraindication-assessment',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">
            Esthetician Skills Tracking
          </h1>
          <p className="mt-2 text-gray-600">
            Log and monitor student progress on esthetics techniques
          </p>
        </div>
                    ...
                    <div key={category.name}>
                      ...
                      <div className="space-y-1">
                        {category.skills.map((skill) => {
                          const skillLog = skillLogs.find(
                            (log) => log.skillId === skill.id
                          );
                          return (
                            <div
                              key={skill.id}
                            ...
                            >
                              <span
                                className={
                                  skillLog ? 'text-gray-900' : 'text-gray-500'
                                }
                              >
                                {skill.name}
                              </span>
