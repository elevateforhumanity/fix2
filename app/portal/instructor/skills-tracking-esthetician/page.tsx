...
const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      { id: 'basic-facial', name: 'Basic Facial' },
      { id: 'deep-cleansing-facial', name: 'Deep Cleansing Facial' },
      { id: 'anti-aging-facial', name: 'Anti-Aging Facial' },
      { id: 'acne-treatment', name: 'Acne Treatment Facial' },
      { id: 'hydrating-facial', name: 'Hydrating Facial' },
      { id: 'brightening-facial', name: 'Brightening Facial' }
    ]
  },
  {
    ...
    skills: [
      ...
      { id: 'led-light-therapy', name: 'LED Light Therapy' },
      { id: 'microcurrent', name: 'Microcurrent Facial' },
      { id: 'oxygen-facial', name: 'Oxygen Facial' }
    ]
  },
  {
    name: 'Hair Removal',
    skills: [
      { id: 'eyebrow-waxing', name: 'Eyebrow Waxing' },
      { id: 'facial-waxing', name: 'Facial Waxing' },
      { id: 'body-waxing', name: 'Body Waxing' },
      { id: 'eyebrow-threading', name: 'Eyebrow Threading' },
  ...
  },
  {
    ...
    skills: [
      { id: 'lash-tinting', name: 'Lash Tinting' },
      { id: 'brow-tinting', name: 'Brow Tinting' },
      { id: 'lash-lift', name: 'Lash Lift' },
      { id: 'brow-lamination', name: 'Brow Lamination' },
      { id: 'lash-extensions', name: 'Lash Extensions' },
  ...
  },
  {
    ...
    skills: [
      ...
      { id: 'body-wrap', name: 'Body Wrap' },
      { id: 'cellulite-treatment', name: 'Cellulite Treatment' },
      { id: 'spray-tan', name: 'Spray Tan' },
      { id: 'back-facial', name: 'Back Facial' }
    ]
  },
  {
    name: 'Makeup Application',
    skills: [
      { id: 'day-makeup', name: 'Day Makeup' },
      { id: 'evening-makeup', name: 'Evening Makeup' },
      { id: 'bridal-makeup', name: 'Bridal Makeup' },
      { id: 'airbrush-makeup', name: 'Airbrush Makeup' },
      { id: 'special-effects', name: 'Special Effects Makeup' }
    ]
  },
  {
    name: 'Skin Analysis & Consultation',
    skills: [
      { id: 'skin-analysis', name: 'Skin Analysis' },
      { id: 'skin-typing', name: 'Skin Typing' },
      { id: 'product-recommendation', name: 'Product Recommendation' },
      { id: 'treatment-planning', name: 'Treatment Planning' },
      { id: 'client-consultation', name: 'Client Consultation' },
      { id: 'contraindication-assessment', name: 'Contraindication Assessment' }
    ]
  }
];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Esthetician Skills Tracking</h1>
          <p className="mt-2 text-gray-600">Log and monitor student progress on esthetics techniques</p>
        </div>
