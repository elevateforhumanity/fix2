...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.elevateforhumanity.org/portal/staff",
  },
  title: 'Staff Portal | Elevate For Humanity',
  description: 'Discover more about Staff Portal inside the Elevate For Humanity workforce ecosystem.',
};
      ...
      <section className="bg-blue-700 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">Discover more about Staff Portal inside the Elevate For Humanity workforce ecosystem.</p>
