...
export const metadata: Metadata = {
  title: 'CareerCounseling | Student Portal',
};
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6">CareerCounseling</h1>
          ...
          <div className="p-6">
            {enrollments && enrollments.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">Get started with CareerCounseling</p>
