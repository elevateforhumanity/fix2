...
export const metadata: Metadata = {
  ...
  title: 'I18n | Student Portal',
  description: 'Manage your i18n',
};
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold capitalize">i18n</h1>
            <p className="text-gray-600 mt-1">Manage and track your i18n</p>
          </div>
