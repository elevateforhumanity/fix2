...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.elevateforhumanity.org/portal/student/i18n",
  },
  title: 'I18n | Elevate For Humanity',
  description: 'Explore I18n and discover opportunities for career growth and development.',
};
      ...
      <section className="relative h-[400px] md:h-[500px] lg:h-[600px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-100">
            Explore I18n and discover opportunities for career growth and development.
          </p>
