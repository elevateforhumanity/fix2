...
export const metadata: Metadata = {
  ...
  description: "Access your courses, grades, assignments, certificates, and track your progress through career training programs.",
  keywords: ["student portal", "my courses", "grades", "assignments", "certificates", "learning progress"],
  openGraph: {
    title: "Student Portal | Elevate for Humanity",
    description: "Access your courses, grades, assignments, and track your learning progress.",
