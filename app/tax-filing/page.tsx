...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Professional tax filing for just $100. Maximum refund guaranteed.',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-block bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4">
                <span className="font-semibold">Powered by Drake Tax Software</span>
              </div>
              <h1 className="text-5xl font-extrabold mb-6 text-3xl md:text-4xl lg:text-5xl">
                File Your Taxes for Just $100
              </h1>
              <p className="text-xl text-green-100 mb-8">
                Professional tax preparation with Drake Software. Federal + State included. Maximum refund guaranteed.
              </p>
      ...
      <section id="pricing" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-extrabold text-center mb-4 text-2xl md:text-3xl lg:text-4xl">Simple, Honest Pricing</h2>
          <p className="text-xl text-gray-600 text-center mb-12">Compare us to TurboTax and H&R Block</p>
          
          <div className="grid md:grid-cols-3 gap-8">
            {/* TurboTax */}
            <div className="bg-white rounded-xl shadow-lg p-8 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4">TurboTax</h3>
              <div className="text-4xl font-extrabold mb-2 text-2xl md:text-3xl lg:text-4xl">$119+</div>
            ...
            <div className="   rounded-xl shadow-2xl p-8 border-4 border-green-400 transform scale-105">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Elevate Tax Filing</h3>
              <div className="text-5xl font-extrabold text-white mb-2 text-3xl md:text-4xl lg:text-5xl">$100</div>
              ...
              <ul className="space-y-3 mb-8 text-white">
                ...
                <li className="flex items-start">
                  <span className="text-yellow-300 mr-2">✓</span>
                  <span className="text-sm">Drake Software (professional grade)</span>
                </li>
                <li className="flex items-start">
                  <span className="text-yellow-300 mr-2">✓</span>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-2 border-gray-200">
              ...
              <div className="text-4xl font-extrabold mb-2 text-2xl md:text-3xl lg:text-4xl">$115+</div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-extrabold text-center mb-12 text-2xl md:text-3xl lg:text-4xl">What's Included</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Professional-grade software used by CPAs and tax preparers nationwide
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We guarantee you'll get every dollar you deserve or we'll refund our fee
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Tax professionals available to answer questions and review your return
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-extrabold text-center mb-12 text-2xl md:text-3xl lg:text-4xl">How It Works</h2>
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Sign up and pay $100 flat fee</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-green-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                2
              ...
              <p className="text-sm text-gray-600">Answer simple questions about your income</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-green-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                3
              ...
              <p className="text-sm text-gray-600">Expert reviews your return for accuracy</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-green-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                4
              ...
              <p className="text-sm text-gray-600">We file with IRS and state electronically</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-lg text-blue-100 mb-6">
                  Drake Software is the #1 choice of professional tax preparers. Trusted by over 80,000 tax professionals nationwide.
                </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-extrabold text-center mb-12 text-2xl md:text-3xl lg:text-4xl">Frequently Asked Questions</h2>
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6 shadow">
              <h3 className="font-bold text-lg mb-2">Is $100 really all I pay?</h3>
              <p className="text-gray-600">
                Yes! $100 includes federal AND state filing. No hidden fees, no upsells, no surprises.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow">
              <h3 className="font-bold text-lg mb-2">What is Drake Software?</h3>
              <p className="text-gray-600">
                Drake is professional tax software used by CPAs and tax preparers. It's more accurate and comprehensive than consumer software like TurboTax.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow">
              <h3 className="font-bold text-lg mb-2">Do I get expert help?</h3>
              <p className="text-gray-600">
                Yes! Our tax professionals review every return and are available to answer questions. This is included in your $100 fee.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow">
              <h3 className="font-bold text-lg mb-2">How fast will I get my refund?</h3>
              <p className="text-gray-600">
                Most refunds arrive in 8-21 days when e-filed. We can also set up direct deposit for faster processing.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow">
              <h3 className="font-bold text-lg mb-2">What if I made a mistake?</h3>
              <p className="text-gray-600">
                We offer free amendments if needed. Our software also checks for errors before filing to prevent issues.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20    text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-extrabold mb-6 text-2xl md:text-3xl lg:text-4xl">Ready to File Your Taxes?</h2>
          <p className="text-xl text-green-100 mb-8">
