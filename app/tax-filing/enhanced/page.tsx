...
export const metadata: Metadata = {
  ...
  description:
    'File your taxes with certified preparers. Drake Software powered. EPS Financial refund advances. Maximum refund guaranteed.',
};
          ...
          <div className="grid md:grid-cols-2 gap-12 h-full items-center">
            ...
            <div>
              ...
              <p className="text-base md:text-lg mb-8 text-blue-100 leading-relaxed">
                Professional tax preparation powered by Drake Software. Federal
                + State included. Maximum refund guaranteed. Get your refund up
                to 4 days early with EPS Financial.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                <Link
                  ...
                  className="group px-8 py-4 bg-brand-orange-600 text-white font-bold rounded-xl hover:bg-brand-orange-700 transition-all shadow-2xl hover:shadow-orange-600/50 hover:scale-105 flex items-center gap-2"
                >
                  Start Your Return
                  <svg
                ...
                <Link
                  href="/vita"
                  className="px-8 py-4 bg-brand-green-600/20 backdrop-blur-sm border-2 border-green-400/30 text-green-100 font-bold rounded-xl hover:bg-brand-green-600/30 transition-all"
                >
                  Free VITA Services
                </Link>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative z-10 bg-white rounded-3xl shadow-2xl p-8 transform hover:scale-105 transition-transform duration-300">
                  <div className="text-center mb-6">
                    <div className="inline-block px-4 py-1 bg-orange-100 text-brand-orange-600 rounded-full text-sm font-semibold mb-4">
                      Most Popular
                    </div>
      ...
      <section className="py-20   ">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-block px-4 py-2 bg-brand-green-100 text-green-700 rounded-full text-sm font-semibold mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-shadow border-2 border-green-200">
              ...
              <p className="text-gray-600 mb-6">
                Get up to $7,500 before your refund arrives. No cost option
                available.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-shadow border-2 border-blue-200">
              ...
              <p className="text-gray-600 mb-6">
                Simple, low-cost refund transfer. Pay your tax prep fee from
                your refund.
              </p>
              <ul className="space-y-3 mb-6">
                <li className="flex items-center gap-2 text-sm text-gray-700">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Industry-leading software and financial services
            </p>
          </div>
