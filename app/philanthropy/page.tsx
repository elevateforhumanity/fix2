      ...
      <header style={{ marginBottom: '3rem', textAlign: 'center' }}>
        ...
        >
          {philanthropyData?.mission ||
            'Empowering communities through education, workforce development, and social impact initiatives.'}
        </p>
      </header>
      {/* Tab Navigation */}
      <div
          ...
          <section style={{ marginBottom: '3rem', textAlign: 'center' }}>
            ...
            >
              {philanthropyData?.founder?.bio ||
                'A visionary leader committed to creating pathways to prosperity through education and workforce development.'}
            </p>
          </section>
          {/* Priority Areas */}
