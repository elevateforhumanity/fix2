          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
            <div style={{
              ...
              <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>
                Comprehensive Elevate Learn2Earn Workforce programs, apprenticeships, and skills training 
            ...
            <div style={{
              ...
              <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>
                Certified government contractor providing Elevate Learn2Earn Workforce, education services, 
