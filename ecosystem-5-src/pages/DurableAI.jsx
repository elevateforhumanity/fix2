      ...
      <main id="main-content" style={{ minHeight: '100vh' }}>
        ...
        >
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              Just tell our AI what kind of business you have, and watch it
              create a professional website instantly.
            </p>
            <div
              style={{
            ...
            >
              <div style={{ textAlign: 'center', padding: '2rem' }}>
                ...
                <p style={{ color: '#718096' }}>
                  Simply describe your business type, industry, and goals. Our
              ...
              <div style={{ textAlign: 'center', padding: '2rem' }}>
                ...
                <p style={{ color: '#718096' }}>
                  Content, images, layout, colors, and functionality - all
              ...
              <div style={{ textAlign: 'center', padding: '2rem' }}>
                ...
                <p style={{ color: '#718096' }}>
                  Fine-tune your site with our editor, then publish with one
                  click.
                </p>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <p style={{ color: '#718096', marginBottom: '1rem' }}>
                  AI writes compelling copy, headlines, and descriptions
              ...
              >
                ...
                <p style={{ color: '#718096', marginBottom: '1rem' }}>
                  AI selects colors, fonts, and layouts that convert based on
                  your business type.
                </p>
                <ul style={{ color: '#718096', paddingLeft: '1.5rem' }}>
              ...
              >
                ...
                <p style={{ color: '#718096', marginBottom: '1rem' }}>
                  AI adds the right features for your business - forms,
                  galleries, booking systems.
                </p>
                <ul style={{ color: '#718096', paddingLeft: '1.5rem' }}>
                  <li>Contact forms</li>
        ...
        >
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            >
              Join over 50,000 businesses who've built their websites with AI in
              under a minute.
            </p>
            <div
              style={{
