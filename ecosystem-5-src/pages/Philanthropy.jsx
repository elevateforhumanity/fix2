      ...
      <header style={{ marginBottom: '3rem', textAlign: 'center' }}>
        ...
        >
          {philanthropyData?.mission ||
            'Empowering communities through education, Elevate Learn2Earn Workforce, and social impact initiatives.'}
        </p>
      </header>
      {/* Tab Navigation */}
      <div
      ...
      {activeTab === 'overview' && (
        <div>
          ...
          <section style={{ marginBottom: '3rem', textAlign: 'center' }}>
            ...
            >
              {philanthropyData?.founder?.bio ||
                'A visionary leader committed to creating pathways to prosperity through education and Elevate Learn2Earn Workforce.'}
            </p>
          </section>
          {/* Priority Areas */}
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            >
              ...
              <p style={{ color: '#92400e', marginBottom: '1.5rem' }}>
                Partner with us to create meaningful impact while achieving your
