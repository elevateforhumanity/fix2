...
export async function validateBatch(req: AuthRequest, res: Response) {
  try {
    ...
    const { results, summary } = dataValidationService.validateBatch(
      type,
      records
    );
  ...
  try {
    const validators = [
      ...
      },
      {
        ...
        description: 'Validates employment outcome records',
      },
      {
        type: 'iep',
        name: 'IEP Validation',
        description: 'Validates Individual Employment Plans',
      },
      {
        type: 'skillGain',
        name: 'Skill Gain Validation',
        description: 'Validates measurable skill gain records',
      },
      {
        type: 'financial',
        name: 'Financial Validation',
        description: 'Validates financial records',
      },
      {
        type: 'supportService',
        name: 'Support Service Validation',
        description: 'Validates support service records',
      },
      {
        type: 'placement',
        name: 'Placement Validation',
        description: 'Validates job placement records',
      },
      {
        type: 'retentionCheck',
        name: 'Retention Check Validation',
        description: 'Validates retention check records',
      },
    ];
