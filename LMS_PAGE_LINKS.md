...
- **Assignment Detail** - `/student/assignments/[assignmentId]`
- **Quizzes** - `/student/quizzes`
- **Quiz Taking** - `/student/quizzes/[quizId]`
...
- **Course Authoring Tool** - `/admin/course-authoring`
...
- **Manage Delegates** - `/admin/delegates`
...
- **Completion Reports** - `/admin/reports/completion`
- **WIOA Compliance** - `/admin/reports/wioa`
...
- **Grade Assignment** - `/instructor/grading/[assignmentId]`
...
- **Truck Driving (CDL)** - `/programs/truck-driving`
...
**Total: 170+ pages/routes**

---

## 💡 HOW TO USE

1. **Replace base URL** with your actual domain
2. **Bookmark frequently used pages**
3. **Share specific links** with users
4. **Use for testing** - test each page individually
...
- **Instructor Pages:** Requires instructor role
- **Admin Pages:** Requires admin role
- **Program Holder Pages:** Requires provider role
- **Delegate Pages:** Requires delegate role

---

**Need a specific page link?** Let me know and I'll provide the exact URL!
