        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <h3 className="font-semibold text-slate-900 mb-2">WorkOne Appointment</h3>
              <p className="text-sm text-slate-600">Schedule on IndianaCareerConnect.com</p>
            </div>
            <div>
              <div className="w-10 h-10 rounded-full bg-brand-orange-600 text-white flex items-center justify-center font-bold mb-3">
                3
              ...
              <p className="text-sm text-slate-600">Begin your 4-week program</p>
            </div>
          </div>
        </div>
      </section>
