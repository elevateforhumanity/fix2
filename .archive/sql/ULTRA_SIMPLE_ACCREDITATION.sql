-- ============================================
-- ULTRA SIMPLE ACCREDITATION TABLES
-- This version creates profiles table if needed
-- ============================================
...
-- ============================================
-- NOW CREATE ACCREDITATION TABLES
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_grades_user ON grade_records(user_id);
...
CREATE INDEX IF NOT EXISTS idx_hours_user ON hour_tracking(user_id);
...
CREATE INDEX IF NOT EXISTS idx_sap_user ON sap_records(user_id);
...
CREATE INDEX IF NOT EXISTS idx_ecr_user ON ecr_snapshots(user_id);
...
CREATE INDEX IF NOT EXISTS idx_welcome_user ON welcome_packets(user_id);
...
CREATE INDEX IF NOT EXISTS idx_mou_user ON mou_signatures(user_id);
...
BEGIN
  ...
  RAISE NOTICE '🔑 Using auth.users(id) for all foreign keys';
