...
// Primary CTA
className =
  'bg-brand-orange-600 hover:bg-brand-orange-700 text-white font-bold px-8 py-3 rounded-lg transition';

// Secondary CTA
className =
  'bg-white hover:bg-slate-50 text-slate-900 font-bold px-8 py-3 rounded-lg border-2 border-slate-300 transition';
```
