...
export const ApprenticeshipDashboard: React.FC<
  ApprenticeshipDashboardProps
> = ({ summary, onLogHours, onViewEvaluations }) => {
  const {
    apprenticeship,
    ojt_progress_percentage,
    ri_progress_percentage,
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: '14px' }}>
              {summary.days_remaining} days remaining • Expected completion:{' '}
              {formatDate(summary.estimated_completion_date)}
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="card-body">
          ...
          >
            ...
            >
              ...
              >
                {apprenticeship.ojt_hours_completed} /{' '}
                {apprenticeship.ojt_hours_required}
              </div>
            ...
            >
              ...
              >
                {apprenticeship.ri_hours_completed} /{' '}
                {apprenticeship.ri_hours_required}
              </div>
              <div style={{ fontSize: '14px', color: 'var(--text-secondary)' }}>
                RI Hours
              </div>
            ...
            >
              ...
              >
                {apprenticeship.competencies_completed.length} /{' '}
                {apprenticeship.competencies_required.length}
              </div>
              <div style={{ fontSize: '14px', color: 'var(--text-secondary)' }}>
                Competencies
              </div>
