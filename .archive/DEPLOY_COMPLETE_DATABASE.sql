-- ============================================================================
-- ELEVATE FOR HUMANITY - COMPLETE DATABASE DEPLOYMENT
-- ============================================================================
-- Run this in Supabase SQL Editor to set up ALL tables for:
-- - LMS (courses, lessons, enrollments, progress)
-- - Admin Portal (user management, roles, permissions)
-- - Student Portal (dashboard, certificates, badges)
-- - Staff Portal (case management, reporting)
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_learning_activity_type ON public.learning_activity(activity_type);
...
-- ============================================================================
-- MESSAGES (Student-Staff Communication)
-- ============================================================================
...
-- Students can read their own enrollments and progress
...
-- Students can read their own certificates and badges
...
BEGIN
  ...
  RAISE NOTICE '📊 Tables created: profiles, programs, courses, lessons, enrollments, certificates, badges, and more';
  RAISE NOTICE '🔒 Row Level Security enabled on all tables';
  RAISE NOTICE '🎓 Sample course data inserted';
  RAISE NOTICE '🚀 LMS is ready for deployment!';
END $$;
