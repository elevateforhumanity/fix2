          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-orange-700">
                All programs meet federal workforce development standards with
                complete eligibility verification, Individual Employment Plans
                (IEP), PIRL reporting, and performance tracking systems.
              </p>
            </div>
