      ...
      <main id="main-content">
        ...
        >
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              Get access to professional productivity tools AND job training
              programs that lead to real careers. No cost. No catch. Just
              opportunity.
            </p>
            <div
              style={{
              ...
              {trainingPrograms.map((program, idx) => (
                ...
                >
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    ...
                    >
                      ⏱️ Duration: <strong>{program.duration}</strong>
                    </div>
