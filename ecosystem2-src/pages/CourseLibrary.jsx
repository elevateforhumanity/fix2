  ...
  return (
    <main style={{ padding: 32, background: '#f8fafc', minHeight: '100vh' }}>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="LMS, government LMS, DOL compliant, workforce development, online courses, best LMS, LearnWorlds alternative, LearnKey alternative, government contractor, digital binder, reporting, scholarship, dynamic LMS"
        />
        <meta
          property="og:title"
        ...
        <meta
          ...
          content="The #1 government-ready LMS for workforce development, DOL/DOE/DWD compliance, and dynamic reporting. Outperform LearnWorlds and LearnKey."
        />
      ...
      <p style={{ fontSize: 18, color: '#444', marginBottom: 32 }}>
        ...
        and ready for workforce development. Download digital binders and Excel
        reports for every course. All prices reflect a transparent 50% markup
        for platform sustainability and partner support.
      </p>
      <div
        style={{
          display: 'flex',
