...
export default function MainLanding() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        'DOL-approved workforce development with WIA compliance, apprenticeships, and job placement tracking',
      icon: '🏛️',
      color: '#3b82f6',
      sector: 'Government',
      page: '/government',
      ...
      <main id="main-content" style={{ minHeight: '100vh' }}>
        ...
        >
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              Powering FREE job training programs, apprenticeships, and
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: '0.9rem', opacity: 0.9 }}>
                    Get paid while you train - up to $20/hour during
                    apprenticeships
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div style={{ fontSize: '0.9rem', opacity: 0.9 }}>
                    Become a certified instructor - multiply your impact in the
                    community
                  </div>
                </div>
                <div
            ...
            >
              ...
              <div style={{ fontSize: '1rem', opacity: 0.9 }}>
                Join 500+ organizations already transforming lives • Apply
                ...
                >
                  <div
                    style={{
                      ...
                      marginBottom: '1.5rem',
                      filter:
                        currentFeature === index ? 'none' : 'grayscale(0.3)',
                    }}
                  >
                    {feature.icon}
                  </div>
                  <h3
                    style={{
                      ...
                      marginBottom: '1rem',
                      color:
                        currentFeature === index ? feature.color : '#2d3748',
                    }}
                  >
                    {feature.title}
                  </h3>
                  ...
                  {currentFeature === index && (
                    ...
                    >
                      <Link
                        to={
                          feature.page ||
                          `/durable-${feature.title.toLowerCase().split(' ')[0]}`
                        }
                        style={{
                          display: 'inline-block',
                          padding: '1rem 2.5rem',
          ...
          <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
            ...
            >
              ...
              >
                ...
                >
                  Foundation management, grant tracking, donor engagement,
                  impact measurement
                </p>
                <div
                  style={{
              ...
              >
                ...
                >
                  DOL-approved workforce development, WIA compliance,
                  apprenticeships
                </p>
                <div
                  style={{
              ...
              >
                ...
                >
                  Enterprise training delivery, certifications, assessments,
                  analytics
                </p>
                <div
                  style={{
              ...
              >
                ...
                >
                  Comprehensive program management, apprenticeships, career
                  pathways
                </p>
                <div
                  style={{
            ...
            >
              ...
              <p style={{ fontSize: '1.2rem', opacity: 0.9 }}>
                Every landing page seamlessly integrated. Every solution working
                together. Every pathway leading to success. This is what $3
                billion in platform development delivers.
              </p>
            </div>
          </div>
        </section>
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              ...
              >
                ...
                >
                  "Reduced patient onboarding time by 75% while maintaining full
                  HIPAA compliance. The platform handles 50,000+ patient
                  interactions monthly with zero security incidents."
                </div>
                <div
              ...
              >
                ...
                >
                  "Achieved 89% job placement rate across 15,000 participants.
                  Real-time analytics help us optimize programs and demonstrate
                  ROI to state funders."
                </div>
                <div
                  style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}
                >
              ...
              >
                ...
                >
                  "Streamlined our grant distribution process, reducing
                  administrative overhead by 60%. We've distributed $2.4B
                  through the platform with complete audit compliance."
                </div>
                <div
                  style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}
                >
        ...
        <section style={{ padding: '5rem 2rem', backgroundColor: 'white' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              Sector-specific solutions with enterprise SLAs, compliance
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '25px',
                    backgroundColor:
                      billingCycle === 'monthly' ? '#ff6b6b' : 'transparent',
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '25px',
                    backgroundColor:
                      billingCycle === 'yearly' ? '#ff6b6b' : 'transparent',
        ...
        >
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <p
              style={{ fontSize: '1.3rem', marginBottom: '3rem', opacity: 0.9 }}
            >
