        ...
        <div className="space-y-6">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <p className="text-sm text-green-700 mb-3">
              This program is eligible for federal workforce development
              funding:
            </p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="pt-3 border-t">
                  <p className="text-sm text-gray-600">
                    Fair revenue distribution supporting sustainable workforce
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              ...
              <p className="text-green-700 text-sm mb-4">
                Most programs qualify for federal workforce development funding
                through WIOA and other programs.
              </p>
              <Link
                href="/compliance"
