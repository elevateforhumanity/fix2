# Course Cover Images Guide

## Current Status

⚠️ **All 10 programs have SVG placeholders only**

Real course cover images needed for professional appearance.
...
7. Save as `cover.jpg` in program folder

**Time**: 10-15 minutes per cover
...
4. Use free tools like Photopea or GIMP
5. Export as JPG

**Time**: 5-10 minutes per cover
**Cost**: Free
...
**For all 10 covers in 2-3 hours**:

1. **Setup** (15 min)
   - Create Canva account
   - Set up 1200x675px template
   - Choose brand colors

2. **Create Covers** (90-120 min)
   - Use template for consistency
   - Customize for each program
   - Add program-specific imagery
   - Export all as JPG

3. **Optimize** (15 min)
   - Batch compress with TinyPNG
   - Verify file sizes <150KB
   - Check image quality
...
After creating all covers:

1. **Visual Test**
   - View on desktop
   - View on mobile
   - Check in course listings
   - Verify in course detail pages
...
4. Create 5 high-priority covers
5. Download and compress
6. Upload to site

**Result**: 5 professional course covers in 30 minutes
...
├── barber-apprenticeship/
│   └── cover.svg (⚠️ Replace with cover.jpg)
├── building-tech/
│   └── cover.svg (⚠️ Replace with cover.jpg)
├── cna-training/
│   └── cover.svg (⚠️ Replace with cover.jpg)
...
**Action Required**: Create 10 course cover images
**Estimated Time**: 2-3 hours (batch creation)
**Priority**: HIGH (visible on course pages)
