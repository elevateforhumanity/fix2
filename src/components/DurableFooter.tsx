      ...
      <div className="container">
        <div className="flex flex-wrap gap-8" style={{marginBottom: '3rem'}}>
          ...
          <div style={{flex: '1 1 250px'}}>
            <h3 style={{fontSize: '1.25rem', marginBottom: '1rem', color: 'white'}}>
          ...
          <div style={{flex: '1 1 200px'}}>
            <h4 style={{fontSize: '1rem', marginBottom: '1rem', color: 'white'}}>Programs</h4>
          ...
          {/* Column 4 - Contact */}
          <div style={{flex: '1 1 200px'}}>
            <h4 style={{fontSize: '1rem', marginBottom: '1rem', color: 'white'}}>Contact</h4>
            <ul style={{listStyle: 'none', padding: 0}}>
