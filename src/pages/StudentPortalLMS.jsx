          ...
          {activeTab === 'enrollment' && (
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-green-600 hover:bg-blue-900 text-white px-8 py-4 rounded-lg font-semibold transition"
                >
          ...
          {activeTab === 'dashboard' && (
            <div>
              <div className="bg-green-50 border border-green-200 text-green-600 p-4 rounded-lg mb-8">
                <strong>Welcome back, Student!</strong> You have 2 active
                courses and 1 completed certification.
              </div>
          ...
          {activeTab === 'courses' && (
            <div className="space-y-6">
              ...
              <div className="bg-beige-50 border border-brown-200 rounded-xl p-6">
                ...
                <button className="bg-green-600 hover:bg-blue-900 text-white px-6 py-2 rounded-lg font-semibold transition">
                  Continue Course
                </button>
              </div>
              <div className="bg-beige-50 border border-brown-200 rounded-xl p-6">
          ...
          {activeTab === 'profile' && (
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <button className="bg-green-600 hover:bg-blue-900 text-white px-8 py-3 rounded-lg font-semibold transition">
                  Update Profile
                </button>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <div className="space-y-6">
                <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg">
                  ...
                  <p className="text-brown-900 mb-4">
                    Our support team is here to assist you Monday-Friday, 9 AM -
                    5 PM EST
                  </p>
                  <p className="text-brown-900">
