      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-green-50 border-2 border-green-200 rounded-lg p-8 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-gray-700">
                This program is approved for Workforce Innovation and
                Opportunity Act (WIOA) funding. Eligible participants can
            ...
            <div>
              ...
              <p className="text-gray-700">
                Indiana residents may qualify for the Workforce Ready Grant
                (WRG), covering all program costs including materials and
                licensing fees.
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Enroll in our DOL-registered apprenticeship with Milady's
