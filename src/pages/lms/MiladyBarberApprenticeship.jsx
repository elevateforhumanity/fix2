        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-2xl mb-6 text-gray-300">
              DOL Registered Apprenticeship • ETPL Approved • Indiana State
              Licensure
            </p>
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Earn while you learn with industry-leading curriculum. 2,000 hours
              of comprehensive training leading to Indiana State Barber License.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600">
              12-18 months of comprehensive training
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          <h2 className="text-3xl font-bold mb-6 text-center">
            Professional Barbering Curriculum
          </h2>
          <p className="text-lg text-gray-700 mb-8 text-center">
            Industry-leading content meeting all Indiana State Board
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>
                    <strong>Barbering History & Professional Image</strong> -
                    Industry foundations and ethics
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-600 mr-2 mt-1 flex-shrink-0" />
                  <span>
                    <strong>Infection Control & Safety</strong> - Sanitation,
                    sterilization, and OSHA standards
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-600 mr-2 mt-1 flex-shrink-0" />
                  <span>
                    <strong>Anatomy & Physiology</strong> - Skin, hair, and
                    scalp science
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-600 mr-2 mt-1 flex-shrink-0" />
                  <span>
                    <strong>Trichology</strong> - Hair structure, growth, and
                    disorders
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-600 mr-2 mt-1 flex-shrink-0" />
                  <span>
                    <strong>Chemistry & Products</strong> - Chemical services
                ...
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-600 mr-2 mt-1 flex-shrink-0" />
                  <span>
                    <strong>Business Management</strong> - Shop operations and
                    client relations
                  </span>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-600 mr-2 mt-1 flex-shrink-0" />
                  <span>
                    <strong>Haircutting Techniques</strong> - Fades, tapers,
                    line-ups, and classic cuts
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-600 mr-2 mt-1 flex-shrink-0" />
                  <span>
                    <strong>Clipper & Shear Work</strong> - Professional tool
                    mastery
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-600 mr-2 mt-1 flex-shrink-0" />
                  <span>
                    <strong>Beard Design & Grooming</strong> - Shaping,
                ...
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-600 mr-2 mt-1 flex-shrink-0" />
                  <span>
                    <strong>Shaving Services</strong> - Straight razor
                    techniques and hot towel services
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-600 mr-2 mt-1 flex-shrink-0" />
                  <span>
                    <strong>Hair Coloring & Chemical Services</strong> - Color
                ...
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-600 mr-2 mt-1 flex-shrink-0" />
                  <span>
                    <strong>Styling & Finishing</strong> - Blow-drying, product
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-blue-600 mr-2 mt-1" />
                  <span>
                    Structured on-the-job learning with wage progression
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-blue-600 mr-2 mt-1" />
                  <span>
                    Related technical instruction (RTI) requirements met
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-blue-600 mr-2 mt-1" />
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mb-4">
                Work in established barbershops across Indiana with your state
                license
              </p>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg p-12 text-center">
          ...
          <p className="text-xl mb-8">
            Join our DOL-registered apprenticeship program with industry-leading
            curriculum
          </p>
          <button
            onClick={handleEnroll}
