  ...
  const courses = [
    {
      ...
      duration: '2 hours',
      description:
        'Master comprehensive infection control protocols and safety standards. Learn the latest COVID-19 safety measures, sterilization procedures, and client protection practices.',
    ...
    },
    {
      ...
      duration: '1 hour',
      description:
        'Learn to recognize signs of domestic violence and provide appropriate support. Understand your role as a trusted professional in helping clients in crisis.',
    ...
    },
    {
      ...
      duration: '30+ minutes',
      description:
        'Understand human trafficking indicators and learn how to respond appropriately. Be part of the solution in protecting vulnerable individuals.',
  ...
  const benefits = [
    {
      ...
      description:
        'Earn a recognized certification that demonstrates your commitment to client safety and well-being.',
    },
    {
      icon: <Users className="w-8 h-8 text-indigo-600" />,
      title: 'Make a Real Difference',
      description:
        'Learn skills that can help you recognize and respond to clients in crisis situations.',
    },
    {
      icon: <CheckCircle className="w-8 h-8 text-indigo-600" />,
      title: 'Career Advancement',
      description:
        'Stand out in your field with specialized training in client well-being and safety.',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Comprehensive training in infection control, domestic violence
              awareness, and human trafficking response. Protect your clients
                ...
                <div className="md:w-2/3">
                  ...
                  <div className="bg-indigo-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-700">
                      <strong>Assessment:</strong> {course.exam.questions}{' '}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Select the option that works best for you or your team
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-600 mb-4">
              All plans include 60 days of access and lifetime certification
              validity
            </p>
        ...
        <div className="space-y-6">
          <details className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="mt-4 text-gray-700">
              You get access to all three courses: Infection Control (2 hours),
              Domestic Violence Awareness (1 hour), and Human Trafficking
              Awareness (30 minutes). Upon completion, you'll receive a
          ...
          <details className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="mt-4 text-gray-700">
              You have 60 days from enrollment to complete all courses. The
              total time required is approximately 3.5 hours, which you can
          ...
          <details className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="mt-4 text-gray-700">
              Your certification is valid for a lifetime. However, we recommend
              refreshing your knowledge every 2 years to stay current with
              evolving standards.
            </p>
          </details>
          <details className="bg-white p-6 rounded-lg shadow-md">
          ...
          <details className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="mt-4 text-gray-700">
              ...
              satisfied with the course content, contact us for a full refund.
            </p>
          </details>
        </div>
      </div>
      ...
      <div className="bg-indigo-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            Join thousands of professionals who have earned their Client
            Well-Being & Safety Certification
          </p>
          <a
            href="#pricing"
