  ...
  const programs = [
    {
      ...
      icon: HardHat,
      description:
        'Get certified in construction fundamentals with hands-on training and industry-recognized credentials.',
    ...
    },
    {
      ...
      icon: Stethoscope,
      description:
        'Become a certified phlebotomy technician with comprehensive training and national certification prep.',
      duration: '8-10 weeks',
    ...
    },
    {
      ...
      icon: Truck,
      description:
        'Earn your CDL Class A license with comprehensive behind-the-wheel training and job placement.',
      duration: '4-8 weeks',
    ...
    },
    {
      ...
      icon: TestTube,
      description:
        'Get DOT certified as a drug and alcohol testing collector for workplace compliance.',
      duration: '2-4 weeks',
    ...
    },
    {
      ...
      icon: Music,
      description:
        'Develop your artistic talents with professional instruction in music and dance.',
      duration: '12-16 weeks',
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {featuredPrograms.map((program, idx) => (
              ...
              >
                <CardHeader>
                  <div
                    className={`w-20 h-20 ${program.bg} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all`}
                  >
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2 text-sm text-brand-text-muted">
                      ...
                      <span>
                        Earn: <strong>{program.credentials}</strong>
                      </span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-brand-text-muted">
                      <Users className="h-4 w-4" />
                      <span>
                        <strong>{program.students}</strong> students enrolled
                      </span>
                    </div>
                  </div>
                </CardContent>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredPrograms.map((program, idx) => (
                  ...
                  >
                    <CardHeader>
                      <div
                        className={`w-16 h-16 ${program.bg} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                      >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl text-brand-text mb-8">
              Programs funded by:{' '}
              <strong>WIOA • WRG • OJT • WEX • JRI • DOL • State Grants</strong>
            </p>
