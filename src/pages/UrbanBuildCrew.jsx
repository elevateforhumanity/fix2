...
export function UrbanBuildCrew() {
  return (
    <div>
      <Helmet>
        <title>Urban Build Crew | Elevate for Humanity</title>
        <meta
          name="description"
      ...
      <div style={{ minHeight: '100vh', backgroundColor: '#fff' }}>
        ...
        >
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              Building careers in construction and skilled trades through
            ...
            >
              ...
              >
                ...
                <p style={{ color: '#6b5d52', lineHeight: '1.6' }}>
                  Learn construction and trade skills through real-world
                  projects and experienced instructors
                </p>
              </div>
              <div
                style={{
        ...
        >
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            >
              Join Urban Build Crew and gain the skills you need for a
