...
const JobReadyIndy = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Job Ready Indy | Elevate for Humanity</title>
        <meta
          name="description"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
            ...
            <p className="text-lg text-gray-700 mb-6 text-center max-w-3xl mx-auto">
              ...
              develop the essential skills employers are looking for. Complete
              six badge courses to demonstrate your workplace readiness and
