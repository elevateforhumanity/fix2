    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-brown-600">Processing your donation...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
          ...
          {/* Donation Details */}
          {donation && (
            <div className="bg-beige-50 rounded-xl p-8 mb-8">
              <div className="grid md:grid-cols-3 gap-6 text-left">
                <div>
                  <div className="text-sm text-brown-500 mb-1">
                    Donation Amount
                  </div>
                ...
                <div>
                  ...
                  <div className="text-lg font-semibold text-brown-900 capitalize">
                    {donation.type === 'monthly'
                      ? 'Monthly Recurring'
                      : 'One-Time'}
                  </div>
                ...
                <div>
                  <div className="text-sm text-brown-500 mb-1">Date</div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="flex items-center justify-center gap-2 bg-beige-100 text-brown-900 py-3 px-6 rounded-lg font-semibold hover:bg-brown-300 transition-colors">
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/"
              className="bg-white text-brown-900 py-3 px-6 rounded-lg font-semibold hover:bg-beige-50 transition-colors border-2 border-brown-200"
            >
              Return Home
            </Link>
            <Link
            ...
            <Link
              to="/volunteer"
              className="bg-brown-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-brown-600-hover transition-colors"
            >
              Volunteer With Us
            </Link>
          </div>
