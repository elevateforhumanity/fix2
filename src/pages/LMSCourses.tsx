    ...
    <div className="min-h-screen bg-beige-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <p className="text-xl text-brown-600 max-w-3xl">
          ...
          {filteredCourses.map((course) => (
            ...
            >
              ...
              <div className="relative aspect-[16/10] overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  <div className="bg-white/90 backdrop-blur-sm rounded-full p-4">
                    <Play className="h-8 w-8 text-green-600 fill-blue-600" />
                  </div>
                </div>
                {/* Level Badge */}
                <div className="absolute top-3 left-3">
                  <span className="bg-white/90 backdrop-blur-sm text-brown-900 text-xs font-semibold px-3 py-1 rounded-full">
                    {course.level}
                  </span>
                </div>
                {/* FREE Badge */}
              ...
              <div className="p-4">
                ...
                <h3 className="font-semibold text-brown-900 mb-2 line-clamp-2 group-hover:text-green-600 transition-colors">
                  {course.title}
                </h3>
                ...
                <div className="flex items-center justify-between text-sm text-brown-600 pt-3 border-t border-gray-100">
                ...
                <div className="flex items-center gap-1 text-xs text-brown-500 mt-2">
