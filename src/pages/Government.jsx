        ...
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {fundingPrograms.map((program, idx) => (
              <div
                key={idx}
                className="bg-white rounded-xl p-6 shadow-sm border border-brown-200 hover:shadow-md transition-shadow"
              >
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-16 h-16 bg-green-600/10 rounded-lg flex items-center justify-center">
                    {program.icon}
                  </div>
                  <div className="flex-1">
                    ...
                    <p className="text-brown-600 mb-3">{program.description}</p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {benefits.map((benefit, idx) => (
                <div key={idx} className="flex items-center gap-3">
                  ...
                  <span className="text-brown-900">{benefit}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="section">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-xl p-6 text-center shadow-sm border border-brown-200">
              <div className="text-4xl font-bold text-green-600 mb-2">106+</div>
              <div className="text-brown-600">Certification Programs</div>
            </div>
            <div className="bg-white rounded-xl p-6 text-center shadow-sm border border-brown-200">
            ...
            <div className="bg-white rounded-xl p-6 text-center shadow-sm border border-brown-200">
              ...
              <div className="text-brown-600">Avg. Tuition Value</div>
            </div>
            <div className="bg-white rounded-xl p-6 text-center shadow-sm border border-brown-200">
              <div className="text-4xl font-bold text-green-600 mb-2">100%</div>
              <div className="text-brown-600">WIOA Compliant</div>
            </div>
          </div>
        </div>
      </section>
