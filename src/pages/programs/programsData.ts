export const programsData = {
  barber: {
    ...
    subtitle: 'Earn while you learn. Master professional barbering skills and qualify for Indiana State Licensure through our 2,000-hour registered apprenticeship program.',
    ...
    badges: ['💰 WRG Funded', '💰 WIOA Funded', '📜 State Licensure', '⏱️ 2,000 Hours'],
    overview: 'Our Barber Apprenticeship Program combines hands-on training with classroom instruction to prepare you for a successful career in barbering. You\'ll work alongside experienced professionals while earning a wage and building your skills.',
    skills: [
    ...
    careers: [
      {
        ...
        description: 'Work in established barbershops across Indiana with your state license.',
      ...
      {
        title: 'Mobile Barber',
        description: 'Provide on-site services to clients, events, and businesses.',
    ...
    careers: [
      {
        ...
        description: 'Maintain and repair building systems in commercial and residential properties.',
        salary: '$35,000-$55,000/year'
      },
      {
        title: 'Maintenance Supervisor',
        description: 'Oversee building maintenance teams and coordinate repair projects.',
  ...
  hvac: {
    ...
    careers: [
      ...
      {
        title: 'Welder',
        description: 'Work in manufacturing, construction, or fabrication shops.',
    ...
    careers: [
      {
        ...
        description: 'Provide direct patient care in hospitals, nursing homes, and home health.',
        salary: '$28,000-$38,000/year'
      },
      {
        title: 'Qualified Medication Aide',
        description: 'Administer medications and provide enhanced patient care.',
        salary: '$32,000-$42,000/year'
      },
      {
        title: 'Healthcare Advancement',
        description: 'Use CNA as stepping stone to RN, LPN, or other healthcare careers.',
    ...
    careers: [
      {
        ...
        description: 'Provide on-site drug testing services to businesses and individuals.',
    ...
    careers: [
      {
        ...
        description: 'Support office operations with digital tools and organization.',
    ...
    careers: [
      {
        ...
        description: 'Provide one-on-one peer support in treatment facilities and community settings.',
