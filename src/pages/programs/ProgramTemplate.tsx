    ...
    <div className="program-page">
      ...
      <section className="section" style={{ background: 'var(--color-green)' }}>
        <div className="container">
          <div className="mx-auto" style={{ maxWidth: '900px' }}>
            ...
            <p className="text-center body-large" style={{ marginBottom: '3rem' }}>
            ...
            <div className="flex flex-wrap gap-8">
              {program.careers.map((career, index) => (
                <div
                  key={index}
                  className="card"
                  style={{ flex: '1 1 calc(33.333% - 2rem)', minWidth: '250px' }}
                >
      ...
      <section className="section">
        <div className="container">
          ...
          >
            <h2 className="section-title text-center">100% Funded Training Available</h2>
            <p className="text-center body-large" style={{ marginBottom: '2rem' }}>
            ...
            <div className="flex flex-wrap gap-6 justify-center">
              ...
              >
                <h3 style={{ color: 'var(--color-brown)', marginBottom: '1rem' }}>
                  WIOA Funding
                </h3>
                <p>
                  Workforce Innovation and Opportunity Act provides funding for eligible
              ...
              >
                ...
                <p>
                  Workforce Ready Grant covers tuition, fees, and materials for approved
                  training programs.
                </p>
              </div>
            </div>

            <p className="text-center" style={{ marginTop: '2rem', fontSize: '1.125rem' }}>
        ...
        <div className="container">
          <div className="mx-auto text-center" style={{ maxWidth: '700px' }}>
            ...
            <p style={{ fontSize: '1.25rem', marginBottom: '2rem', opacity: 0.9 }}>
              Start your application on Indiana Career Connect today and take the first step
