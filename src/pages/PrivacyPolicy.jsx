        ...
        <div style={{ fontSize: 16, lineHeight: 1.8, color: '#333' }}>
          <section style={{ marginBottom: 32 }}>
            ...
            <p style={{ marginBottom: 16 }}>
              Welcome to Elevate for Humanity ("we," "our," or "us"). We are
          ...
          <section style={{ marginBottom: 32 }}>
            ...
            <p style={{ marginBottom: 16 }}>
              ...
              or navigate the platform. This information may include:
            </p>
            <ul style={{ marginBottom: 16, paddingLeft: 24 }}>
              <li>
          ...
          <section style={{ marginBottom: 32 }}>
            ...
            <p style={{ marginBottom: 16 }}>
              ...
              technology can be guaranteed to be 100% secure. While we strive to
