        ...
        >
          <button
            ...
            style={{
              ...
              textAlign: 'left',
              backgroundColor:
                folder === 'inbox' ? 'var(--brand-surface)' : 'transparent',
              color: folder === 'inbox' ? 'var(--brand-info)' : '#000',
              border: 'none',
          ...
          <button
            ...
            style={{
              ...
              textAlign: 'left',
              backgroundColor:
                folder === 'starred' ? 'var(--brand-surface)' : 'transparent',
              color: folder === 'starred' ? 'var(--brand-info)' : '#000',
              border: 'none',
              borderRadius: '0.375rem',
              cursor: 'pointer',
            }}
          ...
          <button
            ...
            style={{
              ...
              textAlign: 'left',
              backgroundColor:
                folder === 'sent' ? 'var(--brand-surface)' : 'transparent',
              color: folder === 'sent' ? 'var(--brand-info)' : '#000',
              border: 'none',
              borderRadius: '0.375rem',
              cursor: 'pointer',
            }}
          ...
          <button
            ...
            style={{
              ...
              textAlign: 'left',
              backgroundColor:
                folder === 'drafts' ? 'var(--brand-surface)' : 'transparent',
              color: folder === 'drafts' ? 'var(--brand-info)' : '#000',
              border: 'none',
              borderRadius: '0.375rem',
              cursor: 'pointer',
            }}
          ...
          <button
            ...
            style={{
              ...
              textAlign: 'left',
              backgroundColor:
                folder === 'trash' ? 'var(--brand-surface)' : 'transparent',
              color: folder === 'trash' ? 'var(--brand-info)' : '#000',
              border: 'none',
              borderRadius: '0.375rem',
              cursor: 'pointer',
            }}
        ...
        >
          ...
          {emails.map((email) => (
            ...
            >
              ...
              >
                <span style={{ fontWeight: email.read ? '400' : '600' }}>
                  {email.from}
                </span>
                <span
                  style={{
