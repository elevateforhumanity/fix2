  ...
  const askQuestion = async () => {
    ...
    setTimeout(() => {
      setAnswer({
        ...
        sources: sources
          .slice(0, 3)
          .map((s) => ({ title: s.title, citation: `${s.title}, p.1` })),
        timestamp: new Date(),
      });
      setLoading(false);
    }, 1500);
      ...
      >
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          <select
            ...
            onChange={(e) =>
              setCurrentNotebook(notebooks.find((n) => n.id === e.target.value))
            }
            style={{
              width: '100%',
              padding: '0.5rem',
          ...
          <button
            onClick={() => {
              ...
              if (title)
                setNotebooks([
                  ...notebooks,
                  { id: `nb_${Date.now()}`, title, sources: [], notes: [] },
                ]);
            }}
            style={{
              width: '100%',
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          <button
            ...
            style={{
              ...
              marginBottom: '0.5rem',
              backgroundColor:
                view === 'sources' ? 'var(--brand-info)' : '#fff',
          ...
          <button
            ...
            style={{
              ...
              padding: '0.75rem',
              marginBottom: '0.5rem',
              backgroundColor: view === 'chat' ? 'var(--brand-info)' : '#fff',
          ...
          <button
            ...
            style={{
              ...
              padding: '0.75rem',
              marginBottom: '0.5rem',
              backgroundColor: view === 'notes' ? 'var(--brand-info)' : '#fff',
          ...
          <button
            ...
            style={{
              width: '100%',
              padding: '0.75rem',
              backgroundColor: view === 'graph' ? 'var(--brand-info)' : '#fff',
