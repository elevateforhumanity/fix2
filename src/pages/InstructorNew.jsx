            ...
            >
              <div
                style={{
                  ...
                  borderRadius: '50%',
                  backgroundColor:
                    step >= s.num ? 'var(--brand-info)' : 'var(--brand-border)',
                ...
                {parseFloat(courseData.price) > 0 && (
                  ...
                  >
                    ...
                    <div style={{ fontSize: 14 }}>
                      ...
                      <div style={{ marginBottom: 4 }}>
                        Your Earnings (70%):{' '}
                        <strong>${(courseData.price * 0.7).toFixed(2)}</strong>
                      </div>
                      <div>
                        Platform Fee (30%):{' '}
                        <strong>${(courseData.price * 0.3).toFixed(2)}</strong>
                      </div>
                    </div>
                  </div>
                )}
            ...
            <div>
              ...
              >
                ...
                <p style={{ fontSize: 13, color: '#0056b3', margin: 0 }}>
                  After creating your course, you'll be able to add curriculum,
                  upload videos, create quizzes, and publish when ready.
                </p>
              </div>
            </div>
          )}
