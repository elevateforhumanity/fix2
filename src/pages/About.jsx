  ...
  const services = [
    {
      ...
      description:
        'Comprehensive Learn2Earn Workforce programs, apprenticeships, and skills training designed to meet industry demands.',
      color: 'text-brand-info',
      bg: 'bg-blue-50',
    },
    {
      ...
      description:
        'Certified government contractor providing workforce and education services for federal, state, and local agencies.',
      color: 'text-purple-600',
      bg: 'bg-purple-50',
    },
    {
      ...
      description:
        'Supporting communities through strategic giving, grant programs, and partnerships that create lasting social impact.',
      color: 'text-pink-600',
      bg: 'bg-pink-50',
    },
    {
      ...
      description:
        'Building stronger communities through education, mentorship, and workforce initiatives.',
      color: 'text-brand-success',
      bg: 'bg-green-50',
    },
  ];
      ...
      <div className="min-h-screen bg-background">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {values.map((value, idx) => (
                ...
                >
                  <CardHeader>
                    <div
                      className={`w-16 h-16 ${value.bg} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                    >
        ...
        <section className="py-20 px-4 bg-white">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12 animate-fade-in-up">
              <Badge className="mb-4 text-base px-6 py-2">Our Story</Badge>
            ...
            >
              <CardContent className="p-8 md:p-12 space-y-6 text-lg leading-relaxed text-brand-text">
                ...
                <p className="text-xl font-semibold text-brand-text">
                  ...
                  <span className="text-purple-600">$2.85M in funding</span> to
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16 animate-fade-in-up">
              ...
              <p className="text-xl text-brand-text-muted max-w-3xl mx-auto">
                Comprehensive services designed to empower individuals and
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {services.map((service, idx) => (
                ...
                >
                  <CardHeader>
                    <div
                      className={`w-16 h-16 ${service.bg} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all`}
                    >
        ...
        <section className="relative bg-gradient-to-br from-blue-700 via-purple-600 to-purple-700 text-white py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            ...
            <p
              className="text-xl md:text-2xl mb-10 text-blue-100 animate-fade-in-up"
              style={{ animationDelay: '100ms' }}
            >
