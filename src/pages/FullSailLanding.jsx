...
const FullSailLanding = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Free Training Programs | Elevate for Humanity</title>
        <meta
          name="description"
      ...
      <div className="min-h-screen bg-beige-50">
        ...
        <div className="bg-brown-900 text-white text-center py-3 text-sm">
          <span className="bg-green-600 text-white px-3 py-1 rounded font-bold mr-2">
            FREE TRAINING
          </span>
          Available for Qualified Indiana Residents • WIOA Approved Programs
        </div>
        {/* Hero Section with Form */}
        <div className="bg-gradient-to-br from-brown-800 to-brown-700 text-white">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-[1fr_400px] grid-cols-1">
              ...
              {/* Lead Capture Form */}
              <div className="bg-white text-brown-900 p-8 lg:p-10 shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    <label
                      htmlFor="firstName"
                      className="block font-bold text-brown-900 mb-1"
                    >
                      First Name *
                    </label>
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-brown-300 rounded focus:border-orange-500 focus:outline-none text-base"
                      required
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 border-2 border-brown-300 rounded focus:border-orange-500 focus:outline-none text-base bg-white"
                      required
                    >
                  ...
                  <p className="text-xs text-brown-600 leading-relaxed mt-4">
                    By submitting this form, you consent to receive emails and
                    texts from Elevate for Humanity. You may opt out at any
        ...
        {/* Programs Section */}
        <div className="py-16 px-6 bg-beige-50">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-center text-brown-900 mb-12">
                ...
                >
                  ...
                  <ul className="text-left space-y-2 mb-6">
                    {program.features.map((feature, idx) => (
                      <li
                        key={idx}
                        className="text-brown-900 text-sm pl-5 relative"
                      >
