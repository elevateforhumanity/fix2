...
export default function Connect() {
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-lg shadow text-center">
          ...
          <div className="text-brown-600 text-sm">Total Members</div>
        </div>
        <div className="bg-white p-6 rounded-lg shadow text-center">
          <div className="text-2xl font-bold text-green-600">
            {communityStats.activeToday}
          </div>
          <div className="text-brown-600 text-sm">Active Today</div>
        </div>
        <div className="bg-white p-6 rounded-lg shadow text-center">
          <div className="text-2xl font-bold text-purple-600">
            {communityStats.jobPlacements.toLocaleString()}
          </div>
          <div className="text-brown-600 text-sm">Job Placements</div>
        </div>
        <div className="bg-white p-6 rounded-lg shadow text-center">
          <div className="text-2xl font-bold text-orange-600">
            {communityStats.mentorSessions}
          </div>
          <div className="text-brown-600 text-sm">Mentor Sessions</div>
        </div>
      </div>
      {/* Quick Actions */}
      <div className="grid md:grid-cols-3 gap-6">
        ...
        >
          ...
          <h3 className="font-medium text-brown-900 mb-2">Find Jobs</h3>
        ...
        >
          ...
          <h3 className="font-medium text-brown-900 mb-2">Attend Events</h3>
          <p className="text-brown-600 text-sm">
        ...
        >
          ...
          <h3 className="font-medium text-brown-900 mb-2">Get Mentorship</h3>
          <p className="text-brown-600 text-sm">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <button
            onClick={() => setActiveTab('events')}
            className="mt-4 text-green-600 hover:text-green-600 text-sm font-medium"
          >
            View All Events →
          </button>
        </div>
          ...
          <div className="space-y-4">
            {jobOpportunities
              ...
              .map((job) => (
                ...
                >
                  <h4 className="font-medium text-brown-900">{job.title}</h4>
                  <p className="text-sm text-brown-600">
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow">
        <div className="p-6 border-b">
          <h2 className="text-xl font-bold text-brown-900">Upcoming Events</h2>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <span className="bg-beige-50 text-green-600 text-sm px-2 py-1 rounded">
                        {event.type}
                      </span>
                    </div>
                    <p className="text-brown-600 mb-3">{event.description}</p>
                    <div className="flex items-center space-x-6 text-sm text-brown-500">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <span className="bg-beige-100 text-brown-900 text-sm px-2 py-1 rounded">
                        {job.type}
                      </span>
                    </div>
                    <div className="flex items-center space-x-4 text-sm text-brown-600 mb-3">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      {job.skills.map((skill, index) => (
                        <span
                          key={index}
                          className="bg-beige-50 text-green-600 text-sm px-2 py-1 rounded"
                        >
                          {skill}
                        </span>
                      ))}
                  ...
                  <div className="space-x-2">
                    <button className="bg-white text-green-600 border border-blue-600 px-4 py-2 rounded-lg hover:bg-blue-50 transition-colors">
                      Learn More
                    </button>
                    <button className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors">
                      Apply Now
  ...
  const renderMentors = () => (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow">
        <div className="p-6 border-b">
          <h2 className="text-xl font-bold text-brown-900">Industry Mentors</h2>
          <p className="text-brown-600">
            ...
            {mentors.map((mentor) => (
              ...
              >
                <div className="text-center mb-4">
                  ...
                  <h3 className="font-medium text-brown-900">{mentor.name}</h3>
                  <p className="text-sm text-brown-600">{mentor.title}</p>
                  <p className="text-sm text-brown-500">{mentor.company}</p>
                </div>
                ...
                <div className="mb-4">
                  <p className="text-sm text-brown-600 mb-2">Expertise:</p>
                  <div className="flex flex-wrap gap-1">
                    {mentor.expertise.map((skill, index) => (
                      <span
                        key={index}
                        className="bg-beige-50 text-brown-600 text-xs px-2 py-1 rounded"
                      >
                        {skill}
                      </span>
                    ))}
