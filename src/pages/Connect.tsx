                ...
                >
                  ...
                  <div className="flex flex-wrap gap-1 mt-2">
                    {job.skills.slice(0, 3).map((skill, index) => (
                      <span
                        key={index}
                        className="bg-brand-surface text-brand-info text-xs px-2 py-1 rounded"
                      >
                        {skill}
                      </span>
                    ))}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      {job.skills.map((skill, index) => (
                        <span
                          key={index}
                          className="bg-brand-surface text-brand-info text-sm px-2 py-1 rounded"
                        >
                          {skill}
                        </span>
                      ))}
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {mentor.expertise.map((skill, index) => (
                      <span
                        key={index}
                        className="bg-brand-surface text-brand-secondary text-xs px-2 py-1 rounded"
                      >
                        {skill}
                      </span>
                    ))}
