...
export default function ProfessionalSite() {
  ...
  return (
    <div className="min-h-screen bg-beige-50">
        ...
        {activeTab === 'enrollment' && (
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <form className="space-y-6">
              <div>
                ...
                <select className="w-full p-3 border border-brown-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-600">
                  ...
                  <optgroup label="Food Service & Business">
                    <option value="servsafe">
                      ServSafe Food Handler - $69
                    </option>
                    <option value="servsafe-manager">
                      ServSafe Manager - $149
                    </option>
              ...
              <button
                type="submit"
                className="w-full bg-blue-800 hover:bg-blue-900 text-white px-8 py-4 rounded-lg font-semibold transition"
              >
      ...
      <section id="government-contracting" className="bg-white py-16 px-8">
      ...
      {/* Performance Stats */}
      <section id="performance" className="bg-[#1a365d] text-white py-16 px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-sm opacity-90">Participants Trained</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-sm opacity-90">Contract Value Delivered</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-sm opacity-90">Compliance Record</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="bg-[#2d3748] text-white py-8 px-8 text-center">
        <div className="max-w-7xl mx-auto">
          <p className="mb-2">
            &copy; 2024 Elevate for Humanity | Veteran-Owned Small Business
          </p>
          <p className="mb-2">
            CAGE Code: 9ABC1 | DUNS: 123456789 | VOSB Certified
          </p>
          <p className="text-sm opacity-90">
            Creating pathways to prosperity through professional workforce
            development
          </p>
        </div>
      </footer>
