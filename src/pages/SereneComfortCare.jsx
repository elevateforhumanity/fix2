...
export function SereneComfortCare() {
  return (
    <div>
      <Helmet>
        <title>Serene Comfort Care | Elevate for Humanity</title>
        <meta
          name="description"
          content="Healthcare Services & Professional Training Programs. Providing compassionate care and training the next generation of healthcare professionals."
        />
      </Helmet>
      <Navigation />
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              ...
              >
                ...
                <p style={{ color: '#6b5d52', lineHeight: '1.6' }}>
              ...
              >
                ...
                <p style={{ color: '#6b5d52', lineHeight: '1.6' }}>
                  Specialized care for elderly patients with dignity, respect,
                  and compassion
                </p>
              </div>
              <div
              ...
              >
                ...
                <p style={{ color: '#6b5d52', lineHeight: '1.6' }}>
                  Skilled nursing, medication management, and post-operative
                  care services
                </p>
              </div>
            </div>
