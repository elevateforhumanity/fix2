        ...
        <main role="main">
          ...
          <section className="relative bg-gradient-to-b from-blue-50 to-white py-20 px-4 text-center overflow-hidden">
            ...
            <div className="relative max-w-6xl mx-auto">
              ...
              <h2 className="text-5xl md:text-6xl font-extrabold mb-6 text-brown-900 leading-tight">
                Your Complete
                <br />
              ...
              <p className="text-xl md:text-2xl text-brown-600 mb-12 max-w-3xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                <Link to="/student-dashboard">
                  <Card className="group hover:shadow-2xl hover:scale-105 transition-all duration-300 border-2 hover:border-blue-500 cursor-pointer h-full">
                    <CardHeader className="text-center">
                      <div className="w-16 h-16 bg-beige-50 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-blue-500 transition-colors">
                ...
                <Link to="/instructor">
                  <Card className="group hover:shadow-2xl hover:scale-105 transition-all duration-300 border-2 hover:border-purple-500 cursor-pointer h-full">
                    <CardHeader className="text-center">
                      <div className="w-16 h-16 bg-beige-50 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-purple-500 transition-colors">
                ...
                <Link to="/course-catalog">
                  <Card className="group hover:shadow-2xl hover:scale-105 transition-all duration-300 border-2 hover:border-green-500 cursor-pointer h-full">
                    <CardHeader className="text-center">
                      <div className="w-16 h-16 bg-beige-50 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-green-500 transition-colors">
                ...
                {stats.map((stat, idx) => (
                  <Card key={idx} className="text-center border-0 shadow-lg">
                    <CardContent className="pt-6">
                      <stat.icon className="h-10 w-10 mx-auto mb-4 text-green-600" />
                      <div className="text-4xl font-extrabold text-green-600 mb-2">
                        {stat.number}
                      </div>
                      <div className="text-sm font-semibold text-brown-600 uppercase tracking-wide">
                        {stat.label}
                      </div>
                    </CardContent>
                  </Card>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {features.map((feature, idx) => (
                  ...
                  >
                    <CardHeader>
                      <div className="w-14 h-14 rounded-xl bg-beige-100 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/login">
                  <Button
                    size="lg"
                    className="bg-white text-green-600 hover:bg-beige-100 text-lg px-10 py-6 rounded-full shadow-2xl"
                  >
          ...
          <section className="py-16 px-4 bg-beige-50">
            <div className="max-w-5xl mx-auto">
              <h3 className="text-3xl md:text-4xl font-bold text-brown-900 mb-12 text-center">
                Need Help Getting Started?
              </h3>
              <div className="grid md:grid-cols-3 gap-8">
                <Card className="text-center hover:shadow-xl transition-shadow">
                  <CardHeader>
                    <div className="w-16 h-16 bg-beige-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
