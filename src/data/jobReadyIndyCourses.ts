...
export const jobReadyIndyCourses = {
  "id": "job-ready-indy",
  ...
  "scrapedData": [
    {
      "source": "https://learning.employindy.org",
      "titles": [],
      "courseCount": 18,
      "logos": [
        "https://learning.employindy.org/images/wEZmo4ixZSDYqqmaNEJCyyw7ODUxMzY5OTEwNDUw/indy-equity-logo_1.png"
      ]
    },
    {
      "source": "https://jri.employindy.org",
      "titles": [
        "Welcome to Job Ready Indy!",
        "Login to Job Ready Indy",
        "Reset Password",
        "Register"
      ],
      "courseCount": 2,
