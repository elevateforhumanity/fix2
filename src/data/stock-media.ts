...
export const stockImages: StockImage[] = [
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-584820927498-cfe5211fd8bf?w=400',
    category: 'Healthcare',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=400',
    category: 'Healthcare',
  ...
  // Technology
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1517842645767-c639042777db?w=400',
    category: 'Technology',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1519003722824-194d4455a60c?w=400',
    category: 'Transportation',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1585747860715-2ba37e788b70?w=400',
    category: 'Barbering',
...
export const stockVideos: StockVideo[] = [
  ...
  },
  {
    ...
    thumbnail: 'https://images.pexels.com/videos/4031818/pexels-photo-4031818.jpeg?w=400',
    category: 'Healthcare',
  ...
  },
  {
    ...
    thumbnail: 'https://images.pexels.com/videos/3205484/pexels-photo-3205484.jpeg?w=400',
    category: 'Barbering',
    tags: ['barber', 'haircut', 'grooming', 'salon'],
    source: 'Pexels',
  ...
  },
  {
    ...
    thumbnail: 'https://images.pexels.com/videos/5495955/pexels-photo-5495955.jpeg?w=400',
    category: 'Skilled Trades',
  ...
  },
  {
    ...
    thumbnail: 'https://images.pexels.com/videos/2053100/pexels-photo-2053100.jpeg?w=400',
    category: 'Transportation',
  ...
  },
  {
    ...
    thumbnail: 'https://images.pexels.com/videos/3130284/pexels-photo-3130284.jpeg?w=400',
    category: 'Technology',
  ...
  },
  {
    ...
    thumbnail: 'https://images.pexels.com/videos/3209828/pexels-photo-3209828.jpeg?w=400',
    category: 'Skilled Trades',
...
export function searchMedia(query: string): { images: StockImage[]; videos: StockVideo[] } {
  const lowerQuery = query.toLowerCase();
  
  const images = stockImages.filter(img => 
  ...
  const videos = stockVideos.filter(vid => 
