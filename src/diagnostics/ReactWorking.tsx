...
export default function ReactWorking() {
  ...
  return (
    ...
    >
      ...
      <ul>
        <li>
          ✅ React: <strong>{reactVersion}</strong>
        </li>
        <li>
          ✅ Mode: <strong>{import.meta.env.MODE}</strong>
        </li>
        <li>
          ✅ Supabase URL: <strong>{env('VITE_SUPABASE_URL')}</strong>
        </li>
        <li>
      ...
      >
        ...
        <p>
          The minimal app works, which means the problem is in your full{' '}
          <code>App</code>—likely one of those lazy-loaded components is
          crashing on import. We'll restore the full app with safer lazy loading
      ...
      >
        ...
        <p>
          Remove <code>?diag=1</code> from the URL or visit the homepage without
          the parameter.
        </p>
      </div>
    </main>
