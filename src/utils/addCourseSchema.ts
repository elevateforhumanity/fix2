...
export function addCourseSchema(course: CourseSchemaProps) {
  ...
  const schema: any = {
    ...
    provider: {
      ...
      sameAs: 'https://elevateproduction.netlify.app',
    },
    offers: {
      '@type': 'Offer',
      price:
...
export const samplePrograms = [
  {
    ...
    description:
      '8-10 week clinical training program with certification exam prep and 92% job placement rate. Learn blood collection, patient care, and laboratory procedures.',
    duration: '10 weeks',
    price: '0',
    rating: 4.9,
    reviewCount: 45,
  ...
  },
  {
    ...
    description:
      '12-16 week OSHA-certified construction training with hands-on experience and 95% job placement rate. Includes safety certification and tool training.',
    duration: '16 weeks',
    price: '0',
    rating: 4.8,
    reviewCount: 67,
  ...
  },
  {
    ...
    description:
      '4-8 week Class A CDL training program with 98% job placement rate. Includes behind-the-wheel training and DOT certification.',
    duration: '8 weeks',
    price: '0',
    rating: 4.9,
    reviewCount: 123,
  ...
  },
  {
    ...
    description:
      '12 week IT fundamentals and hardware/software troubleshooting certification program. 88% job placement rate with average starting salary of $45,000.',
    duration: '12 weeks',
    price: '0',
    rating: 4.7,
    reviewCount: 89,
  ...
  },
  {
    ...
    description:
      '10 week healthcare administration program covering ICD-10, CPT coding, and medical billing software. 90% job placement rate.',
    duration: '10 weeks',
    price: '0',
    rating: 4.8,
    reviewCount: 56,
