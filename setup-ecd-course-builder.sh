...
echo "=== Setting up Elevate Connects Directory course builder ==="

mkdir -p content/courses
mkdir -p content/image-prompts/ecd-courses
mkdir -p content/video-scripts/ecd-courses
mkdir -p scripts

########################################
# 1) Seed ECD course list JSON (EDIT THIS LATER IF NEEDED)
########################################
cat > content/courses/ecd-courses.json << 'FILEEOF'
[
  {
    "slug": "hvac-technician",
    "title": "HVAC Technician Training",
    "category": "Skilled Trades",
    "shortDescription": "Hands-on training to install, maintain, and repair heating and cooling systems for residential and commercial buildings."
  },
  {
    "slug": "barber-apprenticeship",
    "title": "Barber Apprenticeship",
    "category": "Beauty & Grooming",
    "shortDescription": "Earn-while-you-learn apprenticeship in a real barbershop, building hours toward state barber licensure."
  },
  {
    "slug": "cna-healthcare",
    "title": "CNA & Healthcare Careers",
    "category": "Healthcare",
    "shortDescription": "Entry-level healthcare training focused on CNA skills, patient care, and pathways into medical careers."
  },
  {
    "slug": "cdl-transportation",
    "title": "CDL & Transportation Training",
    "category": "Transportation",
    "shortDescription": "Commercial driver training for high-earning transportation and logistics careers."
  },
  {
    "slug": "building-technician",
    "title": "Building Technician & Skilled Trades",
    "category": "Skilled Trades",
    "shortDescription": "Maintenance, basic electrical, plumbing, and systems skills for stable building and facilities roles."
  },
  {
    "slug": "it-support-apprenticeship",
    "title": "IT Support & Help Desk Apprenticeship",
    "category": "Technology",
    "shortDescription": "Foundational IT support training with apprenticeships in help desk, troubleshooting, and user support."
  },
  {
    "slug": "beauty-career-educator",
    "title": "Beauty & Career Educator Training",
    "category": "Beauty & Education",
    "shortDescription": "Hybrid program that prepares experienced beauty professionals to become educators and trainers."
  }
]
FILEEOF

########################################
# 2) Builder worker: generates image prompts + video scripts
########################################
cat > scripts/build-ecd-course-assets.mjs << 'FILEEOF'
#!/usr/bin/env node
...
chmod +x scripts/build-ecd-course-assets.mjs

########################################
# 3) Homepage AI narrator about Elevate for Humanity & funding
########################################
cat > content/video-scripts/ecd-courses/about-elevate-for-humanity-main.md << 'FILEEOF'
...
Elevate for Humanity collaborates with WIOA, Workforce Ready Grants, Job Ready Indy, registered apprenticeships, and other workforce initiatives. That means many programs listed here may be available at low or no cost to eligible learners, including youth, adults, and returning citizens.

When you explore this directory, you'll find pathways in skilled trades, healthcare, transportation, technology, beauty, and more. Each program listing is designed to answer three questions:

• What skills will I learn?  
• What careers can this training lead to?  
• What funding or support might help me pay for it?

When you click into a program, you can request more information or apply. From there, our team and partners can help you review eligibility for federal and state workforce funding, match you to the right class or apprenticeship, and support you through enrollment.
...
echo ""
echo "=== Done. ECD course builder ready. ==="
echo ""
echo "📁 Created:"
echo "   content/courses/ecd-courses.json (7 courses)"
echo "   scripts/build-ecd-course-assets.mjs (builder)"
echo "   content/video-scripts/ecd-courses/about-elevate-for-humanity-main.md"
echo ""
echo "🚀 Next steps:"
echo "   1) Edit content/courses/ecd-courses.json if needed"
echo "   2) Run: node scripts/build-ecd-course-assets.mjs"
echo "   3) Run: node scripts/generate-images.mjs (to create actual images)"
echo ""
