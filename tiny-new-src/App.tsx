...
function CopyLink({ value, label }: { value: string; label?: string }) {
  ...
  return (
    <button
      onClick={copy}
      title="Copy"
      className="ml-2 inline-flex items-center gap-1 text-xs px-2 py-1 rounded border border-slate-300 hover:bg-slate-50"
    >
          ...
          {flash.map((o) => {
            ...
            return (
              <div key={o.id} className="flex flex-wrap items-center gap-2">
                ...
                {pct !== null && (
                  <span className="text-amber-600">({pct}% off)</span>
                )}
                ...
                {o.remaining != null && (
                  <span className="text-amber-600">{o.remaining} left</span>
                )}
                {o.remaining > 0 && (
                  <button
                    onClick={claim}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-8 text-sm">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              <li>
                <Link to="/apply" className="hover:text-indigo-600">
                  Apply
                </Link>
              </li>
              <li>
                <Link to="/programs" className="hover:text-indigo-600">
                  Programs
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/lms" className="hover:text-indigo-600">
                  LMS
                </Link>
              </li>
              <li>
                <Link to="/connect" className="hover:text-indigo-600">
                  Contact
                </Link>
              </li>
              <li>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              to="/programs"
              className="inline-flex items-center rounded-2xl bg-indigo-600 text-white px-5 py-3 font-medium shadow-sm hover:bg-indigo-700"
            >
              Explore Programs
            </Link>
            <Link
              to="/partners"
              className="inline-flex items-center rounded-2xl border border-slate-300 px-5 py-3 font-medium hover:bg-slate-50"
            >
              Partner With Us
            </Link>
            <Link
          ...
          <div className="rounded-3xl border border-slate-200 shadow-sm p-6 bg-white">
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li className="flex items-start gap-3">
                <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-indigo-600 text-white text-[10px]">
                  1
                </span>{' '}
            ...
            <Link
              to="/apply"
              className="mt-6 inline-flex w-full items-center justify-center rounded-2xl bg-indigo-600 px-5 py-3 font-medium text-white hover:bg-indigo-700"
            >
              Start Application
            </Link>
      ...
      <div className="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="rounded-xl border border-slate-200 p-6">
          ...
          <div className="mt-4 flex items-center gap-2">
            ...
            <span className="inline-flex px-2 py-1 bg-orange-100 text-orange-800 text-xs font-medium rounded">
              Community Service
            </span>
          </div>
          <p className="mt-3 text-sm text-slate-500">
        ...
        <div className="rounded-xl border border-slate-200 p-6">
          ...
          <div className="mt-4 flex items-center gap-2">
            ...
            <span className="inline-flex px-2 py-1 bg-pink-100 text-pink-800 text-xs font-medium rounded">
              Milady RISE
            </span>
          </div>
          <p className="mt-3 text-sm text-slate-500">
        ...
        <div className="rounded-xl border border-slate-200 p-6">
          ...
          <div className="mt-4 flex items-center gap-2">
            ...
            <span className="inline-flex px-2 py-1 bg-red-100 text-red-800 text-xs font-medium rounded">
              Community Impact
            </span>
          </div>
          <p className="mt-3 text-sm text-slate-500">
          ...
          return (
            ...
            >
              ...
              <div className="mt-4 flex gap-2">
                <button
                  onClick={() => buy(it.sku)}
                  className="inline-flex flex-1 items-center justify-center rounded-lg bg-indigo-600 text-white px-4 py-2 text-sm hover:bg-indigo-700"
                >
                  Buy Now
                </button>
                <button className="inline-flex items-center justify-center rounded-lg border border-slate-300 px-4 py-2 text-sm hover:bg-slate-50">
                  Details
                </button>
              </div>
  ...
  return (
    <Page title="Affiliate Program">
      ...
      <form onSubmit={apply} className="mt-6 grid gap-4 max-w-md">
        ...
        />
        <button className="inline-flex items-center justify-center rounded-lg bg-indigo-600 text-white px-4 py-2 text-sm hover:bg-indigo-700">
          Apply
        </button>
      </form>
      {submitted && (
      ...
      <div className="mt-8 max-w-md">
        ...
        <div className="mt-2 flex gap-2">
          ...
          <button
            type="button"
            onClick={loadStats}
            className="inline-flex items-center rounded-lg bg-slate-800 text-white px-4 py-2 text-sm hover:bg-slate-900"
          >
            Load
          </button>
        </div>
    ...
    <Page title="Directory">
      ...
      <div className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {!loading && listings.length === 0 && (
          <p className="text-sm text-slate-500">No approved listings yet.</p>
        )}
      </div>
    </Page>
  );
    ...
    <Page title="Legal & Licensing">
      <div className="grid md:grid-cols-3 gap-8">
            ...
            {docs.map((d) => {
              ...
              return (
                <li key={d.name} className="flex items-center gap-2">
                  <button
                    onClick={() => load(d.name)}
                    className="text-indigo-600 hover:underline text-left flex-grow"
                  >
                    {d.name}
                  </button>
        ...
        <div className="md:col-span-2">
          {content ? (
            <pre className="whitespace-pre-wrap text-xs bg-slate-50 p-4 rounded-xl border border-slate-200 max-h-[60vh] overflow-auto">
              {content}
            </pre>
          ) : (
  ...
  return (
    <Page title="Workbooks">
      ...
      <ul className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          return (
            ...
            >
              ...
              <div className="mt-2 flex gap-4 text-xs">
                ...
                <a href={w.pdfPath} className="text-indigo-600 hover:underline">
                  PDF (stub)
                </a>
        ...
        {list.length === 0 && (
          <p className="text-sm text-slate-500">No workbooks available.</p>
        )}
      </ul>
    </Page>
  );
    ...
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {plans.map((p: PricingPlan) => (
          <div
            key={p.code}
            className="relative rounded-xl border border-slate-200 p-6 flex flex-col"
          >
            {p.recommended && (
              <span className="absolute -top-3 left-4 inline-flex items-center px-2 py-1 rounded-full bg-indigo-600 text-white text-[10px] font-medium shadow">
                RECOMMENDED
              </span>
            )}
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="flex items-start gap-4">
              <div className="rounded-lg bg-indigo-100 p-2">
                <div className="h-6 w-6 bg-indigo-600 rounded" />
              </div>
              <div>
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="flex items-start gap-4">
              <div className="rounded-lg bg-red-100 p-2">
                <div className="h-6 w-6 bg-red-600 rounded" />
              </div>
              <div>
      ...
      <div className="mt-12 rounded-2xl bg-slate-50 p-8">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <button className="mt-4 inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm font-medium hover:bg-indigo-700">
              Partner With Us
            </button>
          </div>
          <div className="text-center">
