...
function ChatAssistantWrapper() {
  ...
  const getPageContext = () => {
    ...
    if (path.includes('/dashboard') || path.includes('/hub'))
      return 'dashboard';
  ...
  return (
    <ChatAssistant pageContext={getPageContext()} userRole={getUserRole()} />
  );
}
          ...
          <ToastProvider>
            <ProgressProvider>
              <BrowserRouter>
                <ErrorBoundary>
                  <Suspense
                    fallback={<div style={{ padding: 40 }}>Loading...</div>}
                  >
                    <NavBar />
                    <Routes>
                      ...
                      />
                      <Route
                        path="/durable-features"
                        element={<DurableFeatures />}
                      />
                      <Route
                        path="/durable-pricing"
                        element={<DurablePricing />}
                      />
                      ...
                      <Route
                        path="/durable-landing"
                        element={<DurableLanding />}
                      />
                      ...
                      <Route
                        path="/kingdom-konnect"
                        element={<KingdomKonnect />}
                      />
                      ...
                      <Route
                        path="/urban-build-crew"
                        element={<UrbanBuildCrew />}
                      />
                      <Route
