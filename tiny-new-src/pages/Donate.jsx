                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                  <button
                    ...
                    style={{
                      ...
                      padding: '0.75rem',
                      backgroundColor:
                        frequency === 'once' ? '#7c3aed' : 'white',
                      color: frequency === 'once' ? 'white' : '#1f2937',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: '0.75rem',
                      backgroundColor:
                        frequency === 'monthly' ? '#7c3aed' : 'white',
                      color: frequency === 'monthly' ? 'white' : '#1f2937',
                      border: '2px solid #7c3aed',
                      borderRadius: '6px',
                      fontWeight: '600',
                      cursor: 'pointer',
              ...
              <div style={{ marginBottom: '2rem' }}>
                ...
                >
                  {presetAmounts.map((amt) => (
                    <button
                      ...
                      style={{
                        padding: '1rem',
                        backgroundColor: amount === amt ? '#7c3aed' : 'white',
                ...
                <button
                  ...
                  style={{
                    width: '100%',
                    padding: '1rem',
                    backgroundColor: amount === 'custom' ? '#7c3aed' : 'white',
                    color: amount === 'custom' ? 'white' : '#1f2937',
                    border: '2px solid #e2e8f0',
                    borderRadius: '6px',
                    fontWeight: '600',
                    cursor: 'pointer',
