      ...
      <main id="main-content" style={{ minHeight: '100vh' }}>
        ...
        >
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              From AI-powered creation to advanced e-commerce, Durable has all
              the tools to build, launch, and grow your online presence.
            </p>
            <button
              style={{
                padding: '1rem 2.5rem',
                ...
                {features.map((feature, index) => (
                  <div
                    ...
                    style={{
                      ...
                      marginBottom: '1rem',
                      backgroundColor:
                        activeFeature === index ? 'white' : 'transparent',
                      border:
                        activeFeature === index
                          ? '2px solid #667eea'
                    ...
                    >
                      ...
                      <h3
                        style={{
                          fontSize: '1.5rem',
                          color:
                            activeFeature === index ? '#667eea' : '#2d3748',
                          margin: 0,
                        }}
                      >
                        {feature.title}
        ...
        >
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            >
              Start building your website today and discover why thousands of
              businesses choose Durable.
            </p>
            <div
              style={{
                display: 'flex',
