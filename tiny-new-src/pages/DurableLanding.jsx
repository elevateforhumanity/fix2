  ...
  const features = [
    {
      ...
      description:
        'Create professional websites in minutes with our intelligent design system',
      icon: '🤖',
    },
    {
      title: 'Dynamic Content Management',
      description:
        'Easily update and manage your content with our intuitive interface',
      icon: '📝',
    },
    {
      ...
      <main id="main-content" style={{ minHeight: '100vh' }}>
        ...
        >
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              Durable's AI-powered platform creates professional websites
              instantly. No coding, no design skills needed.
            </p>
            <div
              style={{
                display: 'flex',
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              ...
              >
                ...
                >
                  <li style={{ padding: '0.5rem 0', color: '#718096' }}>
                    ✓ 1 Website
                  </li>
                  <li style={{ padding: '0.5rem 0', color: '#718096' }}>
                    ✓ Basic Templates
