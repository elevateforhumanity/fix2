      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-neutral-400">
            Manage programs, enrollments, affiliates, and reports with natural
          ...
          <div className="space-y-4">
            <div>
              ...
              <code className="block bg-neutral-900 p-3 rounded-lg text-sm text-emerald-400">
                "Create a Tax Preparation & Business Ops program for $2,500, 80
                hours, CIP 52.0304"
              </code>
            </div>
            <div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-yellow-300/80 mt-1">
                This agent requires admin or staff role. All actions are logged
                to the audit table for compliance.
              </div>
            </div>
          </div>
        </div>
