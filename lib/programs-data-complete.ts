...
export const COMPLETE_PROGRAMS: ProgramData[] = [
  ...
  },
  {
    ...
    description: 'The CPR & First Aid program provides essential emergency response training. Students learn CPR for adults, children, and infants, AED operation, choking relief, and basic first aid. This certification is required for many healthcare, childcare, and safety positions. The course includes hands-on practice with manikins and AED trainers.',
    summary: 'Earn CPR and First Aid certifications required for healthcare and safety careers.',
    bullets: [
