-- ============================================
-- COMPLETE PARTNER & SCORM INTEGRATION
...
CREATE INDEX IF NOT EXISTS idx_partner_lms_providers_active ON public.partner_lms_providers (is_active);
...
CREATE INDEX IF NOT EXISTS idx_partner_courses_active ON public.partner_courses (is_active);
