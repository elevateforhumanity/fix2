    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <p className="text-xl text-slate-700 mb-8">
          Access high-quality career training programs funded by WIOA. 
          Get the skills employers need—at no cost to you.
        </p>
        <div className="flex gap-4">
          <button className="elevate-btn-primary">
            Check Eligibility
          </button>
          <button className="elevate-btn-secondary">
            Browse Programs
          </button>
        </div>
      </div>
