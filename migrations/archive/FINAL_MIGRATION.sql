-- FINAL MIGRATION - Creates courses table and inserts 17 courses
-- Run this in Supabase SQL Editor

-- Create courses table (simplified, no dependencies)
...
-- Verify
SELECT 'SUCCESS! Courses created:' as message, COUNT(*) as count FROM courses;
